...
export const metadata: Metadata = {
  title: "Baraat Party Turban in Delhi | Safawala India",
  ...
  keywords: "barat turban in delhi, turban Delhi, wedding turban Delhi, turban service Delhi",
  openGraph: {
    title: "Baraat Party Turban in Delhi | Safawala India",
    description: "Premium turban service in Delhi by Safawala India.",
    url: "https://baratturban.com/barat-turban-in-delhi",
    type: "website",
  },
}

export default function BaratTurbanInDelhiPage() {
  const pageData = {
    title: "Baraat Party Turban in Delhi",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Baraat Party Turban in Delhi Destination</h2>
