...
export const metadata: Metadata = {
  ...
  keywords: "marriage pagdi in jodhpur, pagdi Jodhpur, wedding pagdi Jodhpur, pagdi service Jodhpur",
  openGraph: {
    title: "Pagdi in Jodhpur | Safawala Jodhpur",
    description: "Premium pagdi service in Jodhpur by Safawala Jodhpur.",
    url: "https://safawalajodhpur.com/marriage-pagdi-in-jodhpur",
    type: "website",
  },
}

export default function MarriagePagdiInJodhpurPage() {
  const pageData = {
    ...
    areas: JODHPUR_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "On-site professional service at your Jodhpur venue", "Emergency last-minute service available in Jodhpur", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["marriage pagdi in jodhpur", "pagdi Jodhpur", "wedding pagdi Jodhpur", "pagdi service Jodhpur"],
    faqs: [
  {
