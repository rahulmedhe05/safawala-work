...
export const metadata: Metadata = {
  ...
  keywords: "affordable safa rental, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safarental.com/affordable-safa-rental",
    type: "website",
  },
}

export default function AffordableSafaRentalPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["affordable safa rental", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
