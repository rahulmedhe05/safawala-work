...
export const metadata: Metadata = {
  ...
  keywords: "safa rental in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://safarental.com/safa-rental-in-pune",
    type: "website",
  },
}

export default function SafaRentalInPunePage() {
  const pageData = {
    ...
    seoKeywords: ["safa rental in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
