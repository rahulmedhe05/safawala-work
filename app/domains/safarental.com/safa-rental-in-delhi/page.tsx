...
export const metadata: Metadata = {
  ...
  keywords: "safa rental in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in Delhi | Safawala India",
    description: "Premium safa service in Delhi by Safawala India.",
    url: "https://safarental.com/safa-rental-in-delhi",
    type: "website",
  },
}

export default function SafaRentalInDelhiPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Delhi venue", "Emergency last-minute service available in Delhi", "Expert safa specialists with 40+ years experience in Delhi", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["safa rental in delhi", "safa Delhi", "wedding safa Delhi", "safa service Delhi"],
    faqs: [
  {
