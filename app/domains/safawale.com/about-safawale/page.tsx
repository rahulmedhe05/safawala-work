...
export const metadata: Metadata = {
  ...
  keywords: "about safawale, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawale.com/about-safawale",
    type: "website",
  },
}

export default function AboutSafawalePage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination"],
    seoKeywords: ["about safawale", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
