...
export const metadata: Metadata = {
  ...
  keywords: "safawale reviews, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawale.com/safawale-reviews",
    type: "website",
  },
}

export default function SafawaleReviewsPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safawale reviews", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
