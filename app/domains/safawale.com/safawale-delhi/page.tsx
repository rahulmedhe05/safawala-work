...
export const metadata: Metadata = {
  ...
  keywords: "safawale delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawale.com/safawale-delhi",
    type: "website",
  },
}

export default function SafawaleDelhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safawale delhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
