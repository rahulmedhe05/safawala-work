...
export const metadata: Metadata = {
  ...
  keywords: "contact safawale, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawale.com/contact-safawale",
    type: "website",
  },
}

export default function ContactSafawalePage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["contact safawale", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
