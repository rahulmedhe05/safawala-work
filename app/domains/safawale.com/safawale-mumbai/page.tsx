...
export const metadata: Metadata = {
  ...
  keywords: "safawale mumbai, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawale.com/safawale-mumbai",
    type: "website",
  },
}

export default function SafawaleMumbaiPage() {
  const pageData = {
    title: "Safa in India",
