...
export const metadata: Metadata = {
  ...
  keywords: "safawale jaipur, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawale.com/safawale-jaipur",
    type: "website",
  },
}

export default function SafawaleJaipurPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safawale jaipur", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
