...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://srgrooms.com/premium-wedding-safa-for-international-groom-in-india",
    type: "website",
  },
}
...
export default function PremiumWeddingSafaForInternationalGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India"],
