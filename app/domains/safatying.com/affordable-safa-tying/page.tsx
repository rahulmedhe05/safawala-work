...
export const metadata: Metadata = {
  ...
  keywords: "affordable safa tying, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safatying.com/affordable-safa-tying",
    type: "website",
  },
}

export default function AffordableSafaTyingPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["affordable safa tying", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
