...
export const metadata: Metadata = {
  ...
  keywords: "safa tying in udaipur, safa Udaipur, wedding safa Udaipur, safa service Udaipur",
  openGraph: {
    title: "Safa in Udaipur | Safawala India",
    description: "Premium safa service in Udaipur by Safawala India.",
    url: "https://safatying.com/safa-tying-in-udaipur",
    type: "website",
  },
}

export default function SafaTyingInUdaipurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Udaipur", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Udaipur venue", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["safa tying in udaipur", "safa Udaipur", "wedding safa Udaipur", "safa service Udaipur"],
    faqs: [
  {
