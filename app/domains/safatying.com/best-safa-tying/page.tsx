...
export const metadata: Metadata = {
  ...
  keywords: "best safa tying, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safatying.com/best-safa-tying",
    type: "website",
  },
}

export default function BestSafaTyingPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["best safa tying", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
