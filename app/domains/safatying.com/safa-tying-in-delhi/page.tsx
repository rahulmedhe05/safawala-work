...
export const metadata: Metadata = {
  title: "Safa in Delhi | Safawala India",
  ...
  keywords: "safa tying in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Safa in Delhi | Safawala India",
    description: "Premium safa service in Delhi by Safawala India.",
    url: "https://safatying.com/safa-tying-in-delhi",
    type: "website",
  },
}

export default function SafaTyingInDelhiPage() {
  const pageData = {
    title: "Safa in Delhi",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Safa in Delhi Destination</h2>
