...
export const metadata: Metadata = {
  title: "Safa in Pune | Safawala India",
  ...
  keywords: "safa tying in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://safatying.com/safa-tying-in-pune",
    type: "website",
  },
}

export default function SafaTyingInPunePage() {
  const pageData = {
    title: "Safa in Pune",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in Pune", "On-site professional service at your Pune venue", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Pune"],
    seoKeywords: ["safa tying in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Safa in Pune Destination</h2>
