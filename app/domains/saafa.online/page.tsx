...
export const metadata: Metadata = {
  title: "Saafa Online | Online saafa booking | Book Online India",
  description: "Saafa Online - Online saafa booking. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "saafa online, saafa-online, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Saafa Online | Premium Turban Service",
    description: "Online saafa booking. Expert turban service across India.",
    url: "https://saafa.online",
    type: "website",
  },
}

const SPECIALTIES = ['Online Booking', 'Quick Response', 'Pan India', 'Best Prices']
...
export default function SaafaOnlineHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Online saafa booking. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Saafa Online" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Saafa Online Specialties</h2>
      ...
      <DynamicAboutSection location="Saafa Online" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Saafa Online" state="India" domain="saafa.online" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
