...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pachrangisafa.com/sehra-dulha-in-rajasthan",
    type: "website",
  },
}
...
export default function SehraDulhaInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Rajasthan venue", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Rajasthan", "Emergency last-minute service available in Rajasthan", "Complete barati packages with matching coordination"],
