...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pachrangisafa.com/sehrabandi-in-rajasthan",
    type: "website",
  },
}
...
export default function SehrabandiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Rajasthan", "On-site professional service at your Rajasthan venue", "Emergency last-minute service available in Rajasthan", "Competitive pricing for individual and bulk orders"],
