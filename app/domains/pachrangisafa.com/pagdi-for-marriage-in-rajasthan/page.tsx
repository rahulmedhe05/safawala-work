...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pachrangisafa.com/pagdi-for-marriage-in-rajasthan",
    type: "website",
  },
}
...
export default function PagdiForMarriageInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Rajasthan venue", "Emergency last-minute service available in Rajasthan", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day"],
