...
export const metadata: Metadata = {
  ...
  keywords: "paghdi in rajasthan, safa Rajasthan, wedding safa Rajasthan, safa service Rajasthan",
  openGraph: {
    title: "Safa in Rajasthan | Safawala India",
    description: "Premium safa service in Rajasthan by Safawala India.",
    url: "https://pachrangisafa.com/paghdi-in-rajasthan",
    type: "website",
  },
}

export default function PaghdiInRajasthanPage() {
  const pageData = {
    ...
    seoKeywords: ["paghdi in rajasthan", "safa Rajasthan", "wedding safa Rajasthan", "safa service Rajasthan"],
    faqs: [
  {
