...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pachrangisafa.com/dulhe-ki-pagdi-in-rajasthan",
    type: "website",
  },
}
...
export default function DulheKiPagdiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Rajasthan", "Emergency last-minute service available in Rajasthan"],
