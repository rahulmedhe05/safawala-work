...
export const metadata: Metadata = {
  ...
  keywords: "turban in rajasthan, turban Rajasthan, wedding turban Rajasthan, turban service Rajasthan",
  openGraph: {
    title: "Turban in Rajasthan | Safawala India",
    description: "Premium turban service in Rajasthan by Safawala India.",
    url: "https://pachrangisafa.com/turban-in-rajasthan",
    type: "website",
  },
}

export default function TurbanInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your Rajasthan venue", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["turban in rajasthan", "turban Rajasthan", "wedding turban Rajasthan", "turban service Rajasthan"],
    faqs: [
  {
