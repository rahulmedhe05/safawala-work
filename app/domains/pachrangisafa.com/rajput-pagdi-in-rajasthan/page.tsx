...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Rajasthan | Safawala India",
  ...
  keywords: "rajput pagdi in rajasthan, pagdi Rajasthan, wedding pagdi Rajasthan, pagdi service Rajasthan",
  openGraph: {
    title: "Rajputana Pagdi in Rajasthan | Safawala India",
    description: "Premium pagdi service in Rajasthan by Safawala India.",
    url: "https://pachrangisafa.com/rajput-pagdi-in-rajasthan",
    type: "website",
  },
}

export default function RajputPagdiInRajasthanPage() {
  const pageData = {
    title: "Rajputana Pagdi in Rajasthan",
    ...
    seoKeywords: ["rajput pagdi in rajasthan", "pagdi Rajasthan", "wedding pagdi Rajasthan", "pagdi service Rajasthan"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Rajputana Pagdi in Rajasthan Destination</h2>
