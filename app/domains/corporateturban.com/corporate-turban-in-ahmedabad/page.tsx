...
export const metadata: Metadata = {
  ...
  keywords: "corporate turban in ahmedabad, turban Ahmedabad, wedding turban Ahmedabad, turban service Ahmedabad",
  openGraph: {
    title: "Turban in Ahmedabad | Safawala India",
    description: "Premium turban service in Ahmedabad by Safawala India.",
    url: "https://corporateturban.com/corporate-turban-in-ahmedabad",
    type: "website",
  },
}

export default function CorporateTurbanInAhmedabadPage() {
  const pageData = {
