...
export const metadata: Metadata = {
  ...
  keywords: "corporate turban in udaipur, turban Udaipur, wedding turban Udaipur, turban service Udaipur",
  openGraph: {
    title: "Turban in Udaipur | Safawala India",
    description: "Premium turban service in Udaipur by Safawala India.",
    url: "https://corporateturban.com/corporate-turban-in-udaipur",
    type: "website",
  },
}

export default function CorporateTurbanInUdaipurPage() {
  const pageData = {
