...
export const metadata: Metadata = {
  ...
  keywords: "corporate turban in mumbai, turban Mumbai, wedding turban Mumbai, turban service Mumbai",
  openGraph: {
    title: "Turban in Mumbai | Safawala India",
    description: "Premium turban service in Mumbai by Safawala India.",
    url: "https://corporateturban.com/corporate-turban-in-mumbai",
    type: "website",
  },
}

export default function CorporateTurbanInMumbaiPage() {
  const pageData = {
