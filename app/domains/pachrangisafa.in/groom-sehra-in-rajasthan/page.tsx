...
export const metadata: Metadata = {
  ...
  keywords: "groom sehra in rajasthan, sehra Rajasthan, wedding sehra Rajasthan, sehra service Rajasthan",
  openGraph: {
    title: "Groom Sehra in Rajasthan | Safawala India",
    description: "Premium sehra service in Rajasthan by Safawala India.",
    url: "https://pachrangisafa.in/groom-sehra-in-rajasthan",
    type: "website",
  },
}

export default function GroomSehraInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Rajasthan", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Rajasthan venue", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["groom sehra in rajasthan", "sehra Rajasthan", "wedding sehra Rajasthan", "sehra service Rajasthan"],
    faqs: [
  {
