...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pachrangisafa.in/wedding-turban-draping-in-rajasthan",
    type: "website",
  },
}
...
export default function WeddingTurbanDrapingInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Rajasthan venue", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Expert turban specialists with 40+ years experience in Rajasthan", "Perfect fit with maximum comfort guaranteed all day"],
