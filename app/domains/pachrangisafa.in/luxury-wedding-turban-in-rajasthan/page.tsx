...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pachrangisafa.in/luxury-wedding-turban-in-rajasthan",
    type: "website",
  },
}
...
export default function LuxuryWeddingTurbanInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your Rajasthan venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in Rajasthan", "Competitive pricing for individual and bulk orders"],
