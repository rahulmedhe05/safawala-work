...
export const metadata: Metadata = {
  title: "Dulha (Groom) Pagdi in Punjab | Safawala India",
  ...
  keywords: "dulha pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Dulha (Groom) Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/dulha-pagdi-in-punjab",
    type: "website",
  },
}

export default function DulhaPagdiInPunjabPage() {
  const pageData = {
    title: "Dulha (Groom) Pagdi in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Expert pagdi specialists with 40+ years experience in Punjab", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["dulha pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Dulha (Groom) Pagdi in Punjab Destination</h2>
