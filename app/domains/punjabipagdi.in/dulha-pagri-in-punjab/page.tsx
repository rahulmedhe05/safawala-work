...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/dulha-pagri-in-punjab",
    type: "website",
  },
}
...
export default function DulhaPagriInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Expert pagri specialists with 40+ years experience in Punjab", "On-site professional service at your Punjab venue", "Emergency last-minute service available in Punjab", "Customized designs matching your wedding theme and outfit"],
