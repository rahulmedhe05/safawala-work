...
export const metadata: Metadata = {
  title: "Royal palaces Safa in Punjab | Safawala India",
  ...
  keywords: "maharaja safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Royal palaces Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/maharaja-safa-in-punjab",
    type: "website",
  },
}

export default function MaharajaSafaInPunjabPage() {
  const pageData = {
    title: "Royal palaces Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Punjab", "On-site professional service at your Punjab venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["maharaja safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal palaces Safa in Punjab Destination</h2>
