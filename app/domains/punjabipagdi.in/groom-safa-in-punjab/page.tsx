...
export const metadata: Metadata = {
  ...
  keywords: "groom safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Groom Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/groom-safa-in-punjab",
    type: "website",
  },
}

export default function GroomSafaInPunjabPage() {
  const pageData = {
