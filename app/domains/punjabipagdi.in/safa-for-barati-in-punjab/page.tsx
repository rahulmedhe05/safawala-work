...
export const metadata: Metadata = {
  ...
  keywords: "safa for barati in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Barati Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/safa-for-barati-in-punjab",
    type: "website",
  },
}

export default function SafaForBaratiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Punjab venue", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Punjab", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Punjab"],
    seoKeywords: ["safa for barati in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
