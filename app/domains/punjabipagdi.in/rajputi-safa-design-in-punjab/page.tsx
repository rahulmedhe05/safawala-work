...
export const metadata: Metadata = {
  title: "Rajputana Safa in Punjab | Safawala India",
  ...
  keywords: "rajputi safa design in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Rajputana Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/rajputi-safa-design-in-punjab",
    type: "website",
  },
}

export default function RajputiSafaDesignInPunjabPage() {
  const pageData = {
    title: "Rajputana Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Punjab", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["rajputi safa design in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Rajputana Safa in Punjab Destination</h2>
