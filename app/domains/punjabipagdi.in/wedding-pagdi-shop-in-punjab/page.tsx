...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi shop in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/wedding-pagdi-shop-in-punjab",
    type: "website",
  },
}

export default function WeddingPagdiShopInPunjabPage() {
  const pageData = {
