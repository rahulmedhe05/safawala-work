...
export const metadata: Metadata = {
  title: "Jodhpur Pagri in Punjab | Safawala India",
  ...
  keywords: "jodhpuri pagri in punjab, pagri Punjab, wedding pagri Punjab, pagri service Punjab",
  openGraph: {
    title: "Jodhpur Pagri in Punjab | Safawala India",
    description: "Premium pagri service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/jodhpuri-pagri-in-punjab",
    type: "website",
  },
}

export default function JodhpuriPagriInPunjabPage() {
  const pageData = {
    title: "Jodhpur Pagri in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Punjab", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["jodhpuri pagri in punjab", "pagri Punjab", "wedding pagri Punjab", "pagri service Punjab"],
    faqs: [
  {
  ...
  {
    "question": "Do you provide matching Pagri for barati in Punjab?",
  ...
  {
    "question": "Can I see Pagri designs before booking in Punjab?",
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Jodhpur Pagri in Punjab Destination</h2>

<p>Looking for the finest Pagri in Punjab? Safawala Punjab is the trusted choice of thousands of families for authentic, premium turban services. Experience our 40+ years legacy of excellence.</p>
