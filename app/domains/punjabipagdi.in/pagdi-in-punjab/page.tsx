...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/pagdi-in-punjab",
    type: "website",
  },
}
...
export default function PagdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Punjab venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Punjab", "Expert pagdi specialists with 40+ years experience in Punjab", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations"],
