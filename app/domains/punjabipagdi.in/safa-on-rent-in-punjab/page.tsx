...
export const metadata: Metadata = {
  ...
  keywords: "safa on rent in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/safa-on-rent-in-punjab",
    type: "website",
  },
}

export default function SafaOnRentInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Punjab", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["safa on rent in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
