...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/pagri-in-punjab",
    type: "website",
  },
}
...
export default function PagriInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Punjab venue", "Emergency last-minute service available in Punjab", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit"],
...
<p>Welcome to Safawala Punjab - your premier destination for Pagri services. With over 40 years of expertise in traditional turban craftsmanship, we bring royal elegance to your special day.</p>
