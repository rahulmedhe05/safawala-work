...
export const metadata: Metadata = {
  ...
  keywords: "groom pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Groom Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/groom-pagdi-in-punjab",
    type: "website",
  },
}

export default function GroomPagdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Punjab", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Punjab", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["groom pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
