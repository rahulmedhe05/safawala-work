...
export const metadata: Metadata = {
  title: "Sehra in Punjab | Safawala India",
  ...
  keywords: "dulhe ka sehra in punjab, sehra Punjab, wedding sehra Punjab, sehra service Punjab",
  openGraph: {
    title: "Sehra in Punjab | Safawala India",
    description: "Premium sehra service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/dulhe-ka-sehra-in-punjab",
    type: "website",
  },
}

export default function DulheKaSehraInPunjabPage() {
  const pageData = {
    title: "Sehra in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Punjab", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "On-site professional service at your Punjab venue", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["dulhe ka sehra in punjab", "sehra Punjab", "wedding sehra Punjab", "sehra service Punjab"],
    faqs: [
  {
  ...
  {
    "question": "How early should I book Sehra for my Punjab wedding?",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Sehra in Punjab Destination</h2>

<p>Welcome to Safawala Punjab - your premier destination for Sehra services. With over 40 years of expertise in traditional turban craftsmanship, we bring royal elegance to your special day.</p>
