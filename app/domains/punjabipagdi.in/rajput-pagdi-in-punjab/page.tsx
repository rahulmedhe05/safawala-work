...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/rajput-pagdi-in-punjab",
    type: "website",
  },
}
...
export default function RajputPagdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Emergency last-minute service available in Punjab", "On-site professional service at your Punjab venue", "Expert pagdi specialists with 40+ years experience in Punjab", "Free consultation and design preview via WhatsApp"],
