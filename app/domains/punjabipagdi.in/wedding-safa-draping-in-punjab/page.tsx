...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa draping in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/wedding-safa-draping-in-punjab",
    type: "website",
  },
}

export default function WeddingSafaDrapingInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in Punjab"],
    seoKeywords: ["wedding safa draping in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
