...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in punjab, sehra Punjab, wedding sehra Punjab, sehra service Punjab",
  openGraph: {
    title: "Sehra in Punjab | Safawala India",
    description: "Premium sehra service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/sehrabandi-in-punjab",
    type: "website",
  },
}

export default function SehrabandiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Punjab", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your Punjab venue"],
    seoKeywords: ["sehrabandi in punjab", "sehra Punjab", "wedding sehra Punjab", "sehra service Punjab"],
    faqs: [
  {
