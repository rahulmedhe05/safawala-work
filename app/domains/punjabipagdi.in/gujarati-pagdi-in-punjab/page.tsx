...
export const metadata: Metadata = {
  title: "Gujarat Pagdi in Punjab | Safawala India",
  ...
  keywords: "gujarati pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Gujarat Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/gujarati-pagdi-in-punjab",
    type: "website",
  },
}

export default function GujaratiPagdiInPunjabPage() {
  const pageData = {
    title: "Gujarat Pagdi in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in Punjab", "Emergency last-minute service available in Punjab", "Complete barati packages with matching coordination", "On-site professional service at your Punjab venue", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["gujarati pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Gujarat Pagdi in Punjab Destination</h2>
