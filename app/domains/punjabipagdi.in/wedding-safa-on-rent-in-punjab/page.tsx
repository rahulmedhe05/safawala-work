...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Safa in Punjab | Safawala India",
  ...
  keywords: "wedding safa on rent in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/wedding-safa-on-rent-in-punjab",
    type: "website",
  },
}

export default function WeddingSafaOnRentInPunjabPage() {
  const pageData = {
    title: "Premium Wedding-Grade Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Punjab", "Expert safa specialists with 40+ years experience in Punjab", "On-site professional service at your Punjab venue", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["wedding safa on rent in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Safa in Punjab Destination</h2>
