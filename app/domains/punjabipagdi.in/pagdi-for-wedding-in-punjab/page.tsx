...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/pagdi-for-wedding-in-punjab",
    type: "website",
  },
}
...
export default function PagdiForWeddingInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Punjab", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your Punjab venue", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
