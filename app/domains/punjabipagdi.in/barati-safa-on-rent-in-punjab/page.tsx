...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Barati Safa in Punjab | Safawala India",
  ...
  keywords: "barati safa on rent in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Well-Maintained Rental Collection Barati Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/barati-safa-on-rent-in-punjab",
    type: "website",
  },
}

export default function BaratiSafaOnRentInPunjabPage() {
  const pageData = {
    title: "Well-Maintained Rental Collection Barati Safa in Punjab",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Well-Maintained Rental Collection Barati Safa in Punjab Destination</h2>
