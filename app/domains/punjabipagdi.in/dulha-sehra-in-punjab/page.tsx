...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/dulha-sehra-in-punjab",
    type: "website",
  },
}
...
export default function DulhaSehraInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Punjab venue", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Punjab", "Complete barati packages with matching coordination", "Emergency last-minute service available in Punjab"],
