...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/wedding-safa-in-punjab",
    type: "website",
  },
}

export default function WeddingSafaInPunjabPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
