...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/designer-wedding-safa-in-punjab",
    type: "website",
  },
}
...
export default function DesignerWeddingSafaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Punjab venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Punjab", "Expert safa specialists with 40+ years experience in Punjab"],
