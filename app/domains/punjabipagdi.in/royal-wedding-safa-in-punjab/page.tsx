...
export const metadata: Metadata = {
  ...
  keywords: "royal wedding safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/royal-wedding-safa-in-punjab",
    type: "website",
  },
}

export default function RoyalWeddingSafaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Punjab", "Emergency last-minute service available in Punjab", "Free consultation and design preview via WhatsApp", "On-site professional service at your Punjab venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["royal wedding safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
