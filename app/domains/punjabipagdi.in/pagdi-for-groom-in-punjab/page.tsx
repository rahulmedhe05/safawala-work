...
export const metadata: Metadata = {
  title: "Groom Pagdi in Punjab | Safawala India",
  ...
  keywords: "pagdi for groom in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Groom Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/pagdi-for-groom-in-punjab",
    type: "website",
  },
}

export default function PagdiForGroomInPunjabPage() {
  const pageData = {
    title: "Groom Pagdi in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Expert pagdi specialists with 40+ years experience in Punjab", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["pagdi for groom in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
  ...
  {
    "question": "Can I see Pagdi designs before booking in Punjab?",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Pagdi in Punjab Destination</h2>
