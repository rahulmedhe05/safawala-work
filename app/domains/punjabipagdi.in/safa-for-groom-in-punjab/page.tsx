...
export const metadata: Metadata = {
  title: "Groom Safa in Punjab | Safawala India",
  ...
  keywords: "safa for groom in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Groom Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/safa-for-groom-in-punjab",
    type: "website",
  },
}

export default function SafaForGroomInPunjabPage() {
  const pageData = {
    title: "Groom Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Punjab", "On-site professional service at your Punjab venue"],
    seoKeywords: ["safa for groom in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Safa in Punjab Destination</h2>
