...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/groom-sehra-in-punjab",
    type: "website",
  },
}
...
export default function GroomSehraInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert sehra specialists with 40+ years experience in Punjab", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Authentic traditional tying techniques perfected over generations"],
