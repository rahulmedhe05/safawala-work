...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/wedding-pagdi-in-punjab",
    type: "website",
  },
}
...
export default function WeddingPagdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "On-site professional service at your Punjab venue", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Punjab", "Expert pagdi specialists with 40+ years experience in Punjab"],
