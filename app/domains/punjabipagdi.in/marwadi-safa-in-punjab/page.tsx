...
export const metadata: Metadata = {
  title: "Marwar Safa in Punjab | Safawala India",
  ...
  keywords: "marwadi safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Marwar Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/marwadi-safa-in-punjab",
    type: "website",
  },
}

export default function MarwadiSafaInPunjabPage() {
  const pageData = {
    title: "Marwar Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Punjab", "Expert safa specialists with 40+ years experience in Punjab"],
    seoKeywords: ["marwadi safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Marwar Safa in Punjab Destination</h2>
