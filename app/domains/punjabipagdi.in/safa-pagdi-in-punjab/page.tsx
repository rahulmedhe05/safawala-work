...
export const metadata: Metadata = {
  ...
  keywords: "safa pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/safa-pagdi-in-punjab",
    type: "website",
  },
}

export default function SafaPagdiInPunjabPage() {
  const pageData = {
    ...
    seoKeywords: ["safa pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
