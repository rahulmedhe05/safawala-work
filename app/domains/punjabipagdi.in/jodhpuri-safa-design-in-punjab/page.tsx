...
export const metadata: Metadata = {
  title: "Jodhpur Safa in Punjab | Safawala India",
  ...
  keywords: "jodhpuri safa design in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Jodhpur Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/jodhpuri-safa-design-in-punjab",
    type: "website",
  },
}

export default function JodhpuriSafaDesignInPunjabPage() {
  const pageData = {
    title: "Jodhpur Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["jodhpuri safa design in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Jodhpur Safa in Punjab Destination</h2>
