...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/rajwadi-safa-in-punjab",
    type: "website",
  },
}
...
export default function RajwadiSafaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Punjab", "Competitive pricing for individual and bulk orders"],
