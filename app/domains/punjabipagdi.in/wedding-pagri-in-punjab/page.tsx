...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.in/wedding-pagri-in-punjab",
    type: "website",
  },
}
...
export default function WeddingPagriInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert pagri specialists with 40+ years experience in Punjab", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Punjab", "On-site professional service at your Punjab venue"],
