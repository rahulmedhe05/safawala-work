...
export const metadata: Metadata = {
  title: "Turban in Punjab | Safawala India",
  ...
  keywords: "turban in punjab, turban Punjab, wedding turban Punjab, turban service Punjab",
  openGraph: {
    title: "Turban in Punjab | Safawala India",
    description: "Premium turban service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/turban-in-punjab",
    type: "website",
  },
}

export default function TurbanInPunjabPage() {
  const pageData = {
    title: "Turban in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your Punjab venue", "Customized designs matching your wedding theme and outfit", "Expert turban specialists with 40+ years experience in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["turban in punjab", "turban Punjab", "wedding turban Punjab", "turban service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Turban in Punjab Destination</h2>
