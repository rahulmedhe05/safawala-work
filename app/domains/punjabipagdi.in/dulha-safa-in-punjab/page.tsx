...
export const metadata: Metadata = {
  title: "Dulha (Groom) Safa in Punjab | Safawala India",
  ...
  keywords: "dulha safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Dulha (Groom) Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.in/dulha-safa-in-punjab",
    type: "website",
  },
}

export default function DulhaSafaInPunjabPage() {
  const pageData = {
    title: "Dulha (Groom) Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["dulha safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Dulha (Groom) Safa in Punjab Destination</h2>
