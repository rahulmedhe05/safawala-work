...
export const metadata: Metadata = {
  ...
  keywords: "premium wedding turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Premium Wedding-Grade Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://weddingturban.com/premium-wedding-turban",
    type: "website",
  },
}

export default function PremiumWeddingTurbanPage() {
  const pageData = {
    ...
    seoKeywords: ["premium wedding turban", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
