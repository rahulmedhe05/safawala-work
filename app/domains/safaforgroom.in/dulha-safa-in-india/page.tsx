...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safaforgroom.in/dulha-safa-in-india",
    type: "website",
  },
}
...
export default function DulhaSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
