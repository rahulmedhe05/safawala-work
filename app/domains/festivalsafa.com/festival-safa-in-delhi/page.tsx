...
export const metadata: Metadata = {
  ...
  keywords: "festival safa in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Safa in Delhi | Safawala India",
    description: "Premium safa service in Delhi by Safawala India.",
    url: "https://festivalsafa.com/festival-safa-in-delhi",
    type: "website",
  },
}

export default function FestivalSafaInDelhiPage() {
  const pageData = {
    title: "Safa in Delhi",
