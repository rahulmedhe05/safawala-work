...
export const metadata: Metadata = {
  ...
  keywords: "affordable festival safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://festivalsafa.com/affordable-festival-safa",
    type: "website",
  },
}

export default function AffordableFestivalSafaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["affordable festival safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
