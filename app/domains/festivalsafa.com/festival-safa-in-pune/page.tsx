...
export const metadata: Metadata = {
  ...
  keywords: "festival safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://festivalsafa.com/festival-safa-in-pune",
    type: "website",
  },
}

export default function FestivalSafaInPunePage() {
  const pageData = {
    title: "Safa in Pune",
