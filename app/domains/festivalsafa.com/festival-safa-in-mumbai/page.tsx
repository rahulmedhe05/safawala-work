...
export const metadata: Metadata = {
  ...
  keywords: "festival safa in mumbai, safa Mumbai, wedding safa Mumbai, safa service Mumbai",
  openGraph: {
    title: "Safa in Mumbai | Safawala India",
    description: "Premium safa service in Mumbai by Safawala India.",
    url: "https://festivalsafa.com/festival-safa-in-mumbai",
    type: "website",
  },
}

export default function FestivalSafaInMumbaiPage() {
  const pageData = {
    ...
    seoKeywords: ["festival safa in mumbai", "safa Mumbai", "wedding safa Mumbai", "safa service Mumbai"],
    faqs: [
  {
