...
export const metadata: Metadata = {
  title: "Safa Groom | Wedding safa for grooms | Book Online India",
  description: "Safa Groom - Wedding safa for grooms. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "safa groom, safa-groom, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Safa Groom | Premium Turban Service",
    description: "Wedding safa for grooms. Expert turban service across India.",
    url: "https://safagroom.com",
    type: "website",
  },
}

const SPECIALTIES = ['Groom Turban Tying', 'On-site Service', 'Matching Accessories', 'Photography Ready']
...
export default function SafaGroomHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Wedding safa for grooms. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Safa Groom" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Safa Groom Specialties</h2>
      ...
      <DynamicAboutSection location="Safa Groom" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Safa Groom" state="India" domain="safagroom.com" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
