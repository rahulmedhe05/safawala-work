...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safagroom.com/royal-groom-turban-for-destination-wedding-in-india",
    type: "website",
  },
}
...
export default function RoyalGroomTurbanForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Expert turban specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
