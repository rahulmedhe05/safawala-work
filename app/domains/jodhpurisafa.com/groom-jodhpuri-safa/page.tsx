...
export const metadata: Metadata = {
  ...
  keywords: "groom jodhpuri safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Jodhpur Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jodhpurisafa.com/groom-jodhpuri-safa",
    type: "website",
  },
}

export default function GroomJodhpuriSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["groom jodhpuri safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
