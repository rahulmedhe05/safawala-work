...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Jodhpur Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jodhpurisafa.com/jodhpuri-safa-colors",
    type: "website",
  },
}

export default function JodhpuriSafaColorsPage() {
  const pageData = {
    ...
    seoKeywords: ["jodhpuri safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
