...
export const metadata: Metadata = {
  ...
  keywords: "wedding jodhpuri safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Jodhpur Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jodhpurisafa.com/wedding-jodhpuri-safa",
    type: "website",
  },
}

export default function WeddingJodhpuriSafaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["wedding jodhpuri safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
