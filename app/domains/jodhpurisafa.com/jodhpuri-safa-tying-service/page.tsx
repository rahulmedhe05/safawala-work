...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Jodhpur Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jodhpurisafa.com/jodhpuri-safa-tying-service",
    type: "website",
  },
}

export default function JodhpuriSafaTyingServicePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India"],
    seoKeywords: ["jodhpuri safa tying service", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
