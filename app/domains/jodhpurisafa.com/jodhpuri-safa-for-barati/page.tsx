...
export const metadata: Metadata = {
  title: "Jodhpur Barati Safa in India | Safawala India",
  ...
  keywords: "jodhpuri safa for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Jodhpur Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jodhpurisafa.com/jodhpuri-safa-for-barati",
    type: "website",
  },
}

export default function JodhpuriSafaForBaratiPage() {
  const pageData = {
    title: "Jodhpur Barati Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "On-site professional service at your India venue"],
    seoKeywords: ["jodhpuri safa for barati", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Jodhpur Barati Safa in India Destination</h2>
