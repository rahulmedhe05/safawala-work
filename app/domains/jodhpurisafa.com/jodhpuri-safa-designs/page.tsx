...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa designs, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Jodhpur Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jodhpurisafa.com/jodhpuri-safa-designs",
    type: "website",
  },
}

export default function JodhpuriSafaDesignsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["jodhpuri safa designs", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
