...
export const metadata: Metadata = {
  ...
  keywords: "my safawala delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mysafawala.com/my-safawala-delhi",
    type: "website",
  },
}

export default function MySafawalaDelhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["my safawala delhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
