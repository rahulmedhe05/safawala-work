...
export const metadata: Metadata = {
  ...
  keywords: "about my safawala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mysafawala.com/about-my-safawala",
    type: "website",
  },
}

export default function AboutMySafawalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["about my safawala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
