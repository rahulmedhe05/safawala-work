...
export const metadata: Metadata = {
  ...
  keywords: "my safawala jaipur, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mysafawala.com/my-safawala-jaipur",
    type: "website",
  },
}

export default function MySafawalaJaipurPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["my safawala jaipur", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
