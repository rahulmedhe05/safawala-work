...
export const metadata: Metadata = {
  ...
  keywords: "contact my safawala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mysafawala.com/contact-my-safawala",
    type: "website",
  },
}

export default function ContactMySafawalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["contact my safawala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
