...
export const metadata: Metadata = {
  ...
  keywords: "safawalas delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalas.com/safawalas-delhi",
    type: "website",
  },
}

export default function SafawalasDelhiPage() {
  const pageData = {
    title: "Safa in India",
