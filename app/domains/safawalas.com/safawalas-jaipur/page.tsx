...
export const metadata: Metadata = {
  ...
  keywords: "safawalas jaipur, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalas.com/safawalas-jaipur",
    type: "website",
  },
}

export default function SafawalasJaipurPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safawalas jaipur", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
