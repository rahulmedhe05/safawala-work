...
export const metadata: Metadata = {
  ...
  keywords: "safawalas weddings, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalas.com/safawalas-weddings",
    type: "website",
  },
}

export default function SafawalasWeddingsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India"],
    seoKeywords: ["safawalas weddings", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
