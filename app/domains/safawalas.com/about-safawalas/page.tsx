...
export const metadata: Metadata = {
  ...
  keywords: "about safawalas, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalas.com/about-safawalas",
    type: "website",
  },
}

export default function AboutSafawalasPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["about safawalas", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
