...
export const metadata: Metadata = {
  ...
  keywords: "safawalas mumbai, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalas.com/safawalas-mumbai",
    type: "website",
  },
}

export default function SafawalasMumbaiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safawalas mumbai", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
