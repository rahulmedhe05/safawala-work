...
export const metadata: Metadata = {
  ...
  keywords: "contact safawalas, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalas.com/contact-safawalas",
    type: "website",
  },
}

export default function ContactSafawalasPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["contact safawalas", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
