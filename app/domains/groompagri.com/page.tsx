...
export const metadata: Metadata = {
  title: "Groom Pagri | Groom's pagri service | Book Online India",
  description: "Groom Pagri - Groom's pagri service. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "groom pagri, groom-pagri, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Groom Pagri | Premium Turban Service",
    description: "Groom's pagri service. Expert turban service across India.",
    url: "https://groompagri.com",
    type: "website",
  },
}

const SPECIALTIES = ['Pagri Tying Expert', 'Style Consultation', 'Matching Outfits', 'All Fabrics']
...
export default function GroomPagriHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Groom's pagri service. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Groom Pagri" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Groom Pagri Specialties</h2>
      ...
      <DynamicAboutSection location="Groom Pagri" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Groom Pagri" state="India" domain="groompagri.com" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
