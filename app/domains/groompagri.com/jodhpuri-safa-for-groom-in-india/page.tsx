...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.com/jodhpuri-safa-for-groom-in-india",
    type: "website",
  },
}
...
export default function JodhpuriSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders"],
