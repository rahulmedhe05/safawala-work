...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://groompagri.com/safa-on-rent-in-india",
    type: "website",
  },
}
...
export default function SafaOnRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue"],
