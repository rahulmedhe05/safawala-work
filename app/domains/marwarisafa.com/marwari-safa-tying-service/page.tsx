...
export const metadata: Metadata = {
  ...
  keywords: "marwari safa tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/marwari-safa-tying-service",
    type: "website",
  },
}

export default function MarwariSafaTyingServicePage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["marwari safa tying service", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
