...
export const metadata: Metadata = {
  ...
  keywords: "best marwari safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/best-marwari-safa",
    type: "website",
  },
}

export default function BestMarwariSafaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India"],
    seoKeywords: ["best marwari safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
