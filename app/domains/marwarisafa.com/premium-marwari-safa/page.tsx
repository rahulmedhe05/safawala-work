...
export const metadata: Metadata = {
  ...
  keywords: "premium marwari safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Highest Premium Quality Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/premium-marwari-safa",
    type: "website",
  },
}

export default function PremiumMarwariSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["premium marwari safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
