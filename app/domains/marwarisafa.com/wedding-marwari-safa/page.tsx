...
export const metadata: Metadata = {
  ...
  keywords: "wedding marwari safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/wedding-marwari-safa",
    type: "website",
  },
}

export default function WeddingMarwariSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding marwari safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
