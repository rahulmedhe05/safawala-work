...
export const metadata: Metadata = {
  ...
  keywords: "marwari safa rental, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/marwari-safa-rental",
    type: "website",
  },
}

export default function MarwariSafaRentalPage() {
  const pageData = {
    ...
    seoKeywords: ["marwari safa rental", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
