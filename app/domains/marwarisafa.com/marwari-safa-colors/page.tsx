...
export const metadata: Metadata = {
  ...
  keywords: "marwari safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/marwari-safa-colors",
    type: "website",
  },
}

export default function MarwariSafaColorsPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
    seoKeywords: ["marwari safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
