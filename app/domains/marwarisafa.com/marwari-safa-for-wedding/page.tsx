...
export const metadata: Metadata = {
  ...
  keywords: "marwari safa for wedding, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/marwari-safa-for-wedding",
    type: "website",
  },
}

export default function MarwariSafaForWeddingPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
    seoKeywords: ["marwari safa for wedding", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
