...
export const metadata: Metadata = {
  ...
  keywords: "groom marwari safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://marwarisafa.com/groom-marwari-safa",
    type: "website",
  },
}

export default function GroomMarwariSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["groom marwari safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
