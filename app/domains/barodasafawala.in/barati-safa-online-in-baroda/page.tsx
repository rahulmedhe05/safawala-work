...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.in/barati-safa-online-in-baroda",
    type: "website",
  },
}
...
export default function BaratiSafaOnlineInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Baroda", "On-site professional service at your Baroda venue", "Free consultation and design preview via WhatsApp"],
