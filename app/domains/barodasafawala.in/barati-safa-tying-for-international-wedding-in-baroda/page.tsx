...
export const metadata: Metadata = {
  ...
  keywords: "barati safa tying for international wedding in baroda, safa Baroda, wedding safa Baroda, safa service Baroda",
  openGraph: {
    title: "Premium Wedding-Grade Barati Safa in Baroda | Safawala India",
    description: "Premium safa service in Baroda by Safawala India.",
    url: "https://barodasafawala.in/barati-safa-tying-for-international-wedding-in-baroda",
    type: "website",
  },
}

export default function BaratiSafaTyingForInternationalWeddingInBarodaPage() {
  const pageData = {
