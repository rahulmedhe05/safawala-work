...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.in/groom-safa-in-baroda",
    type: "website",
  },
}
...
export default function GroomSafaInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Baroda", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Baroda venue", "Perfect fit with maximum comfort guaranteed all day"],
