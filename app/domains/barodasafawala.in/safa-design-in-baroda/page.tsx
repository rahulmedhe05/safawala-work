...
export const metadata: Metadata = {
  ...
  keywords: "safa design in baroda, safa Baroda, wedding safa Baroda, safa service Baroda",
  openGraph: {
    title: "Safa in Baroda | Safawala India",
    description: "Premium safa service in Baroda by Safawala India.",
    url: "https://barodasafawala.in/safa-design-in-baroda",
    type: "website",
  },
}

export default function SafaDesignInBarodaPage() {
  const pageData = {
    ...
    seoKeywords: ["safa design in baroda", "safa Baroda", "wedding safa Baroda", "safa service Baroda"],
    faqs: [
  {
