...
export const metadata: Metadata = {
  title: "Pagri in Baroda | Safawala India",
  description: "Looking for premium pagri in Baroda? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritag...",
  keywords: "pagri in baroda, pagri Baroda, wedding pagri Baroda, pagri service Baroda",
  openGraph: {
    title: "Pagri in Baroda | Safawala India",
    description: "Premium pagri service in Baroda by Safawala India.",
    url: "https://barodasafawala.in/pagri-in-baroda",
    type: "website",
  },
}
...
export default function PagriInBarodaPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium pagri in Baroda? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagri service in Baroda by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Baroda", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagri specialists with 40+ years experience in Baroda"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Pagri in Baroda Destination</h2>
