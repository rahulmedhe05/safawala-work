...
export const metadata: Metadata = {
  title: "Royal courts Pagdi in Baroda | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.in/rajwadi-pagdi-in-baroda",
    type: "website",
  },
}
...
export default function RajwadiPagdiInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Baroda", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal courts Pagdi in Baroda Destination</h2>
