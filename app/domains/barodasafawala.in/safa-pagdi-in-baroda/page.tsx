...
export const metadata: Metadata = {
  ...
  keywords: "safa pagdi in baroda, pagdi Baroda, wedding pagdi Baroda, pagdi service Baroda",
  openGraph: {
    title: "Pagdi in Baroda | Safawala India",
    description: "Premium pagdi service in Baroda by Safawala India.",
    url: "https://barodasafawala.in/safa-pagdi-in-baroda",
    type: "website",
  },
}

export default function SafaPagdiInBarodaPage() {
  const pageData = {
    ...
    seoKeywords: ["safa pagdi in baroda", "pagdi Baroda", "wedding pagdi Baroda", "pagdi service Baroda"],
    faqs: [
  {
