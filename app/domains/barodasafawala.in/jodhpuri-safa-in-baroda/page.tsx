...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa in baroda, safa Baroda, wedding safa Baroda, safa service Baroda",
  openGraph: {
    title: "Jodhpur Safa in Baroda | Safawala India",
    description: "Premium safa service in Baroda by Safawala India.",
    url: "https://barodasafawala.in/jodhpuri-safa-in-baroda",
    type: "website",
  },
}

export default function JodhpuriSafaInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Baroda", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "On-site professional service at your Baroda venue"],
    seoKeywords: ["jodhpuri safa in baroda", "safa Baroda", "wedding safa Baroda", "safa service Baroda"],
    faqs: [
  {
