...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.in/pagdi-in-baroda",
    type: "website",
  },
}
...
export default function PagdiInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Baroda", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Baroda venue", "Competitive pricing for individual and bulk orders"],
