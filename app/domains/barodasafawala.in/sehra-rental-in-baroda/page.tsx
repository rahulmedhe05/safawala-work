...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.in/sehra-rental-in-baroda",
    type: "website",
  },
}
...
export default function SehraRentalInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Expert sehra specialists with 40+ years experience in Baroda", "Emergency last-minute service available in Baroda", "On-site professional service at your Baroda venue", "Authentic traditional tying techniques perfected over generations"],
