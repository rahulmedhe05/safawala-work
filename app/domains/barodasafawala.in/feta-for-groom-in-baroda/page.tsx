...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.in/feta-for-groom-in-baroda",
    type: "website",
  },
}
...
export default function FetaForGroomInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Baroda venue", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp"],
