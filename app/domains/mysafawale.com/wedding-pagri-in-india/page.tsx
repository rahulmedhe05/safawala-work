...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://mysafawale.com/wedding-pagri-in-india",
    type: "website",
  },
}
...
export default function WeddingPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
