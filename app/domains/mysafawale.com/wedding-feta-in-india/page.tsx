...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://mysafawale.com/wedding-feta-in-india",
    type: "website",
  },
}
...
export default function WeddingFetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert feta specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp"],
