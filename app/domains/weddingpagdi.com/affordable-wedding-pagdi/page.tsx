...
export const metadata: Metadata = {
  ...
  keywords: "affordable wedding pagdi, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://weddingpagdi.com/affordable-wedding-pagdi",
    type: "website",
  },
}

export default function AffordableWeddingPagdiPage() {
  const pageData = {
    ...
    seoKeywords: ["affordable wedding pagdi", "pagdi India", "wedding pagdi India", "pagdi service India"],
    faqs: [
  {
