...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagdi in Pune | Safawala India",
  description: "Looking for premium pagdi in Pune? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage ...",
  keywords: "wedding pagdi in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Pune | Safawala India",
    description: "Premium pagdi service in Pune by Safawala India.",
    url: "https://weddingpagdi.com/wedding-pagdi-in-pune",
    type: "website",
  },
}
...
export default function WeddingPagdiInPunePage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium pagdi in Pune? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagdi service in Pune by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Pune", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "On-site professional service at your Pune venue", "Expert pagdi specialists with 40+ years experience in Pune"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Pagdi in Pune Destination</h2>
