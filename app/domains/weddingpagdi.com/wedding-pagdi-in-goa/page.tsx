...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagdi in Goa | Safawala India",
  description: "Looking for premium pagdi in Goa? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage t...",
  keywords: "wedding pagdi in goa, pagdi Goa, wedding pagdi Goa, pagdi service Goa",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Goa | Safawala India",
    description: "Premium pagdi service in Goa by Safawala India.",
    url: "https://weddingpagdi.com/wedding-pagdi-in-goa",
    type: "website",
  },
}
...
export default function WeddingPagdiInGoaPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium pagdi in Goa? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagdi service in Goa by Safawala India.",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Pagdi in Goa Destination</h2>

<p>Safawala Goa presents the most exquisite Pagdi collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
