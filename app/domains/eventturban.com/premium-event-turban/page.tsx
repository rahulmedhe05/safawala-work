...
export const metadata: Metadata = {
  ...
  keywords: "premium event turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Highest Premium Quality Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://eventturban.com/premium-event-turban",
    type: "website",
  },
}

export default function PremiumEventTurbanPage() {
  const pageData = {
    ...
    seoKeywords: ["premium event turban", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
