...
export const metadata: Metadata = {
  ...
  keywords: "event turban in delhi, turban Delhi, wedding turban Delhi, turban service Delhi",
  openGraph: {
    title: "Turban in Delhi | Safawala India",
    description: "Premium turban service in Delhi by Safawala India.",
    url: "https://eventturban.com/event-turban-in-delhi",
    type: "website",
  },
}

export default function EventTurbanInDelhiPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in Delhi", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Delhi venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Delhi"],
    seoKeywords: ["event turban in delhi", "turban Delhi", "wedding turban Delhi", "turban service Delhi"],
    faqs: [
  {
