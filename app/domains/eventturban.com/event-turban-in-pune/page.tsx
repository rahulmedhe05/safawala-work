...
export const metadata: Metadata = {
  title: "Turban in Pune | Safawala India",
  description: "Looking for premium turban in Pune? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage...",
  keywords: "event turban in pune, turban Pune, wedding turban Pune, turban service Pune",
  openGraph: {
    title: "Turban in Pune | Safawala India",
    description: "Premium turban service in Pune by Safawala India.",
    url: "https://eventturban.com/event-turban-in-pune",
    type: "website",
  },
}

export default function EventTurbanInPunePage() {
  const pageData = {
    title: "Turban in Pune",
    shortDescription: "Looking for premium turban in Pune? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium turban service in Pune by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Expert turban specialists with 40+ years experience in Pune", "Complete barati packages with matching coordination", "Emergency last-minute service available in Pune", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["event turban in pune", "turban Pune", "wedding turban Pune", "turban service Pune"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Turban in Pune Destination</h2>
