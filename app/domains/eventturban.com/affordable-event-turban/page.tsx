...
export const metadata: Metadata = {
  ...
  keywords: "affordable event turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://eventturban.com/affordable-event-turban",
    type: "website",
  },
}

export default function AffordableEventTurbanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["affordable event turban", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
