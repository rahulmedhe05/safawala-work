...
export const metadata: Metadata = {
  ...
  keywords: "event turban in goa, turban Goa, wedding turban Goa, turban service Goa",
  openGraph: {
    title: "Turban in Goa | Safawala India",
    description: "Premium turban service in Goa by Safawala India.",
    url: "https://eventturban.com/event-turban-in-goa",
    type: "website",
  },
}

export default function EventTurbanInGoaPage() {
  const pageData = {
    title: "Turban in Goa",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in Goa", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
    seoKeywords: ["event turban in goa", "turban Goa", "wedding turban Goa", "turban service Goa"],
    faqs: [
  {
