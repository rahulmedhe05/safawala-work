...
export const metadata: Metadata = {
  ...
  keywords: "best event turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://eventturban.com/best-event-turban",
    type: "website",
  },
}

export default function BestEventTurbanPage() {
  const pageData = {
    ...
    seoKeywords: ["best event turban", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
