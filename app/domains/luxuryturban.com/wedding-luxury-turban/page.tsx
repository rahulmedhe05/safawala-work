...
export const metadata: Metadata = {
  ...
  keywords: "wedding luxury turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Premium Wedding-Grade Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://luxuryturban.com/wedding-luxury-turban",
    type: "website",
  },
}

export default function WeddingLuxuryTurbanPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding luxury turban", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
