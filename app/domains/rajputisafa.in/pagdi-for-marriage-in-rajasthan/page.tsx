...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for marriage in rajasthan, pagdi Rajasthan, wedding pagdi Rajasthan, pagdi service Rajasthan",
  openGraph: {
    title: "Pagdi in Rajasthan | Safawala India",
    description: "Premium pagdi service in Rajasthan by Safawala India.",
    url: "https://rajputisafa.in/pagdi-for-marriage-in-rajasthan",
    type: "website",
  },
}

export default function PagdiForMarriageInRajasthanPage() {
  const pageData = {
    ...
    seoKeywords: ["pagdi for marriage in rajasthan", "pagdi Rajasthan", "wedding pagdi Rajasthan", "pagdi service Rajasthan"],
    faqs: [
  {
