...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajputisafa.in/pagadi-in-rajasthan",
    type: "website",
  },
}
...
export default function PagadiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Rajasthan venue", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Rajasthan", "Competitive pricing for individual and bulk orders"],
