...
export const metadata: Metadata = {
  title: "Jodhpur Pagdi in Rajasthan | Safawala India",
  ...
  keywords: "jodhpuri pagdi in rajasthan, pagdi Rajasthan, wedding pagdi Rajasthan, pagdi service Rajasthan",
  openGraph: {
    title: "Jodhpur Pagdi in Rajasthan | Safawala India",
    description: "Premium pagdi service in Rajasthan by Safawala India.",
    url: "https://rajputisafa.in/jodhpuri-pagdi-in-rajasthan",
    type: "website",
  },
}

export default function JodhpuriPagdiInRajasthanPage() {
  const pageData = {
    title: "Jodhpur Pagdi in Rajasthan",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Jodhpur Pagdi in Rajasthan Destination</h2>
