...
export const metadata: Metadata = {
  ...
  keywords: "dulha sehra in rajasthan, sehra Rajasthan, wedding sehra Rajasthan, sehra service Rajasthan",
  openGraph: {
    title: "Dulha (Groom) Sehra in Rajasthan | Safawala India",
    description: "Premium sehra service in Rajasthan by Safawala India.",
    url: "https://rajputisafa.in/dulha-sehra-in-rajasthan",
    type: "website",
  },
}

export default function DulhaSehraInRajasthanPage() {
  const pageData = {
...
<p>Safawala Rajasthan presents the most exquisite Sehra collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
