...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajputisafa.in/jodhpuri-safa-design-in-rajasthan",
    type: "website",
  },
}
...
export default function JodhpuriSafaDesignInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in Rajasthan", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Rajasthan venue", "Authentic traditional tying techniques perfected over generations"],
