...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajputisafa.in/feta-for-groom-in-rajasthan",
    type: "website",
  },
}
...
export default function FetaForGroomInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Rajasthan venue", "Customized designs matching your wedding theme and outfit"],
