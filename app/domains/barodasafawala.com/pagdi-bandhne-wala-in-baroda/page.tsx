...
export const metadata: Metadata = {
  title: "Pagdi in Baroda | Safawala India",
  ...
  keywords: "pagdi bandhne wala in baroda, pagdi Baroda, wedding pagdi Baroda, pagdi service Baroda",
  openGraph: {
    title: "Pagdi in Baroda | Safawala India",
    description: "Premium pagdi service in Baroda by Safawala India.",
    url: "https://barodasafawala.com/pagdi-bandhne-wala-in-baroda",
    type: "website",
  },
}

export default function PagdiBandhneWalaInBarodaPage() {
  const pageData = {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Pagdi in Baroda Destination</h2>
