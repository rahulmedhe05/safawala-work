...
export const metadata: Metadata = {
  ...
  keywords: "groom pagdi in baroda, pagdi Baroda, wedding pagdi Baroda, pagdi service Baroda",
  openGraph: {
    title: "Groom Pagdi in Baroda | Safawala India",
    description: "Premium pagdi service in Baroda by Safawala India.",
    url: "https://barodasafawala.com/groom-pagdi-in-baroda",
    type: "website",
  },
}

export default function GroomPagdiInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Baroda venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Baroda"],
    seoKeywords: ["groom pagdi in baroda", "pagdi Baroda", "wedding pagdi Baroda", "pagdi service Baroda"],
    faqs: [
  {
