...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.com/sehra-for-groom-in-baroda",
    type: "website",
  },
}
...
export default function SehraForGroomInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Baroda", "On-site professional service at your Baroda venue", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Baroda", "Authentic traditional tying techniques perfected over generations"],
