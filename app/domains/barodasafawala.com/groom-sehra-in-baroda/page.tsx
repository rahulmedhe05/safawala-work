...
export const metadata: Metadata = {
  title: "Groom Sehra in Baroda | Safawala India",
  ...
  keywords: "groom sehra in baroda, sehra Baroda, wedding sehra Baroda, sehra service Baroda",
  openGraph: {
    title: "Groom Sehra in Baroda | Safawala India",
    description: "Premium sehra service in Baroda by Safawala India.",
    url: "https://barodasafawala.com/groom-sehra-in-baroda",
    type: "website",
  },
}

export default function GroomSehraInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Baroda", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Baroda", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["groom sehra in baroda", "sehra Baroda", "wedding sehra Baroda", "sehra service Baroda"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Sehra in Baroda Destination</h2>
