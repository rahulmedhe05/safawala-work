...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.com/groom-safa-bandhej-in-baroda",
    type: "website",
  },
}
...
export default function GroomSafaBandhejInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Baroda venue", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Baroda", "Customized designs matching your wedding theme and outfit"],
