...
export const metadata: Metadata = {
  ...
  keywords: "sehra in baroda, sehra Baroda, wedding sehra Baroda, sehra service Baroda",
  openGraph: {
    title: "Sehra in Baroda | Safawala India",
    description: "Premium sehra service in Baroda by Safawala India.",
    url: "https://barodasafawala.com/sehra-in-baroda",
    type: "website",
  },
}

export default function SehraInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Baroda", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Baroda", "On-site professional service at your Baroda venue", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["sehra in baroda", "sehra Baroda", "wedding sehra Baroda", "sehra service Baroda"],
    faqs: [
  {
