...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa design in baroda, safa Baroda, wedding safa Baroda, safa service Baroda",
  openGraph: {
    title: "Rajputana Safa in Baroda | Safawala India",
    description: "Premium safa service in Baroda by Safawala India.",
    url: "https://barodasafawala.com/rajputi-safa-design-in-baroda",
    type: "website",
  },
}

export default function RajputiSafaDesignInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Baroda", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Baroda", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["rajputi safa design in baroda", "safa Baroda", "wedding safa Baroda", "safa service Baroda"],
    faqs: [
  {
