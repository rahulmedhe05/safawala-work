...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagri in Baroda | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://barodasafawala.com/wedding-pagri-in-baroda",
    type: "website",
  },
}
...
export default function WeddingPagriInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert pagri specialists with 40+ years experience in Baroda", "Complete barati packages with matching coordination"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Pagri in Baroda Destination</h2>
