...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in baroda, sehra Baroda, wedding sehra Baroda, sehra service Baroda",
  openGraph: {
    title: "Sehra in Baroda | Safawala India",
    description: "Premium sehra service in Baroda by Safawala India.",
    url: "https://barodasafawala.com/sehrabandi-in-baroda",
    type: "website",
  },
}

export default function SehrabandiInBarodaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Baroda venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Baroda", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["sehrabandi in baroda", "sehra Baroda", "wedding sehra Baroda", "sehra service Baroda"],
    faqs: [
  {
