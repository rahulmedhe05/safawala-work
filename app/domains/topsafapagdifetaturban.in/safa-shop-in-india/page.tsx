...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://topsafapagdifetaturban.in/safa-shop-in-india",
    type: "website",
  },
}
...
export default function SafaShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day"],
