...
export const metadata: Metadata = {
  ...
  keywords: "safa pagdi in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/safa-pagdi-in-pune",
    type: "website",
  },
}

export default function SafaPagdiInPunePage() {
  const pageData = {
    title: "Pagdi in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Pune", "Free consultation and design preview via WhatsApp", "On-site professional service at your Pune venue", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Pune"],
    seoKeywords: ["safa pagdi in pune", "pagdi Pune", "wedding pagdi Pune", "pagdi service Pune"],
    faqs: [
  {
