...
export const metadata: Metadata = {
  ...
  keywords: "groom turban shop in pune, turban Pune, wedding turban Pune, turban service Pune",
  openGraph: {
    title: "Groom Turban in Pune | Safawala Pune",
    description: "Premium turban service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/groom-turban-shop-in-pune",
    type: "website",
  },
}

export default function GroomTurbanShopInPunePage() {
  const pageData = {
