...
export const metadata: Metadata = {
  ...
  keywords: "pagdi in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/pagdi-in-pune",
    type: "website",
  },
}

export default function PagdiInPunePage() {
  const pageData = {
    title: "Pagdi in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Emergency last-minute service available in Pune", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Pune venue", "Expert pagdi specialists with 40+ years experience in Pune", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["pagdi in pune", "pagdi Pune", "wedding pagdi Pune", "pagdi service Pune"],
    faqs: [
  {
