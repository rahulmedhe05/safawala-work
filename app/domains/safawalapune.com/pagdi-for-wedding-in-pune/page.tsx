...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for wedding in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/pagdi-for-wedding-in-pune",
    type: "website",
  },
}

export default function PagdiForWeddingInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Pune", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["pagdi for wedding in pune", "pagdi Pune", "wedding pagdi Pune", "pagdi service Pune"],
    faqs: [
  {
