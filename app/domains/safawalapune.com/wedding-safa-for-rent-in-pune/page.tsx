...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa for rent in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/wedding-safa-for-rent-in-pune",
    type: "website",
  },
}

export default function WeddingSafaForRentInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Pune", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["wedding safa for rent in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
