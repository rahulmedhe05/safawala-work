...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Pune | Safawala Pune",
  ...
  keywords: "rajput pagdi in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Rajputana Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/rajput-pagdi-in-pune",
    type: "website",
  },
}

export default function RajputPagdiInPunePage() {
  const pageData = {
    title: "Rajputana Pagdi in Pune",
    ...
    seoKeywords: ["rajput pagdi in pune", "pagdi Pune", "wedding pagdi Pune", "pagdi service Pune"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Pune - Your Premier Rajputana Pagdi in Pune Destination</h2>
