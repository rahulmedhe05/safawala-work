...
export const metadata: Metadata = {
  title: "Jodhpur Safa in Pune | Safawala Pune",
  ...
  keywords: "jodhpuri safa design in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Jodhpur Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/jodhpuri-safa-design-in-pune",
    type: "website",
  },
}

export default function JodhpuriSafaDesignInPunePage() {
  const pageData = {
    title: "Jodhpur Safa in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Pune", "Complete barati packages with matching coordination", "Emergency last-minute service available in Pune", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["jodhpuri safa design in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Pune - Your Premier Jodhpur Safa in Pune Destination</h2>
