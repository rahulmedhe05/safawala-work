...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa on rent in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/wedding-safa-on-rent-in-pune",
    type: "website",
  },
}

export default function WeddingSafaOnRentInPunePage() {
  const pageData = {
