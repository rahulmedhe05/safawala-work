...
export const metadata: Metadata = {
  ...
  keywords: "safa design in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/safa-design-in-pune",
    type: "website",
  },
}

export default function SafaDesignInPunePage() {
  const pageData = {
    title: "Safa in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Pune venue", "Emergency last-minute service available in Pune", "Expert safa specialists with 40+ years experience in Pune", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["safa design in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
