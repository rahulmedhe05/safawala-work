...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi shop in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/wedding-pagdi-shop-in-pune",
    type: "website",
  },
}

export default function WeddingPagdiShopInPunePage() {
  const pageData = {
