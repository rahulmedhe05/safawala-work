...
export const metadata: Metadata = {
  ...
  keywords: "safa for barati in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Barati Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/safa-for-barati-in-pune",
    type: "website",
  },
}

export default function SafaForBaratiInPunePage() {
  const pageData = {
