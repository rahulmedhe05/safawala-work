...
export const metadata: Metadata = {
  ...
  keywords: "safa for men in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/safa-for-men-in-pune",
    type: "website",
  },
}

export default function SafaForMenInPunePage() {
  const pageData = {
    title: "Safa in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "On-site professional service at your Pune venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Pune"],
    seoKeywords: ["safa for men in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
