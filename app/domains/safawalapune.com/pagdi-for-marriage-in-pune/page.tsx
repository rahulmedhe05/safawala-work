...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for marriage in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/pagdi-for-marriage-in-pune",
    type: "website",
  },
}

export default function PagdiForMarriageInPunePage() {
  const pageData = {
    title: "Pagdi in Pune",
    ...
    seoKeywords: ["pagdi for marriage in pune", "pagdi Pune", "wedding pagdi Pune", "pagdi service Pune"],
    faqs: [
  {
