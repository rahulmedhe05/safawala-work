...
export const metadata: Metadata = {
  ...
  keywords: "pagdi bandhne wala in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/pagdi-bandhne-wala-in-pune",
    type: "website",
  },
}

export default function PagdiBandhneWalaInPunePage() {
  const pageData = {
    title: "Pagdi in Pune",
