...
export const metadata: Metadata = {
  ...
  keywords: "groom pagdi in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Groom Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/groom-pagdi-in-pune",
    type: "website",
  },
}

export default function GroomPagdiInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in Pune", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["groom pagdi in pune", "pagdi Pune", "wedding pagdi Pune", "pagdi service Pune"],
    faqs: [
  {
