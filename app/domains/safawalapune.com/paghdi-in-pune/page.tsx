...
export const metadata: Metadata = {
  ...
  keywords: "paghdi in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/paghdi-in-pune",
    type: "website",
  },
}

export default function PaghdiInPunePage() {
  const pageData = {
    title: "Safa in Pune",
