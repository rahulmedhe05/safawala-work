...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Rajputana Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/rajputi-safa-in-pune",
    type: "website",
  },
}

export default function RajputiSafaInPunePage() {
  const pageData = {
