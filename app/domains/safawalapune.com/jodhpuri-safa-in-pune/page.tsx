...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Jodhpur Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/jodhpuri-safa-in-pune",
    type: "website",
  },
}

export default function JodhpuriSafaInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your Pune venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Pune"],
    seoKeywords: ["jodhpuri safa in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
