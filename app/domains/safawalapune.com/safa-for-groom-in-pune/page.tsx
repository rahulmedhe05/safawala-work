...
export const metadata: Metadata = {
  ...
  keywords: "safa for groom in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Groom Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/safa-for-groom-in-pune",
    type: "website",
  },
}

export default function SafaForGroomInPunePage() {
  const pageData = {
