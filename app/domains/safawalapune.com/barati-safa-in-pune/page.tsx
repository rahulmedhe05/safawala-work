...
export const metadata: Metadata = {
  ...
  keywords: "barati safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Barati Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/barati-safa-in-pune",
    type: "website",
  },
}

export default function BaratiSafaInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Pune"],
    seoKeywords: ["barati safa in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
