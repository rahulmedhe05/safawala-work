...
export const metadata: Metadata = {
  ...
  keywords: "dulhe ki pagdi in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/dulhe-ki-pagdi-in-pune",
    type: "website",
  },
}

export default function DulheKiPagdiInPunePage() {
  const pageData = {
    title: "Pagdi in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Pune", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Pune venue", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in Pune"],
    seoKeywords: ["dulhe ki pagdi in pune", "pagdi Pune", "wedding pagdi Pune", "pagdi service Pune"],
    faqs: [
  {
