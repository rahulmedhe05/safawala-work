...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in pune, sehra Pune, wedding sehra Pune, sehra service Pune",
  openGraph: {
    title: "Sehra in Pune | Safawala Pune",
    description: "Premium sehra service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/sehrabandi-in-pune",
    type: "website",
  },
}

export default function SehrabandiInPunePage() {
  const pageData = {
    title: "Sehra in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Pune", "Emergency last-minute service available in Pune", "On-site professional service at your Pune venue", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["sehrabandi in pune", "sehra Pune", "wedding sehra Pune", "sehra service Pune"],
    faqs: [
  {
