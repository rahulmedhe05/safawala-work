...
export const metadata: Metadata = {
  ...
  keywords: "pagadi in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/pagadi-in-pune",
    type: "website",
  },
}

export default function PagadiInPunePage() {
  const pageData = {
    title: "Safa in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Pune", "Free consultation and design preview via WhatsApp", "On-site professional service at your Pune venue"],
    seoKeywords: ["pagadi in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
