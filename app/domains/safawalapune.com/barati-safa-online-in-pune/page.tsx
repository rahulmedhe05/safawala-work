...
export const metadata: Metadata = {
  ...
  keywords: "barati safa online in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Barati Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/barati-safa-online-in-pune",
    type: "website",
  },
}

export default function BaratiSafaOnlineInPunePage() {
  const pageData = {
    ...
    seoKeywords: ["barati safa online in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
