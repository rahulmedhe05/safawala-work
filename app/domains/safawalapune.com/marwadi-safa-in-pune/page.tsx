...
export const metadata: Metadata = {
  title: "Marwar Safa in Pune | Safawala Pune",
  ...
  keywords: "marwadi safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Marwar Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/marwadi-safa-in-pune",
    type: "website",
  },
}

export default function MarwadiSafaInPunePage() {
  const pageData = {
    title: "Marwar Safa in Pune",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Pune - Your Premier Marwar Safa in Pune Destination</h2>
