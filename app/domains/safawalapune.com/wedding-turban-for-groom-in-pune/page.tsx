...
export const metadata: Metadata = {
  ...
  keywords: "wedding turban for groom in pune, turban Pune, wedding turban Pune, turban service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Groom Turban in Pune | Safawala Pune",
    description: "Premium turban service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/wedding-turban-for-groom-in-pune",
    type: "website",
  },
}

export default function WeddingTurbanForGroomInPunePage() {
  const pageData = {
