...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Sehra in Pune | Safawala Pune",
  ...
  keywords: "sehra rental in pune, sehra Pune, wedding sehra Pune, sehra service Pune",
  openGraph: {
    title: "Well-Maintained Rental Collection Sehra in Pune | Safawala Pune",
    description: "Premium sehra service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/sehra-rental-in-pune",
    type: "website",
  },
}

export default function SehraRentalInPunePage() {
  const pageData = {
    title: "Well-Maintained Rental Collection Sehra in Pune",
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["On-site professional service at your Pune venue", "Expert sehra specialists with 40+ years experience in Pune", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Pune", "Complete barati packages with matching coordination"],
    seoKeywords: ["sehra rental in pune", "sehra Pune", "wedding sehra Pune", "sehra service Pune"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Pune - Your Premier Well-Maintained Rental Collection Sehra in Pune Destination</h2>
