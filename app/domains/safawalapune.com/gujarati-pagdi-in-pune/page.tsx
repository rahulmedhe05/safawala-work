...
export const metadata: Metadata = {
  title: "Gujarat Pagdi in Pune | Safawala Pune",
  ...
  keywords: "gujarati pagdi in pune, pagdi Pune, wedding pagdi Pune, pagdi service Pune",
  openGraph: {
    title: "Gujarat Pagdi in Pune | Safawala Pune",
    description: "Premium pagdi service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/gujarati-pagdi-in-pune",
    type: "website",
  },
}

export default function GujaratiPagdiInPunePage() {
  const pageData = {
    title: "Gujarat Pagdi in Pune",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Pune - Your Premier Gujarat Pagdi in Pune Destination</h2>
