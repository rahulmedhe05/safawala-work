...
export const metadata: Metadata = {
  ...
  keywords: "turban in pune, turban Pune, wedding turban Pune, turban service Pune",
  openGraph: {
    title: "Turban in Pune | Safawala Pune",
    description: "Premium turban service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/turban-in-pune",
    type: "website",
  },
}

export default function TurbanInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Pune venue", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Pune", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["turban in pune", "turban Pune", "wedding turban Pune", "turban service Pune"],
    faqs: [
  {
