...
export const metadata: Metadata = {
  ...
  keywords: "sehra dulha in pune, sehra Pune, wedding sehra Pune, sehra service Pune",
  openGraph: {
    title: "Dulha (Groom) Sehra in Pune | Safawala Pune",
    description: "Premium sehra service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/sehra-dulha-in-pune",
    type: "website",
  },
}

export default function SehraDulhaInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Expert sehra specialists with 40+ years experience in Pune", "Emergency last-minute service available in Pune"],
    seoKeywords: ["sehra dulha in pune", "sehra Pune", "wedding sehra Pune", "sehra service Pune"],
    faqs: [
  {
