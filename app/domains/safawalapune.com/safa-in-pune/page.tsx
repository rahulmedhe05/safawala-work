...
export const metadata: Metadata = {
  ...
  keywords: "safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/safa-in-pune",
    type: "website",
  },
}

export default function SafaInPunePage() {
  const pageData = {
    title: "Safa in Pune",
    ...
    seoKeywords: ["safa in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
