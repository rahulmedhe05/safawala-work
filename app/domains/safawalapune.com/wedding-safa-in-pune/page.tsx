...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/wedding-safa-in-pune",
    type: "website",
  },
}

export default function WeddingSafaInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "On-site professional service at your Pune venue", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Pune", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["wedding safa in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
