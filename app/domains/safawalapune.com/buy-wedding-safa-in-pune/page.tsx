...
export const metadata: Metadata = {
  ...
  keywords: "buy wedding safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Pune | Safawala Pune",
    description: "Premium safa service in Pune by Safawala Pune.",
    url: "https://safawalapune.com/buy-wedding-safa-in-pune",
    type: "website",
  },
}

export default function BuyWeddingSafaInPunePage() {
  const pageData = {
    ...
    areas: PUNE_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Pune", "On-site professional service at your Pune venue", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Pune"],
    seoKeywords: ["buy wedding safa in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
