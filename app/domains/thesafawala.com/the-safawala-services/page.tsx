...
export const metadata: Metadata = {
  ...
  keywords: "the safawala services, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://thesafawala.com/the-safawala-services",
    type: "website",
  },
}

export default function TheSafawalaServicesPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["the safawala services", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
