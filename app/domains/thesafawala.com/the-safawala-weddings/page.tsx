...
export const metadata: Metadata = {
  ...
  keywords: "the safawala weddings, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://thesafawala.com/the-safawala-weddings",
    type: "website",
  },
}

export default function TheSafawalaWeddingsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Complete barati packages with matching coordination"],
    seoKeywords: ["the safawala weddings", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
