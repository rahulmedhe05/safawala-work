...
export const metadata: Metadata = {
  ...
  keywords: "the safawala delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://thesafawala.com/the-safawala-delhi",
    type: "website",
  },
}

export default function TheSafawalaDelhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["the safawala delhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
