...
export const metadata: Metadata = {
  ...
  keywords: "about the safawala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://thesafawala.com/about-the-safawala",
    type: "website",
  },
}

export default function AboutTheSafawalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["about the safawala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
