...
export const metadata: Metadata = {
  ...
  keywords: "the safawala mumbai, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://thesafawala.com/the-safawala-mumbai",
    type: "website",
  },
}

export default function TheSafawalaMumbaiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination"],
    seoKeywords: ["the safawala mumbai", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
