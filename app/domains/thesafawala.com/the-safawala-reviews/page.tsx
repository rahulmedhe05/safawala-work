...
export const metadata: Metadata = {
  ...
  keywords: "the safawala reviews, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://thesafawala.com/the-safawala-reviews",
    type: "website",
  },
}

export default function TheSafawalaReviewsPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["the safawala reviews", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
