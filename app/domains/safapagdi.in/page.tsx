...
export const metadata: Metadata = {
  title: "Safa Pagdi | Safa & Pagdi service | Book Online India",
  description: "Safa Pagdi - Safa & Pagdi service. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "safa pagdi, safa-pagdi, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Safa Pagdi | Premium Turban Service",
    description: "Safa & Pagdi service. Expert turban service across India.",
    url: "https://safapagdi.in",
    type: "website",
  },
}

const SPECIALTIES = ['Safa Collection', 'Pagdi Variety', 'Mixed Styles', 'Custom Orders']
...
export default function SafaPagdiHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Safa & Pagdi service. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Safa Pagdi" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Safa Pagdi Specialties</h2>
      ...
      <DynamicAboutSection location="Safa Pagdi" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Safa Pagdi" state="India" domain="safapagdi.in" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
