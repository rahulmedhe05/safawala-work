...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.in/designer-wedding-safa-in-india",
    type: "website",
  },
}
...
export default function DesignerWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination"],
