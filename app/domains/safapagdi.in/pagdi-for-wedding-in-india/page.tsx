...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safapagdi.in/pagdi-for-wedding-in-india",
    type: "website",
  },
}
...
export default function PagdiForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "On-site professional service at your India venue"],
