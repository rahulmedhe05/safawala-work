...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://sharmajisafawala.in/sehra-dulha-in-india",
    type: "website",
  },
}
...
export default function SehraDulhaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
