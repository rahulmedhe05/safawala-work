...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://paghdi.in/pagadi-in-india",
    type: "website",
  },
}
...
export default function PagadiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics"],
