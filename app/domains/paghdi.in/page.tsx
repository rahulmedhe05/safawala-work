...
export const metadata: Metadata = {
  title: "Paghdi | Traditional paghdi service | Book Online India",
  description: "Paghdi - Traditional paghdi service. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "paghdi, paghdi, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Paghdi | Premium Turban Service",
    description: "Traditional paghdi service. Expert turban service across India.",
    url: "https://paghdi.in",
    type: "website",
  },
}

const SPECIALTIES = ['Traditional Paghdi', 'Regional Styles', 'Expert Artisans', 'Cultural Events']
...
export default function PaghdiHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Traditional paghdi service. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Paghdi" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Paghdi Specialties</h2>
      ...
      <DynamicAboutSection location="Paghdi" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Paghdi" state="India" domain="paghdi.in" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
