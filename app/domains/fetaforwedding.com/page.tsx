...
export const metadata: Metadata = {
  title: "Feta for Wedding | Wedding feta specialist | Book Online India",
  description: "Feta for Wedding - Wedding feta specialist. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "feta for wedding, feta-for-wedding, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Feta for Wedding | Premium Turban Service",
    description: "Wedding feta specialist. Expert turban service across India.",
    url: "https://fetaforwedding.com",
    type: "website",
  },
}

const SPECIALTIES = ['Marathi Feta', 'Maharashtrian Style', 'Wedding Pheta', 'Traditional & Modern']
...
export default function FetaforWeddingHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Wedding feta specialist. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Feta for Wedding" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Feta for Wedding Specialties</h2>
      ...
      <DynamicAboutSection location="Feta for Wedding" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Feta for Wedding" state="India" domain="fetaforwedding.com" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
