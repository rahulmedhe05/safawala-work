...
export const metadata: Metadata = {
  ...
  keywords: "groom dulha safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://dulhasafa.com/groom-dulha-safa",
    type: "website",
  },
}

export default function GroomDulhaSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["groom dulha safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
