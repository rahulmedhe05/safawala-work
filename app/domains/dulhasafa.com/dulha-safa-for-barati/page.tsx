...
export const metadata: Metadata = {
  ...
  keywords: "dulha safa for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Dulha (Groom) Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://dulhasafa.com/dulha-safa-for-barati",
    type: "website",
  },
}

export default function DulhaSafaForBaratiPage() {
  const pageData = {
