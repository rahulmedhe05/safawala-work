...
export const metadata: Metadata = {
  ...
  keywords: "dulha safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Dulha (Groom) Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://dulhasafa.com/dulha-safa-colors",
    type: "website",
  },
}

export default function DulhaSafaColorsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["dulha safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
