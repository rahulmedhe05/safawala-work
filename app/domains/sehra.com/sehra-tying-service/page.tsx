...
export const metadata: Metadata = {
  ...
  keywords: "sehra tying service, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/sehra-tying-service",
    type: "website",
  },
}

export default function SehraTyingServicePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["sehra tying service", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
