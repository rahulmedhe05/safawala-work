...
export const metadata: Metadata = {
  ...
  keywords: "sehra colors, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/sehra-colors",
    type: "website",
  },
}

export default function SehraColorsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in India"],
    seoKeywords: ["sehra colors", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
