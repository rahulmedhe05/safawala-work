...
export const metadata: Metadata = {
  ...
  keywords: "sehra rental, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Well-Maintained Rental Collection Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/sehra-rental",
    type: "website",
  },
}

export default function SehraRentalPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Expert sehra specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["sehra rental", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
