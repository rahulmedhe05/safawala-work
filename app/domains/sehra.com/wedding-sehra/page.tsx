...
export const metadata: Metadata = {
  ...
  keywords: "wedding sehra, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Premium Wedding-Grade Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/wedding-sehra",
    type: "website",
  },
}

export default function WeddingSehraPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding sehra", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
