...
export const metadata: Metadata = {
  ...
  keywords: "best sehra, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/best-sehra",
    type: "website",
  },
}

export default function BestSehraPage() {
  const pageData = {
    ...
    seoKeywords: ["best sehra", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
