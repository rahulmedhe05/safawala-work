...
export const metadata: Metadata = {
  ...
  keywords: "groom sehra, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Groom Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/groom-sehra",
    type: "website",
  },
}

export default function GroomSehraPage() {
  const pageData = {
    ...
    seoKeywords: ["groom sehra", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
