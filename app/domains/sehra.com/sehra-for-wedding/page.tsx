...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Sehra in India | Safawala India",
  ...
  keywords: "sehra for wedding, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Premium Wedding-Grade Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/sehra-for-wedding",
    type: "website",
  },
}

export default function SehraForWeddingPage() {
  const pageData = {
    title: "Premium Wedding-Grade Sehra in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert sehra specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["sehra for wedding", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Sehra in India Destination</h2>
