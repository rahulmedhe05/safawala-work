...
export const metadata: Metadata = {
  title: "Barati Sehra in India | Safawala India",
  ...
  keywords: "sehra for barati, sehra India, wedding sehra India, sehra service India",
  openGraph: {
    title: "Barati Sehra in India | Safawala India",
    description: "Premium sehra service in India by Safawala India.",
    url: "https://sehra.com/sehra-for-barati",
    type: "website",
  },
}

export default function SehraForBaratiPage() {
  const pageData = {
    title: "Barati Sehra in India",
    ...
    seoKeywords: ["sehra for barati", "sehra India", "wedding sehra India", "sehra service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Barati Sehra in India Destination</h2>
