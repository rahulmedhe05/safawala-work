...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saffa.in/groom-feta-in-india",
    type: "website",
  },
}
...
export default function GroomFetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Expert feta specialists with 40+ years experience in India"],
