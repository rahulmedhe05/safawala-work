...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saffa.in/safa-on-rent-near-me-in-india",
    type: "website",
  },
}
...
export default function SafaOnRentNearMeInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue"],
