...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saffa.in/wedding-safa-on-rent-in-india",
    type: "website",
  },
}
...
export default function WeddingSafaOnRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India"],
