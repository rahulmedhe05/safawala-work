...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://saffa.in/wedding-pagri-in-india",
    type: "website",
  },
}
...
export default function WeddingPagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagri specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit"],
