...
export const metadata: Metadata = {
  ...
  keywords: "safawala india delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalaindia.com/safawala-india-delhi",
    type: "website",
  },
}

export default function SafawalaIndiaDelhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safawala india delhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
