...
export const metadata: Metadata = {
  ...
  keywords: "about safawala india, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalaindia.com/about-safawala-india",
    type: "website",
  },
}

export default function AboutSafawalaIndiaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["about safawala india", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
