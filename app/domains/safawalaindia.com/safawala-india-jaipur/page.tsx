...
export const metadata: Metadata = {
  ...
  keywords: "safawala india jaipur, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalaindia.com/safawala-india-jaipur",
    type: "website",
  },
}

export default function SafawalaIndiaJaipurPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue"],
    seoKeywords: ["safawala india jaipur", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
