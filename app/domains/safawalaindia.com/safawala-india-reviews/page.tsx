...
export const metadata: Metadata = {
  ...
  keywords: "safawala india reviews, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalaindia.com/safawala-india-reviews",
    type: "website",
  },
}

export default function SafawalaIndiaReviewsPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["safawala india reviews", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
