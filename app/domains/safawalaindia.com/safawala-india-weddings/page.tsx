...
export const metadata: Metadata = {
  ...
  keywords: "safawala india weddings, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalaindia.com/safawala-india-weddings",
    type: "website",
  },
}

export default function SafawalaIndiaWeddingsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["safawala india weddings", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
