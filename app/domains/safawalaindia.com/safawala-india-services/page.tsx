...
export const metadata: Metadata = {
  ...
  keywords: "safawala india services, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawalaindia.com/safawala-india-services",
    type: "website",
  },
}

export default function SafawalaIndiaServicesPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["safawala india services", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
