...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajasthanipagdi.in/sehra-for-groom-in-rajasthan",
    type: "website",
  },
}
...
export default function SehraForGroomInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your Rajasthan venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit"],
