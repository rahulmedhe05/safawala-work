...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajasthanipagdi.in/groom-safa-in-rajasthan",
    type: "website",
  },
}
...
export default function GroomSafaInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Rajasthan", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Rajasthan venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
