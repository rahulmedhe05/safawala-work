...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://srgroomscreations.in/jodhpuri-safa-for-groom-in-india",
    type: "website",
  },
}
...
export default function JodhpuriSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
