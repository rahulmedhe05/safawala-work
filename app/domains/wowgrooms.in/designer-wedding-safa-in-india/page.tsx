...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://wowgrooms.in/designer-wedding-safa-in-india",
    type: "website",
  },
}
...
export default function DesignerWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day"],
