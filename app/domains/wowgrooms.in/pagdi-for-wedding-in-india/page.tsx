...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://wowgrooms.in/pagdi-for-wedding-in-india",
    type: "website",
  },
}
...
export default function PagdiForWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue"],
