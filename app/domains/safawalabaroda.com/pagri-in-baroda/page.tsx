...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.com/pagri-in-baroda",
    type: "website",
  },
}
...
export default function PagriInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["On-site professional service at your Baroda venue", "Expert pagri specialists with 40+ years experience in Baroda", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Baroda", "Customized designs matching your wedding theme and outfit"],
