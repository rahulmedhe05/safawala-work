...
export const metadata: Metadata = {
  title: "Dulha (Groom) Safa in Baroda | Safawala Baroda",
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.com/dulha-safa-in-baroda",
    type: "website",
  },
}
...
export default function DulhaSafaInBarodaPage() {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Baroda - Your Premier Dulha (Groom) Safa in Baroda Destination</h2>
