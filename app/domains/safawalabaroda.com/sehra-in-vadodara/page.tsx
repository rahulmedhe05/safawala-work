...
export const metadata: Metadata = {
  title: "Sehra in Vadodara | Safawala Baroda",
  description: "Looking for premium sehra in Vadodara? Safawala Baroda is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heri...",
  keywords: "sehra in vadodara, sehra Vadodara, wedding sehra Vadodara, sehra service Vadodara",
  openGraph: {
    title: "Sehra in Vadodara | Safawala Baroda",
    description: "Premium sehra service in Vadodara by Safawala Baroda.",
    url: "https://safawalabaroda.com/sehra-in-vadodara",
    type: "website",
  },
}
...
export default function SehraInVadodaraPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium sehra in Vadodara? Safawala Baroda is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium sehra service in Vadodara by Safawala Baroda.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: BARODA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Expert sehra specialists with 40+ years experience in Vadodara", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Vadodara"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Baroda - Your Premier Sehra in Vadodara Destination</h2>
