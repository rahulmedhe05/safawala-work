...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.com/marathi-pheta-in-baroda",
    type: "website",
  },
}
...
export default function MarathiPhetaInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in Baroda", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Baroda"],
