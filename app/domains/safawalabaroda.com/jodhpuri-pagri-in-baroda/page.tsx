...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.com/jodhpuri-pagri-in-baroda",
    type: "website",
  },
}
...
export default function JodhpuriPagriInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "On-site professional service at your Baroda venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
