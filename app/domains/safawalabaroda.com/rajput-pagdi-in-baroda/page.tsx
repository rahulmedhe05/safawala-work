...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Baroda | Safawala Baroda",
  ...
  keywords: "rajput pagdi in baroda, pagdi Baroda, wedding pagdi Baroda, pagdi service Baroda",
  openGraph: {
    title: "Rajputana Pagdi in Baroda | Safawala Baroda",
    description: "Premium pagdi service in Baroda by Safawala Baroda.",
    url: "https://safawalabaroda.com/rajput-pagdi-in-baroda",
    type: "website",
  },
}

export default function RajputPagdiInBarodaPage() {
  const pageData = {
    title: "Rajputana Pagdi in Baroda",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Baroda - Your Premier Rajputana Pagdi in Baroda Destination</h2>
