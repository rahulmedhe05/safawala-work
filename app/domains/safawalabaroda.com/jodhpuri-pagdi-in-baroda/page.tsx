...
export const metadata: Metadata = {
  title: "Jodhpur Pagdi in Baroda | Safawala Baroda",
  ...
  keywords: "jodhpuri pagdi in baroda, pagdi Baroda, wedding pagdi Baroda, pagdi service Baroda",
  openGraph: {
    title: "Jodhpur Pagdi in Baroda | Safawala Baroda",
    description: "Premium pagdi service in Baroda by Safawala Baroda.",
    url: "https://safawalabaroda.com/jodhpuri-pagdi-in-baroda",
    type: "website",
  },
}

export default function JodhpuriPagdiInBarodaPage() {
  const pageData = {
    title: "Jodhpur Pagdi in Baroda",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Baroda - Your Premier Jodhpur Pagdi in Baroda Destination</h2>
