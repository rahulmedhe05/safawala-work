...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.com/safa-in-vadodara",
    type: "website",
  },
}
...
export default function SafaInVadodaraPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Vadodara", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Vadodara", "On-site professional service at your Vadodara venue", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
