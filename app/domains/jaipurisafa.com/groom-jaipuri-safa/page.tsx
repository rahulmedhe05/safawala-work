...
export const metadata: Metadata = {
  ...
  keywords: "groom jaipuri safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jaipurisafa.com/groom-jaipuri-safa",
    type: "website",
  },
}

export default function GroomJaipuriSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["groom jaipuri safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
