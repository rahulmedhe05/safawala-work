...
export const metadata: Metadata = {
  ...
  keywords: "jaipuri safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jaipurisafa.com/jaipuri-safa-colors",
    type: "website",
  },
}

export default function JaipuriSafaColorsPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["jaipuri safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
