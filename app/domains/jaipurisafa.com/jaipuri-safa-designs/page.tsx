...
export const metadata: Metadata = {
  ...
  keywords: "jaipuri safa designs, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jaipurisafa.com/jaipuri-safa-designs",
    type: "website",
  },
}

export default function JaipuriSafaDesignsPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["jaipuri safa designs", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
