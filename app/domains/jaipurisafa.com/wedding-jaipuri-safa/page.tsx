...
export const metadata: Metadata = {
  ...
  keywords: "wedding jaipuri safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://jaipurisafa.com/wedding-jaipuri-safa",
    type: "website",
  },
}

export default function WeddingJaipuriSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding jaipuri safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
