...
export const metadata: Metadata = {
  ...
  keywords: "safa service in goa, safa Goa, wedding safa Goa, safa service Goa",
  openGraph: {
    title: "Safa in Goa | Safawala India",
    description: "Premium safa service in Goa by Safawala India.",
    url: "https://safaservice.com/safa-service-in-goa",
    type: "website",
  },
}

export default function SafaServiceInGoaPage() {
  const pageData = {
    title: "Safa in Goa",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Goa", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["safa service in goa", "safa Goa", "wedding safa Goa", "safa service Goa"],
    faqs: [
  {
