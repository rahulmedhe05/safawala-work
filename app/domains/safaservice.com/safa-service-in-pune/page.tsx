...
export const metadata: Metadata = {
  ...
  keywords: "safa service in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://safaservice.com/safa-service-in-pune",
    type: "website",
  },
}

export default function SafaServiceInPunePage() {
  const pageData = {
    title: "Safa in Pune",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Pune", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Pune", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
    seoKeywords: ["safa service in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
