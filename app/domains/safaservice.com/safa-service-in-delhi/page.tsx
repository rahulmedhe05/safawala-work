...
export const metadata: Metadata = {
  ...
  keywords: "safa service in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Safa in Delhi | Safawala India",
    description: "Premium safa service in Delhi by Safawala India.",
    url: "https://safaservice.com/safa-service-in-delhi",
    type: "website",
  },
}

export default function SafaServiceInDelhiPage() {
  const pageData = {
    title: "Safa in Delhi",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Delhi venue", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in Delhi", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safa service in delhi", "safa Delhi", "wedding safa Delhi", "safa service Delhi"],
    faqs: [
  {
