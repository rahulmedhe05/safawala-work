...
export const metadata: Metadata = {
  ...
  keywords: "contact safawala india, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawala.in/contact-safawala-india",
    type: "website",
  },
}

export default function ContactSafawalaIndiaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
    seoKeywords: ["contact safawala india", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
