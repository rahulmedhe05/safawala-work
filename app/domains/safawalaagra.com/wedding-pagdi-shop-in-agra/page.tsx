...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi shop in agra, pagdi Agra, wedding pagdi Agra, pagdi service Agra",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Agra | Safawala Agra",
    description: "Premium pagdi service in Agra by Safawala Agra.",
    url: "https://safawalaagra.com/wedding-pagdi-shop-in-agra",
    type: "website",
  },
}

export default function WeddingPagdiShopInAgraPage() {
  const pageData = {
    ...
    areas: AGRA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Expert pagdi specialists with 40+ years experience in Agra", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Agra venue"],
    seoKeywords: ["wedding pagdi shop in agra", "pagdi Agra", "wedding pagdi Agra", "pagdi service Agra"],
    faqs: [
  {
