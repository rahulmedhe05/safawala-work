...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in agra, sehra Agra, wedding sehra Agra, sehra service Agra",
  openGraph: {
    title: "Sehra in Agra | Safawala Agra",
    description: "Premium sehra service in Agra by Safawala Agra.",
    url: "https://safawalaagra.com/sehrabandi-in-agra",
    type: "website",
  },
}

export default function SehrabandiInAgraPage() {
  const pageData = {
    title: "Sehra in Agra",
    ...
    areas: AGRA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Agra", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Agra venue", "Expert sehra specialists with 40+ years experience in Agra", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["sehrabandi in agra", "sehra Agra", "wedding sehra Agra", "sehra service Agra"],
    faqs: [
  {
