...
export const metadata: Metadata = {
  ...
  keywords: "pagdi in rajasthan, pagdi Rajasthan, wedding pagdi Rajasthan, pagdi service Rajasthan",
  openGraph: {
    title: "Pagdi in Rajasthan | Safawala India",
    description: "Premium pagdi service in Rajasthan by Safawala India.",
    url: "https://rajasthanipagdi.com/pagdi-in-rajasthan",
    type: "website",
  },
}

export default function PagdiInRajasthanPage() {
  const pageData = {
    ...
    seoKeywords: ["pagdi in rajasthan", "pagdi Rajasthan", "wedding pagdi Rajasthan", "pagdi service Rajasthan"],
    faqs: [
  {
