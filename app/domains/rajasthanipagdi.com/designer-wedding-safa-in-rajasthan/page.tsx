...
export const metadata: Metadata = {
  ...
  keywords: "designer wedding safa in rajasthan, safa Rajasthan, wedding safa Rajasthan, safa service Rajasthan",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Rajasthan | Safawala India",
    description: "Premium safa service in Rajasthan by Safawala India.",
    url: "https://rajasthanipagdi.com/designer-wedding-safa-in-rajasthan",
    type: "website",
  },
}

export default function DesignerWeddingSafaInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in Rajasthan", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Rajasthan", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["designer wedding safa in rajasthan", "safa Rajasthan", "wedding safa Rajasthan", "safa service Rajasthan"],
    faqs: [
  {
