...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalavadodara.com/pagdi-in-vadodara",
    type: "website",
  },
}
...
export default function PagdiInVadodaraPage() {
  const pageData = {
    ...
    keyFeatures: ["Emergency last-minute service available in Vadodara", "Complete barati packages with matching coordination", "On-site professional service at your Vadodara venue", "Expert pagdi specialists with 40+ years experience in Vadodara", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
