...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for groom in vadodara, pagdi Vadodara, wedding pagdi Vadodara, pagdi service Vadodara",
  openGraph: {
    title: "Groom Pagdi in Vadodara | Safawala Vadodara",
    description: "Premium pagdi service in Vadodara by Safawala Vadodara.",
    url: "https://safawalavadodara.com/pagdi-for-groom-in-vadodara",
    type: "website",
  },
}

export default function PagdiForGroomInVadodaraPage() {
  const pageData = {
