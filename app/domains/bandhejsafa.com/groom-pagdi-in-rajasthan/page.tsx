...
export const metadata: Metadata = {
  ...
  keywords: "groom pagdi in rajasthan, pagdi Rajasthan, wedding pagdi Rajasthan, pagdi service Rajasthan",
  openGraph: {
    title: "Groom Pagdi in Rajasthan | Safawala India",
    description: "Premium pagdi service in Rajasthan by Safawala India.",
    url: "https://bandhejsafa.com/groom-pagdi-in-rajasthan",
    type: "website",
  },
}

export default function GroomPagdiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Rajasthan", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Emergency last-minute service available in Rajasthan"],
    seoKeywords: ["groom pagdi in rajasthan", "pagdi Rajasthan", "wedding pagdi Rajasthan", "pagdi service Rajasthan"],
    faqs: [
  {
