...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bandhejsafa.com/dulhe-ka-sehra-in-rajasthan",
    type: "website",
  },
}
...
export default function DulheKaSehraInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Rajasthan venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Rajasthan", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
