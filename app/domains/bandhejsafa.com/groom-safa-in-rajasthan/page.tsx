...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bandhejsafa.com/groom-safa-in-rajasthan",
    type: "website",
  },
}
...
export default function GroomSafaInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Rajasthan venue", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
