...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bandhejsafa.com/marriage-pagdi-in-rajasthan",
    type: "website",
  },
}
...
export default function MarriagePagdiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in Rajasthan", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Rajasthan"],
