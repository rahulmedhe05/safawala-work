...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bandhejsafa.com/jodhpuri-pagri-in-rajasthan",
    type: "website",
  },
}
...
export default function JodhpuriPagriInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert pagri specialists with 40+ years experience in Rajasthan", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Rajasthan venue", "Competitive pricing for individual and bulk orders"],
