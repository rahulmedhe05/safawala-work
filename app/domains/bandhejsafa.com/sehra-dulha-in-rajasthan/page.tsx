...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bandhejsafa.com/sehra-dulha-in-rajasthan",
    type: "website",
  },
}
...
export default function SehraDulhaInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in Rajasthan", "On-site professional service at your Rajasthan venue"],
