...
export const metadata: Metadata = {
  title: "Designer Crafted Safa in Jaipur | Safawala India",
  ...
  keywords: "designer safa in jaipur, safa Jaipur, wedding safa Jaipur, safa service Jaipur",
  openGraph: {
    title: "Designer Crafted Safa in Jaipur | Safawala India",
    description: "Premium safa service in Jaipur by Safawala India.",
    url: "https://designersafa.com/designer-safa-in-jaipur",
    type: "website",
  },
}

export default function DesignerSafaInJaipurPage() {
  const pageData = {
    title: "Designer Crafted Safa in Jaipur",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Designer Crafted Safa in Jaipur Destination</h2>
