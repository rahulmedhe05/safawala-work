...
export const metadata: Metadata = {
  ...
  keywords: "affordable barat safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Baraat Party Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratsafa.com/affordable-barat-safa",
    type: "website",
  },
}

export default function AffordableBaratSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["affordable barat safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
