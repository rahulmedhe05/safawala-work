...
export const metadata: Metadata = {
  title: "Baraat Party Safa in Goa | Safawala India",
  ...
  keywords: "barat safa in goa, safa Goa, wedding safa Goa, safa service Goa",
  openGraph: {
    title: "Baraat Party Safa in Goa | Safawala India",
    description: "Premium safa service in Goa by Safawala India.",
    url: "https://baratsafa.com/barat-safa-in-goa",
    type: "website",
  },
}

export default function BaratSafaInGoaPage() {
  const pageData = {
    title: "Baraat Party Safa in Goa",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Goa", "Emergency last-minute service available in Goa", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["barat safa in goa", "safa Goa", "wedding safa Goa", "safa service Goa"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Baraat Party Safa in Goa Destination</h2>
