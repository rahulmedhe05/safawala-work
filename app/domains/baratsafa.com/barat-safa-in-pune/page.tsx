...
export const metadata: Metadata = {
  title: "Baraat Party Safa in Pune | Safawala India",
  ...
  keywords: "barat safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Baraat Party Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://baratsafa.com/barat-safa-in-pune",
    type: "website",
  },
}

export default function BaratSafaInPunePage() {
  const pageData = {
    title: "Baraat Party Safa in Pune",
    ...
    seoKeywords: ["barat safa in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Baraat Party Safa in Pune Destination</h2>
