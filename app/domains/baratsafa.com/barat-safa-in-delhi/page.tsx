...
export const metadata: Metadata = {
  title: "Baraat Party Safa in Delhi | Safawala India",
  ...
  keywords: "barat safa in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Baraat Party Safa in Delhi | Safawala India",
    description: "Premium safa service in Delhi by Safawala India.",
    url: "https://baratsafa.com/barat-safa-in-delhi",
    type: "website",
  },
}

export default function BaratSafaInDelhiPage() {
  const pageData = {
    title: "Baraat Party Safa in Delhi",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Delhi", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Delhi", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["barat safa in delhi", "safa Delhi", "wedding safa Delhi", "safa service Delhi"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Baraat Party Safa in Delhi Destination</h2>
