...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Safa in Delhi | Safawala India",
    description: "Premium safa service in Delhi by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-in-delhi",
    type: "website",
  },
}

export default function SafaBandhiInDelhiPage() {
  const pageData = {
    title: "Safa in Delhi",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Delhi", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Delhi venue", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["safa bandhi in delhi", "safa Delhi", "wedding safa Delhi", "safa service Delhi"],
    faqs: [
  {
