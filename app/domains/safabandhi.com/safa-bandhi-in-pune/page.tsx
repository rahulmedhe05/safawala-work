...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-in-pune",
    type: "website",
  },
}

export default function SafaBandhiInPunePage() {
  const pageData = {
    title: "Safa in Pune",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Pune", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Pune"],
    seoKeywords: ["safa bandhi in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
