...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-colors",
    type: "website",
  },
}

export default function SafaBandhiColorsPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["safa bandhi colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
