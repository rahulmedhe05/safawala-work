...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi in goa, safa Goa, wedding safa Goa, safa service Goa",
  openGraph: {
    title: "Safa in Goa | Safawala India",
    description: "Premium safa service in Goa by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-in-goa",
    type: "website",
  },
}

export default function SafaBandhiInGoaPage() {
  const pageData = {
    title: "Safa in Goa",
