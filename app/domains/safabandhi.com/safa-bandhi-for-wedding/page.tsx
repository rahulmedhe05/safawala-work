...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi for wedding, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-for-wedding",
    type: "website",
  },
}

export default function SafaBandhiForWeddingPage() {
  const pageData = {
    ...
    seoKeywords: ["safa bandhi for wedding", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
