...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-for-barati",
    type: "website",
  },
}

export default function SafaBandhiForBaratiPage() {
  const pageData = {
    ...
    seoKeywords: ["safa bandhi for barati", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
