...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi in ahmedabad, safa Ahmedabad, wedding safa Ahmedabad, safa service Ahmedabad",
  openGraph: {
    title: "Safa in Ahmedabad | Safawala India",
    description: "Premium safa service in Ahmedabad by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-in-ahmedabad",
    type: "website",
  },
}

export default function SafaBandhiInAhmedabadPage() {
  const pageData = {
    ...
    seoKeywords: ["safa bandhi in ahmedabad", "safa Ahmedabad", "wedding safa Ahmedabad", "safa service Ahmedabad"],
    faqs: [
  {
