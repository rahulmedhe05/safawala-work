...
export const metadata: Metadata = {
  ...
  keywords: "affordable safa bandhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safabandhi.com/affordable-safa-bandhi",
    type: "website",
  },
}

export default function AffordableSafaBandhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue"],
    seoKeywords: ["affordable safa bandhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
