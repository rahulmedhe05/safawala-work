...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-tying-service",
    type: "website",
  },
}

export default function SafaBandhiTyingServicePage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safa bandhi tying service", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
