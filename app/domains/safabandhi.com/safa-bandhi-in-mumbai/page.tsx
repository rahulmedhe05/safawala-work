...
export const metadata: Metadata = {
  ...
  keywords: "safa bandhi in mumbai, safa Mumbai, wedding safa Mumbai, safa service Mumbai",
  openGraph: {
    title: "Safa in Mumbai | Safawala India",
    description: "Premium safa service in Mumbai by Safawala India.",
    url: "https://safabandhi.com/safa-bandhi-in-mumbai",
    type: "website",
  },
}

export default function SafaBandhiInMumbaiPage() {
  const pageData = {
