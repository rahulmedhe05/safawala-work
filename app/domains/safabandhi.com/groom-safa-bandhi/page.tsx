...
export const metadata: Metadata = {
  ...
  keywords: "groom safa bandhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safabandhi.com/groom-safa-bandhi",
    type: "website",
  },
}

export default function GroomSafaBandhiPage() {
  const pageData = {
    ...
    seoKeywords: ["groom safa bandhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
