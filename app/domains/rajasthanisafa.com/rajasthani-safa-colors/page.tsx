...
export const metadata: Metadata = {
  ...
  keywords: "rajasthani safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajasthan Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/rajasthani-safa-colors",
    type: "website",
  },
}

export default function RajasthaniSafaColorsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["rajasthani safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
