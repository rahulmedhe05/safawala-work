...
export const metadata: Metadata = {
  title: "Rajasthan Groom Safa in India | Safawala India",
  ...
  keywords: "groom rajasthani safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajasthan Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/groom-rajasthani-safa",
    type: "website",
  },
}

export default function GroomRajasthaniSafaPage() {
  const pageData = {
    title: "Rajasthan Groom Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India"],
    seoKeywords: ["groom rajasthani safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Rajasthan Groom Safa in India Destination</h2>
