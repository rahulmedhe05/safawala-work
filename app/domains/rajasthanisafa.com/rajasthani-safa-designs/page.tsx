...
export const metadata: Metadata = {
  ...
  keywords: "rajasthani safa designs, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajasthan Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/rajasthani-safa-designs",
    type: "website",
  },
}

export default function RajasthaniSafaDesignsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["rajasthani safa designs", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
