...
export const metadata: Metadata = {
  ...
  keywords: "rajasthani safa for wedding, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Rajasthan Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/rajasthani-safa-for-wedding",
    type: "website",
  },
}

export default function RajasthaniSafaForWeddingPage() {
  const pageData = {
