...
export const metadata: Metadata = {
  ...
  keywords: "wedding rajasthani safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Rajasthan Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/wedding-rajasthani-safa",
    type: "website",
  },
}

export default function WeddingRajasthaniSafaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India"],
    seoKeywords: ["wedding rajasthani safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
