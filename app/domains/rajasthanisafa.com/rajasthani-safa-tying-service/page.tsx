...
export const metadata: Metadata = {
  ...
  keywords: "rajasthani safa tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajasthan Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/rajasthani-safa-tying-service",
    type: "website",
  },
}

export default function RajasthaniSafaTyingServicePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["rajasthani safa tying service", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
