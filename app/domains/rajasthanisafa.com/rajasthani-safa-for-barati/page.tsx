...
export const metadata: Metadata = {
  title: "Rajasthan Barati Safa in India | Safawala India",
  ...
  keywords: "rajasthani safa for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajasthan Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/rajasthani-safa-for-barati",
    type: "website",
  },
}

export default function RajasthaniSafaForBaratiPage() {
  const pageData = {
    title: "Rajasthan Barati Safa in India",
    ...
    seoKeywords: ["rajasthani safa for barati", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Rajasthan Barati Safa in India Destination</h2>
