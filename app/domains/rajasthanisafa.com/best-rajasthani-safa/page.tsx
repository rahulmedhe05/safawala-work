...
export const metadata: Metadata = {
  ...
  keywords: "best rajasthani safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajasthan Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajasthanisafa.com/best-rajasthani-safa",
    type: "website",
  },
}

export default function BestRajasthaniSafaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["best rajasthani safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
