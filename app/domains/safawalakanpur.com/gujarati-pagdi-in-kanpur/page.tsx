...
export const metadata: Metadata = {
  title: "Gujarat Pagdi in Kanpur | Safawala Kanpur",
  ...
  keywords: "gujarati pagdi in kanpur, pagdi Kanpur, wedding pagdi Kanpur, pagdi service Kanpur",
  openGraph: {
    title: "Gujarat Pagdi in Kanpur | Safawala Kanpur",
    description: "Premium pagdi service in Kanpur by Safawala Kanpur.",
    url: "https://safawalakanpur.com/gujarati-pagdi-in-kanpur",
    type: "website",
  },
}

export default function GujaratiPagdiInKanpurPage() {
  const pageData = {
    title: "Gujarat Pagdi in Kanpur",
    ...
    areas: KANPUR_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Kanpur", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Kanpur", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["gujarati pagdi in kanpur", "pagdi Kanpur", "wedding pagdi Kanpur", "pagdi service Kanpur"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kanpur - Your Premier Gujarat Pagdi in Kanpur Destination</h2>
