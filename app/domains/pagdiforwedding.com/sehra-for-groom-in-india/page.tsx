...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforwedding.com/sehra-for-groom-in-india",
    type: "website",
  },
}
...
export default function SehraForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
