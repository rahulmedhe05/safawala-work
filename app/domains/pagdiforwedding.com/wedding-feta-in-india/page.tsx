...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforwedding.com/wedding-feta-in-india",
    type: "website",
  },
}
...
export default function WeddingFetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert feta specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue"],
