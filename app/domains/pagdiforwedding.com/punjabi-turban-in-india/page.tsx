...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforwedding.com/punjabi-turban-in-india",
    type: "website",
  },
}
...
export default function PunjabiTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Expert turban specialists with 40+ years experience in India"],
