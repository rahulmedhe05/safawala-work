...
export const metadata: Metadata = {
  title: "Pagdi for Wedding | Wedding pagdi specialist | Book Online India",
  description: "Pagdi for Wedding - Wedding pagdi specialist. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "pagdi for wedding, pagdi-for-wedding, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Pagdi for Wedding | Premium Turban Service",
    description: "Wedding pagdi specialist. Expert turban service across India.",
    url: "https://pagdiforwedding.com",
    type: "website",
  },
}

const SPECIALTIES = ['Complete Wedding Package', 'Groom & Barati', 'Family Sets', 'Destination Service']
...
export default function PagdiforWeddingHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Wedding pagdi specialist. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Pagdi for Wedding" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Pagdi for Wedding Specialties</h2>
      ...
      <DynamicAboutSection location="Pagdi for Wedding" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Pagdi for Wedding" state="India" domain="pagdiforwedding.com" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
