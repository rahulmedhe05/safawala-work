...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforwedding.com/rajasthani-safa-in-india",
    type: "website",
  },
}
...
export default function RajasthaniSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics"],
