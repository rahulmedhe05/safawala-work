...
export const metadata: Metadata = {
  ...
  keywords: "paghdi in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/paghdi-in-kerala",
    type: "website",
  },
}

export default function PaghdiInKeralaPage() {
  const pageData = {
