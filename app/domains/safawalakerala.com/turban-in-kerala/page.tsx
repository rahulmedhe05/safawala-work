...
export const metadata: Metadata = {
  title: "Turban in Kerala | Safawala Kerala",
  ...
  keywords: "turban in kerala, turban Kerala, wedding turban Kerala, turban service Kerala",
  openGraph: {
    title: "Turban in Kerala | Safawala Kerala",
    description: "Premium turban service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/turban-in-kerala",
    type: "website",
  },
}

export default function TurbanInKeralaPage() {
  const pageData = {
    title: "Turban in Kerala",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Turban in Kerala Destination</h2>
