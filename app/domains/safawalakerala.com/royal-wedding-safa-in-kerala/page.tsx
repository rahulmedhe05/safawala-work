...
export const metadata: Metadata = {
  ...
  keywords: "royal wedding safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/royal-wedding-safa-in-kerala",
    type: "website",
  },
}

export default function RoyalWeddingSafaInKeralaPage() {
  const pageData = {
