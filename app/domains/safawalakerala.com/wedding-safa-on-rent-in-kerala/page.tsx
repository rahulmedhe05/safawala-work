...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa on rent in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/wedding-safa-on-rent-in-kerala",
    type: "website",
  },
}

export default function WeddingSafaOnRentInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Kerala", "On-site professional service at your Kerala venue", "Expert safa specialists with 40+ years experience in Kerala"],
    seoKeywords: ["wedding safa on rent in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
