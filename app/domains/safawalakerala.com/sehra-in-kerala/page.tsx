...
export const metadata: Metadata = {
  ...
  keywords: "sehra in kerala, sehra Kerala, wedding sehra Kerala, sehra service Kerala",
  openGraph: {
    title: "Sehra in Kerala | Safawala Kerala",
    description: "Premium sehra service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/sehra-in-kerala",
    type: "website",
  },
}

export default function SehraInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Kerala", "On-site professional service at your Kerala venue", "Expert sehra specialists with 40+ years experience in Kerala", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["sehra in kerala", "sehra Kerala", "wedding sehra Kerala", "sehra service Kerala"],
    faqs: [
  {
