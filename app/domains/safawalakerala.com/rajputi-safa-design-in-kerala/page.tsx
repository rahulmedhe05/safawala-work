...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa design in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Rajputana Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/rajputi-safa-design-in-kerala",
    type: "website",
  },
}

export default function RajputiSafaDesignInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Kerala venue", "Expert safa specialists with 40+ years experience in Kerala", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["rajputi safa design in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
