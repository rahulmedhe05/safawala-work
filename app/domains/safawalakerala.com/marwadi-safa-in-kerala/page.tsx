...
export const metadata: Metadata = {
  title: "Marwar Safa in Kerala | Safawala Kerala",
  ...
  keywords: "marwadi safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Marwar Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/marwadi-safa-in-kerala",
    type: "website",
  },
}

export default function MarwadiSafaInKeralaPage() {
  const pageData = {
    title: "Marwar Safa in Kerala",
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["On-site professional service at your Kerala venue", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["marwadi safa in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Marwar Safa in Kerala Destination</h2>
