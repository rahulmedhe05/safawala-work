...
export const metadata: Metadata = {
  ...
  keywords: "safa design in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/safa-design-in-kerala",
    type: "website",
  },
}

export default function SafaDesignInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["On-site professional service at your Kerala venue", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Kerala"],
    seoKeywords: ["safa design in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
