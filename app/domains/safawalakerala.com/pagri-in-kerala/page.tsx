...
export const metadata: Metadata = {
  title: "Pagri in Kerala | Safawala Kerala",
  ...
  keywords: "pagri in kerala, pagri Kerala, wedding pagri Kerala, pagri service Kerala",
  openGraph: {
    title: "Pagri in Kerala | Safawala Kerala",
    description: "Premium pagri service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/pagri-in-kerala",
    type: "website",
  },
}

export default function PagriInKeralaPage() {
  const pageData = {
    title: "Pagri in Kerala",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Pagri in Kerala Destination</h2>
