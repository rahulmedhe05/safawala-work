...
export const metadata: Metadata = {
  title: "Royal courts Safa in Kerala | Safawala Kerala",
  ...
  keywords: "rajwadi safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Royal courts Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/rajwadi-safa-in-kerala",
    type: "website",
  },
}

export default function RajwadiSafaInKeralaPage() {
  const pageData = {
    title: "Royal courts Safa in Kerala",
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Kerala", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in Kerala"],
    seoKeywords: ["rajwadi safa in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Royal courts Safa in Kerala Destination</h2>
