...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for wedding in kerala, pagdi Kerala, wedding pagdi Kerala, pagdi service Kerala",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Kerala | Safawala Kerala",
    description: "Premium pagdi service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/pagdi-for-wedding-in-kerala",
    type: "website",
  },
}

export default function PagdiForWeddingInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Expert pagdi specialists with 40+ years experience in Kerala", "Emergency last-minute service available in Kerala", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["pagdi for wedding in kerala", "pagdi Kerala", "wedding pagdi Kerala", "pagdi service Kerala"],
    faqs: [
  {
