...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Kerala | Safawala Kerala",
  ...
  keywords: "rajput pagdi in kerala, pagdi Kerala, wedding pagdi Kerala, pagdi service Kerala",
  openGraph: {
    title: "Rajputana Pagdi in Kerala | Safawala Kerala",
    description: "Premium pagdi service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/rajput-pagdi-in-kerala",
    type: "website",
  },
}

export default function RajputPagdiInKeralaPage() {
  const pageData = {
    title: "Rajputana Pagdi in Kerala",
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Kerala venue", "Expert pagdi specialists with 40+ years experience in Kerala", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["rajput pagdi in kerala", "pagdi Kerala", "wedding pagdi Kerala", "pagdi service Kerala"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Rajputana Pagdi in Kerala Destination</h2>
