...
export const metadata: Metadata = {
  title: "Dulha (Groom) Safa in Kerala | Safawala Kerala",
  ...
  keywords: "dulha safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Dulha (Groom) Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/dulha-safa-in-kerala",
    type: "website",
  },
}

export default function DulhaSafaInKeralaPage() {
  const pageData = {
    title: "Dulha (Groom) Safa in Kerala",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Dulha (Groom) Safa in Kerala Destination</h2>
