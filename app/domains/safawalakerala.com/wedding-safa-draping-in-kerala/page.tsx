...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa draping in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/wedding-safa-draping-in-kerala",
    type: "website",
  },
}

export default function WeddingSafaDrapingInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Kerala", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in Kerala", "Complete barati packages with matching coordination"],
    seoKeywords: ["wedding safa draping in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
