...
export const metadata: Metadata = {
  ...
  keywords: "safa on rent in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/safa-on-rent-in-kerala",
    type: "website",
  },
}

export default function SafaOnRentInKeralaPage() {
  const pageData = {
