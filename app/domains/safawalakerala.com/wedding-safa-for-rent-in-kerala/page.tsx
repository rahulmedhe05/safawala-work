...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa for rent in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/wedding-safa-for-rent-in-kerala",
    type: "website",
  },
}

export default function WeddingSafaForRentInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in Kerala", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Kerala", "On-site professional service at your Kerala venue"],
    seoKeywords: ["wedding safa for rent in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
