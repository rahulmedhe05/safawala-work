...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Jodhpur Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/jodhpuri-safa-in-kerala",
    type: "website",
  },
}

export default function JodhpuriSafaInKeralaPage() {
  const pageData = {
