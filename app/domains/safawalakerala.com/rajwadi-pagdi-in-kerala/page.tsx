...
export const metadata: Metadata = {
  title: "Royal courts Pagdi in Kerala | Safawala Kerala",
  ...
  keywords: "rajwadi pagdi in kerala, pagdi Kerala, wedding pagdi Kerala, pagdi service Kerala",
  openGraph: {
    title: "Royal courts Pagdi in Kerala | Safawala Kerala",
    description: "Premium pagdi service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/rajwadi-pagdi-in-kerala",
    type: "website",
  },
}

export default function RajwadiPagdiInKeralaPage() {
  const pageData = {
    title: "Royal courts Pagdi in Kerala",
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Kerala venue", "Emergency last-minute service available in Kerala", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["rajwadi pagdi in kerala", "pagdi Kerala", "wedding pagdi Kerala", "pagdi service Kerala"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Royal courts Pagdi in Kerala Destination</h2>
