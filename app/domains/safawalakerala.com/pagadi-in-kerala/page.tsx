...
export const metadata: Metadata = {
  ...
  keywords: "pagadi in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/pagadi-in-kerala",
    type: "website",
  },
}

export default function PagadiInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["On-site professional service at your Kerala venue", "Emergency last-minute service available in Kerala", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
    seoKeywords: ["pagadi in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
