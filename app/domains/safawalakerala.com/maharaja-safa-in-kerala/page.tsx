...
export const metadata: Metadata = {
  title: "Royal palaces Safa in Kerala | Safawala Kerala",
  ...
  keywords: "maharaja safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Royal palaces Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/maharaja-safa-in-kerala",
    type: "website",
  },
}

export default function MaharajaSafaInKeralaPage() {
  const pageData = {
    title: "Royal palaces Safa in Kerala",
    ...
    seoKeywords: ["maharaja safa in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Royal palaces Safa in Kerala Destination</h2>
