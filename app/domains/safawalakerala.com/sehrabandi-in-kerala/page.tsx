...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in kerala, sehra Kerala, wedding sehra Kerala, sehra service Kerala",
  openGraph: {
    title: "Sehra in Kerala | Safawala Kerala",
    description: "Premium sehra service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/sehrabandi-in-kerala",
    type: "website",
  },
}

export default function SehrabandiInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Expert sehra specialists with 40+ years experience in Kerala", "On-site professional service at your Kerala venue", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["sehrabandi in kerala", "sehra Kerala", "wedding sehra Kerala", "sehra service Kerala"],
    faqs: [
  {
