...
export const metadata: Metadata = {
  title: "Groom Sehra in Kerala | Safawala Kerala",
  ...
  keywords: "sehra for groom in kerala, sehra Kerala, wedding sehra Kerala, sehra service Kerala",
  openGraph: {
    title: "Groom Sehra in Kerala | Safawala Kerala",
    description: "Premium sehra service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/sehra-for-groom-in-kerala",
    type: "website",
  },
}

export default function SehraForGroomInKeralaPage() {
  const pageData = {
    title: "Groom Sehra in Kerala",
    ...
    seoKeywords: ["sehra for groom in kerala", "sehra Kerala", "wedding sehra Kerala", "sehra service Kerala"],
    faqs: [
  {
    "question": "How early should I book Sehra for my Kerala wedding?",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Groom Sehra in Kerala Destination</h2>

<p>Safawala Kerala presents the most exquisite Sehra collection in the region. Our master craftsmen specialize in creating the perfect turban experience for God's own country celebrations.</p>
