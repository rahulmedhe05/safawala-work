...
export const metadata: Metadata = {
  ...
  keywords: "groom safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Groom Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/groom-safa-in-kerala",
    type: "website",
  },
}

export default function GroomSafaInKeralaPage() {
  const pageData = {
