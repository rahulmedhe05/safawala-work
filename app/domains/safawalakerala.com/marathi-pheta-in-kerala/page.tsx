...
export const metadata: Metadata = {
  title: "Safa in Kerala | Safawala Kerala",
  ...
  keywords: "marathi pheta in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/marathi-pheta-in-kerala",
    type: "website",
  },
}

export default function MarathiPhetaInKeralaPage() {
  const pageData = {
    title: "Safa in Kerala",
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in Kerala", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Kerala venue", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["marathi pheta in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Safa in Kerala Destination</h2>
