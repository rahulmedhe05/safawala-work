...
export const metadata: Metadata = {
  title: "Rajasthan Safa in Kerala | Safawala Kerala",
  ...
  keywords: "rajasthani safa in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Rajasthan Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/rajasthani-safa-in-kerala",
    type: "website",
  },
}

export default function RajasthaniSafaInKeralaPage() {
  const pageData = {
    title: "Rajasthan Safa in Kerala",
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Kerala venue"],
    seoKeywords: ["rajasthani safa in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Kerala - Your Premier Rajasthan Safa in Kerala Destination</h2>
