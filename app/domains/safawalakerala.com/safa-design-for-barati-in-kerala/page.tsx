...
export const metadata: Metadata = {
  ...
  keywords: "safa design for barati in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Barati Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/safa-design-for-barati-in-kerala",
    type: "website",
  },
}

export default function SafaDesignForBaratiInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Kerala", "On-site professional service at your Kerala venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Kerala", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safa design for barati in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
