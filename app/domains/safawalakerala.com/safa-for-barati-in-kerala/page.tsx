...
export const metadata: Metadata = {
  ...
  keywords: "safa for barati in kerala, safa Kerala, wedding safa Kerala, safa service Kerala",
  openGraph: {
    title: "Barati Safa in Kerala | Safawala Kerala",
    description: "Premium safa service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/safa-for-barati-in-kerala",
    type: "website",
  },
}

export default function SafaForBaratiInKeralaPage() {
  const pageData = {
    ...
    areas: KERALA_AREAS,
    keyFeatures: ["On-site professional service at your Kerala venue", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Kerala", "Emergency last-minute service available in Kerala", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safa for barati in kerala", "safa Kerala", "wedding safa Kerala", "safa service Kerala"],
    faqs: [
  {
