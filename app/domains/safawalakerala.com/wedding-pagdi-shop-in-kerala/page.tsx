...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi shop in kerala, pagdi Kerala, wedding pagdi Kerala, pagdi service Kerala",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Kerala | Safawala Kerala",
    description: "Premium pagdi service in Kerala by Safawala Kerala.",
    url: "https://safawalakerala.com/wedding-pagdi-shop-in-kerala",
    type: "website",
  },
}

export default function WeddingPagdiShopInKeralaPage() {
  const pageData = {
