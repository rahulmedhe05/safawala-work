...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Turban in Goa | Safawala India",
  description: "Looking for premium turban in Goa? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage ...",
  keywords: "turban on rent in goa, turban Goa, wedding turban Goa, turban service Goa",
  openGraph: {
    title: "Well-Maintained Rental Collection Turban in Goa | Safawala India",
    description: "Premium turban service in Goa by Safawala India.",
    url: "https://turbanonrent.com/turban-on-rent-in-goa",
    type: "website",
  },
}

export default function TurbanOnRentInGoaPage() {
  const pageData = {
    title: "Well-Maintained Rental Collection Turban in Goa",
    shortDescription: "Looking for premium turban in Goa? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium turban service in Goa by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "On-site professional service at your Goa venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Goa", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["turban on rent in goa", "turban Goa", "wedding turban Goa", "turban service Goa"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Well-Maintained Rental Collection Turban in Goa Destination</h2>

<p>Safawala Goa presents the most exquisite Turban collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
