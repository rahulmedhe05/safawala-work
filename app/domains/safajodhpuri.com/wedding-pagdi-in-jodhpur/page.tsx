...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/wedding-pagdi-in-jodhpur",
    type: "website",
  },
}
...
export default function WeddingPagdiInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Jodhpur", "Free consultation and design preview via WhatsApp"],
