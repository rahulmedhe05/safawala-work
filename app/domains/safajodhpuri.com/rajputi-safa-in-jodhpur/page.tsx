...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/rajputi-safa-in-jodhpur",
    type: "website",
  },
}
...
export default function RajputiSafaInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Jodhpur", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in Jodhpur", "On-site professional service at your Jodhpur venue", "Free consultation and design preview via WhatsApp"],
