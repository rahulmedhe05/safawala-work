...
export const metadata: Metadata = {
  title: "Marwar Safa in Jodhpur | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/marwadi-safa-in-jodhpur",
    type: "website",
  },
}
...
export default function MarwadiSafaInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Jodhpur venue", "Expert safa specialists with 40+ years experience in Jodhpur", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Marwar Safa in Jodhpur Destination</h2>
