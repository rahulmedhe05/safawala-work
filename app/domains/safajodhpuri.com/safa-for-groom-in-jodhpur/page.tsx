...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/safa-for-groom-in-jodhpur",
    type: "website",
  },
}
...
export default function SafaForGroomInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Jodhpur", "Expert safa specialists with 40+ years experience in Jodhpur", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day"],
