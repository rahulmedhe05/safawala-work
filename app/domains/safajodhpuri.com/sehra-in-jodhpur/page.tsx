...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/sehra-in-jodhpur",
    type: "website",
  },
}
...
export default function SehraInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Jodhpur", "Expert sehra specialists with 40+ years experience in Jodhpur", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "On-site professional service at your Jodhpur venue", "Premium materials - silk, brocade, velvet, and designer fabrics"],
