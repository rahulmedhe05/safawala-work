...
export const metadata: Metadata = {
  title: "Royal courts Safa in Jodhpur | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/rajwadi-safa-in-jodhpur",
    type: "website",
  },
}
...
export default function RajwadiSafaInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Jodhpur venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Jodhpur", "Expert safa specialists with 40+ years experience in Jodhpur", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal courts Safa in Jodhpur Destination</h2>
