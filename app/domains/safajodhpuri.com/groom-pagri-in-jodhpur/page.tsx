...
export const metadata: Metadata = {
  title: "Groom Pagri in Jodhpur | Safawala India",
  description: "Looking for premium pagri in Jodhpur? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of herita...",
  keywords: "groom pagri in jodhpur, pagri Jodhpur, wedding pagri Jodhpur, pagri service Jodhpur",
  openGraph: {
    title: "Groom Pagri in Jodhpur | Safawala India",
    description: "Premium pagri service in Jodhpur by Safawala India.",
    url: "https://safajodhpuri.com/groom-pagri-in-jodhpur",
    type: "website",
  },
}
...
export default function GroomPagriInJodhpurPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium pagri in Jodhpur? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagri service in Jodhpur by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagri specialists with 40+ years experience in Jodhpur", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Jodhpur", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Pagri in Jodhpur Destination</h2>
