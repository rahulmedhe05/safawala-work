...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/wedding-safa-for-barati-in-jodhpur",
    type: "website",
  },
}
...
export default function WeddingSafaForBaratiInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Emergency last-minute service available in Jodhpur", "Expert safa specialists with 40+ years experience in Jodhpur", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp"],
