...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/safa-for-barati-in-jodhpur",
    type: "website",
  },
}
...
export default function SafaForBaratiInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Jodhpur", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "On-site professional service at your Jodhpur venue", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination"],
