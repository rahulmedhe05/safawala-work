...
export const metadata: Metadata = {
  title: "Jodhpur Pagri in Jodhpur | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/jodhpuri-pagri-in-jodhpur",
    type: "website",
  },
}
...
export default function JodhpuriPagriInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in Jodhpur", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Jodhpur Pagri in Jodhpur Destination</h2>
