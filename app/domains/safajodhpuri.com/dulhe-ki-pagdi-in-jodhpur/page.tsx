...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.com/dulhe-ki-pagdi-in-jodhpur",
    type: "website",
  },
}
...
export default function DulheKiPagdiInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Jodhpur", "Expert pagdi specialists with 40+ years experience in Jodhpur", "Complete barati packages with matching coordination"],
