...
export const metadata: Metadata = {
  title: "Regal Quality Turban in Delhi | Safawala India",
  description: "Looking for premium turban in Delhi? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritag...",
  keywords: "royal turban in delhi, turban Delhi, wedding turban Delhi, turban service Delhi",
  openGraph: {
    title: "Regal Quality Turban in Delhi | Safawala India",
    description: "Premium turban service in Delhi by Safawala India.",
    url: "https://royalturban.com/royal-turban-in-delhi",
    type: "website",
  },
}

export default function RoyalTurbanInDelhiPage() {
  const pageData = {
    title: "Regal Quality Turban in Delhi",
    shortDescription: "Looking for premium turban in Delhi? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium turban service in Delhi by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Delhi", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Expert turban specialists with 40+ years experience in Delhi"],
    seoKeywords: ["royal turban in delhi", "turban Delhi", "wedding turban Delhi", "turban service Delhi"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Regal Quality Turban in Delhi Destination</h2>

<p>Safawala Delhi presents the most exquisite Turban collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
