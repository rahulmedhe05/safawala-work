...
export const metadata: Metadata = {
  ...
  keywords: "royal turban collection, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Regal Quality Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://royalturban.com/royal-turban-collection",
    type: "website",
  },
}

export default function RoyalTurbanCollectionPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Expert turban specialists with 40+ years experience in India", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["royal turban collection", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
