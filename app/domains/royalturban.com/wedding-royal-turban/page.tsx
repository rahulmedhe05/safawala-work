...
export const metadata: Metadata = {
  ...
  keywords: "wedding royal turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Premium Wedding-Grade Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://royalturban.com/wedding-royal-turban",
    type: "website",
  },
}

export default function WeddingRoyalTurbanPage() {
  const pageData = {
