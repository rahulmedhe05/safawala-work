...
export const metadata: Metadata = {
  ...
  keywords: "affordable groom turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Groom Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://groomturban.com/affordable-groom-turban",
    type: "website",
  },
}

export default function AffordableGroomTurbanPage() {
  const pageData = {
    ...
    seoKeywords: ["affordable groom turban", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
