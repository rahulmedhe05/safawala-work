...
export const metadata: Metadata = {
  title: "Groom Turban in Goa | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://groomturban.com/groom-turban-in-goa",
    type: "website",
  },
}
...
export default function GroomTurbanInGoaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Goa venue", "Expert turban specialists with 40+ years experience in Goa", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Turban in Goa Destination</h2>
