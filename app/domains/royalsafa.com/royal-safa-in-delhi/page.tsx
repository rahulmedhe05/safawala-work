...
export const metadata: Metadata = {
  title: "Regal Quality Safa in Delhi | Safawala India",
  description: "Looking for premium safa in Delhi? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage ...",
  keywords: "royal safa in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Regal Quality Safa in Delhi | Safawala India",
    description: "Premium safa service in Delhi by Safawala India.",
    url: "https://royalsafa.com/royal-safa-in-delhi",
    type: "website",
  },
}

export default function RoyalSafaInDelhiPage() {
  const pageData = {
    title: "Regal Quality Safa in Delhi",
    shortDescription: "Looking for premium safa in Delhi? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium safa service in Delhi by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Delhi venue", "Emergency last-minute service available in Delhi", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["royal safa in delhi", "safa Delhi", "wedding safa Delhi", "safa service Delhi"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Regal Quality Safa in Delhi Destination</h2>

<p>Safawala Delhi presents the most exquisite Safa collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
