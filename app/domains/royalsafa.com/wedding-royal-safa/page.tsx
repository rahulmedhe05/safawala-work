...
export const metadata: Metadata = {
  ...
  keywords: "wedding royal safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://royalsafa.com/wedding-royal-safa",
    type: "website",
  },
}

export default function WeddingRoyalSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding royal safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
