...
export const metadata: Metadata = {
  ...
  keywords: "royal safa collection, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Regal Quality Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://royalsafa.com/royal-safa-collection",
    type: "website",
  },
}

export default function RoyalSafaCollectionPage() {
  const pageData = {
    ...
    seoKeywords: ["royal safa collection", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
