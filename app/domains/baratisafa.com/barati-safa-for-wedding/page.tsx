...
export const metadata: Metadata = {
  ...
  keywords: "barati safa for wedding, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratisafa.com/barati-safa-for-wedding",
    type: "website",
  },
}

export default function BaratiSafaForWeddingPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["barati safa for wedding", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
