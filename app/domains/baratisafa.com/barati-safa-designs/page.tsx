...
export const metadata: Metadata = {
  ...
  keywords: "barati safa designs, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratisafa.com/barati-safa-designs",
    type: "website",
  },
}

export default function BaratiSafaDesignsPage() {
  const pageData = {
    ...
    seoKeywords: ["barati safa designs", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
