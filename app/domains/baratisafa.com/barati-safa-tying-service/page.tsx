...
export const metadata: Metadata = {
  ...
  keywords: "barati safa tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratisafa.com/barati-safa-tying-service",
    type: "website",
  },
}

export default function BaratiSafaTyingServicePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["barati safa tying service", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
