...
export const metadata: Metadata = {
  ...
  keywords: "barati safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratisafa.com/barati-safa-colors",
    type: "website",
  },
}

export default function BaratiSafaColorsPage() {
  const pageData = {
    ...
    seoKeywords: ["barati safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
