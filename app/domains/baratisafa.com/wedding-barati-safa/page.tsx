...
export const metadata: Metadata = {
  ...
  keywords: "wedding barati safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratisafa.com/wedding-barati-safa",
    type: "website",
  },
}

export default function WeddingBaratiSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding barati safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
