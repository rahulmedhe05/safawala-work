...
export const metadata: Metadata = {
  ...
  keywords: "groom barati safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratisafa.com/groom-barati-safa",
    type: "website",
  },
}

export default function GroomBaratiSafaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Complete barati packages with matching coordination"],
    seoKeywords: ["groom barati safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
