...
export const metadata: Metadata = {
  ...
  keywords: "barati safa for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://baratisafa.com/barati-safa-for-barati",
    type: "website",
  },
}

export default function BaratiSafaForBaratiPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["barati safa for barati", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
