...
export const metadata: Metadata = {
  title: "Dulha (Groom) Sehra in Jodhpur | Safawala India",
  description: "Looking for premium sehra in Jodhpur? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of herita...",
  keywords: "dulha sehra in jodhpur, sehra Jodhpur, wedding sehra Jodhpur, sehra service Jodhpur",
  openGraph: {
    title: "Dulha (Groom) Sehra in Jodhpur | Safawala India",
    description: "Premium sehra service in Jodhpur by Safawala India.",
    url: "https://safajodhpuri.in/dulha-sehra-in-jodhpur",
    type: "website",
  },
}
...
export default function DulhaSehraInJodhpurPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium sehra in Jodhpur? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium sehra service in Jodhpur by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Jodhpur venue", "Emergency last-minute service available in Jodhpur", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Dulha (Groom) Sehra in Jodhpur Destination</h2>
