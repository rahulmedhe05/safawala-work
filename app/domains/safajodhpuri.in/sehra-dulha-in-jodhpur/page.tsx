...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.in/sehra-dulha-in-jodhpur",
    type: "website",
  },
}
...
export default function SehraDulhaInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Jodhpur", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in Jodhpur", "On-site professional service at your Jodhpur venue"],
