...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.in/designer-wedding-safa-in-jodhpur",
    type: "website",
  },
}
...
export default function DesignerWeddingSafaInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Jodhpur", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day"],
