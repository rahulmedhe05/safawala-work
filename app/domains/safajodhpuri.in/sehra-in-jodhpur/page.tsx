...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.in/sehra-in-jodhpur",
    type: "website",
  },
}
...
export default function SehraInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in Jodhpur", "Emergency last-minute service available in Jodhpur", "Premium materials - silk, brocade, velvet, and designer fabrics"],
