...
export const metadata: Metadata = {
  title: "Groom Pagdi in Jodhpur | Safawala India",
  description: "Looking for premium pagdi in Jodhpur? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of herita...",
  keywords: "vadodara groom pagdi in jodhpur, pagdi Jodhpur, wedding pagdi Jodhpur, pagdi service Jodhpur",
  openGraph: {
    title: "Groom Pagdi in Jodhpur | Safawala India",
    description: "Premium pagdi service in Jodhpur by Safawala India.",
    url: "https://safajodhpuri.in/vadodara-groom-pagdi-in-jodhpur",
    type: "website",
  },
}
...
export default function VadodaraGroomPagdiInJodhpurPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium pagdi in Jodhpur? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagdi service in Jodhpur by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Jodhpur venue", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in Jodhpur", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Pagdi in Jodhpur Destination</h2>

<p>Safawala Jodhpur presents the most exquisite Pagdi collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
