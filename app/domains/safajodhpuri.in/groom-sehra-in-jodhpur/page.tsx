...
export const metadata: Metadata = {
  title: "Groom Sehra in Jodhpur | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.in/groom-sehra-in-jodhpur",
    type: "website",
  },
}
...
export default function GroomSehraInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Jodhpur", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Jodhpur", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Sehra in Jodhpur Destination</h2>
