...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.in/pagdi-in-jodhpur",
    type: "website",
  },
}
...
export default function PagdiInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Jodhpur", "Competitive pricing for individual and bulk orders", "On-site professional service at your Jodhpur venue"],
