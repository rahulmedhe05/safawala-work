...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.in/safa-shop-in-jodhpur",
    type: "website",
  },
}
...
export default function SafaShopInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Jodhpur", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "On-site professional service at your Jodhpur venue", "Customized designs matching your wedding theme and outfit"],
