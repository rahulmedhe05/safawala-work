...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safajodhpuri.in/pagdi-for-groom-in-jodhpur",
    type: "website",
  },
}
...
export default function PagdiForGroomInJodhpurPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Jodhpur", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp"],
