...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.com/punjabi-turban-in-india",
    type: "website",
  },
}
...
export default function PunjabiTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day"],
