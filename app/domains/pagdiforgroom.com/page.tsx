...
export const metadata: Metadata = {
  title: "Pagdi for Groom | Traditional pagdi service | Book Online India",
  description: "Pagdi for Groom - Traditional pagdi service. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "pagdi for groom, pagdi-for-groom, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Pagdi for Groom | Premium Turban Service",
    description: "Traditional pagdi service. Expert turban service across India.",
    url: "https://pagdiforgroom.com",
    type: "website",
  },
}

const SPECIALTIES = ['Traditional Pagdi Styles', 'Modern Fusion', 'Expert Tying', 'All Occasions']
...
export default function PagdiforGroomHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Traditional pagdi service. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Pagdi for Groom" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Pagdi for Groom Specialties</h2>
      ...
      <DynamicAboutSection location="Pagdi for Groom" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Pagdi for Groom" state="India" domain="pagdiforgroom.com" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
