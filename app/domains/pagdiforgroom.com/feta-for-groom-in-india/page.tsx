...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdiforgroom.com/feta-for-groom-in-india",
    type: "website",
  },
}
...
export default function FetaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations"],
