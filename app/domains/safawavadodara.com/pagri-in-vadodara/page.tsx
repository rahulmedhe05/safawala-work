...
export const metadata: Metadata = {
  title: "Pagri in Vadodara | Safawala India",
  description: "Looking for premium pagri in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of herit...",
  keywords: "pagri in vadodara, pagri Vadodara, wedding pagri Vadodara, pagri service Vadodara",
  openGraph: {
    title: "Pagri in Vadodara | Safawala India",
    description: "Premium pagri service in Vadodara by Safawala India.",
    url: "https://safawavadodara.com/pagri-in-vadodara",
    type: "website",
  },
}
...
export default function PagriInVadodaraPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium pagri in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagri service in Vadodara by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Vadodara venue", "Customized designs matching your wedding theme and outfit", "Expert pagri specialists with 40+ years experience in Vadodara", "Emergency last-minute service available in Vadodara", "Perfect fit with maximum comfort guaranteed all day"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Pagri in Vadodara Destination</h2>
