...
export const metadata: Metadata = {
  title: "Sehra in Vadodara | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/sehra-in-vadodara",
    type: "website",
  },
}
...
export default function SehraInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Vadodara", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Vadodara venue", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Vadodara"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Sehra in Vadodara Destination</h2>
