...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/wedding-safa-for-rent-in-vadodara",
    type: "website",
  },
}
...
export default function WeddingSafaForRentInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Vadodara", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Vadodara", "On-site professional service at your Vadodara venue", "Competitive pricing for individual and bulk orders"],
