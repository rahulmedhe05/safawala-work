...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/sehrabandi-in-vadodara",
    type: "website",
  },
}
...
export default function SehrabandiInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Expert sehra specialists with 40+ years experience in Vadodara", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Vadodara venue", "Free consultation and design preview via WhatsApp"],
