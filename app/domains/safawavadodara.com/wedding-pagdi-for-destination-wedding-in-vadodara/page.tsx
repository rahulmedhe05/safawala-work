...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagdi in Vadodara | Safawala India",
  description: "Looking for premium pagdi in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of herit...",
  keywords: "wedding pagdi for destination wedding in vadodara, pagdi Vadodara, wedding pagdi Vadodara, pagdi service Vadodara",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Vadodara | Safawala India",
    description: "Premium pagdi service in Vadodara by Safawala India.",
    url: "https://safawavadodara.com/wedding-pagdi-for-destination-wedding-in-vadodara",
    type: "website",
  },
}
...
export default function WeddingPagdiForDestinationWeddingInVadodaraPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium pagdi in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagdi service in Vadodara by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Vadodara", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Vadodara venue", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Pagdi in Vadodara Destination</h2>

<p>Safawala Vadodara presents the most exquisite Pagdi collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
