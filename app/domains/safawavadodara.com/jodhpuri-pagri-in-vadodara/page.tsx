...
export const metadata: Metadata = {
  title: "Jodhpur Pagri in Vadodara | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/jodhpuri-pagri-in-vadodara",
    type: "website",
  },
}
...
export default function JodhpuriPagriInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "On-site professional service at your Vadodara venue", "Emergency last-minute service available in Vadodara", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Jodhpur Pagri in Vadodara Destination</h2>
