...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/groom-pagdi-in-vadodara",
    type: "website",
  },
}
...
export default function GroomPagdiInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Vadodara", "Expert pagdi specialists with 40+ years experience in Vadodara", "On-site professional service at your Vadodara venue", "Complete barati packages with matching coordination"],
