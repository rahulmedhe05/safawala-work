...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Safa in Vadodara | Safawala India",
  description: "Looking for premium safa in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of herita...",
  keywords: "custom wedding safa in vadodara, safa Vadodara, wedding safa Vadodara, safa service Vadodara",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Vadodara | Safawala India",
    description: "Premium safa service in Vadodara by Safawala India.",
    url: "https://safawavadodara.com/custom-wedding-safa-in-vadodara",
    type: "website",
  },
}
...
export default function CustomWeddingSafaInVadodaraPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium safa in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium safa service in Vadodara by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "On-site professional service at your Vadodara venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Vadodara", "Complete barati packages with matching coordination"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Safa in Vadodara Destination</h2>

<p>Safawala Vadodara presents the most exquisite Safa collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
