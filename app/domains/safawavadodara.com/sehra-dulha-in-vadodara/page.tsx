...
export const metadata: Metadata = {
  title: "Dulha (Groom) Sehra in Vadodara | Safawala India",
  description: "Looking for premium sehra in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of herit...",
  keywords: "sehra dulha in vadodara, sehra Vadodara, wedding sehra Vadodara, sehra service Vadodara",
  openGraph: {
    title: "Dulha (Groom) Sehra in Vadodara | Safawala India",
    description: "Premium sehra service in Vadodara by Safawala India.",
    url: "https://safawavadodara.com/sehra-dulha-in-vadodara",
    type: "website",
  },
}
...
export default function SehraDulhaInVadodaraPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium sehra in Vadodara? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium sehra service in Vadodara by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Vadodara", "On-site professional service at your Vadodara venue", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Dulha (Groom) Sehra in Vadodara Destination</h2>
