...
export const metadata: Metadata = {
  title: "Royal courts Safa in Vadodara | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/rajwadi-safa-in-vadodara",
    type: "website",
  },
}
...
export default function RajwadiSafaInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Vadodara", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Vadodara venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Vadodara"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal courts Safa in Vadodara Destination</h2>
