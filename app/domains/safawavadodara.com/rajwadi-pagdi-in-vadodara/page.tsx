...
export const metadata: Metadata = {
  title: "Royal courts Pagdi in Vadodara | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/rajwadi-pagdi-in-vadodara",
    type: "website",
  },
}
...
export default function RajwadiPagdiInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Vadodara venue", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Vadodara", "Free consultation and design preview via WhatsApp"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal courts Pagdi in Vadodara Destination</h2>
