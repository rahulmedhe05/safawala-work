...
export const metadata: Metadata = {
  title: "Pagdi in Vadodara | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/safa-pagdi-in-vadodara",
    type: "website",
  },
}
...
export default function SafaPagdiInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "On-site professional service at your Vadodara venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Vadodara", "Emergency last-minute service available in Vadodara"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Pagdi in Vadodara Destination</h2>
