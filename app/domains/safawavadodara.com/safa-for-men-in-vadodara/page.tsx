...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/safa-for-men-in-vadodara",
    type: "website",
  },
}
...
export default function SafaForMenInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Vadodara", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
