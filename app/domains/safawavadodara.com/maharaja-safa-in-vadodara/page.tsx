...
export const metadata: Metadata = {
  title: "Royal palaces Safa in Vadodara | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/maharaja-safa-in-vadodara",
    type: "website",
  },
}
...
export default function MaharajaSafaInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Vadodara venue", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Vadodara", "Emergency last-minute service available in Vadodara", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal palaces Safa in Vadodara Destination</h2>
