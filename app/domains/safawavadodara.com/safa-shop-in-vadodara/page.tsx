...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawavadodara.com/safa-shop-in-vadodara",
    type: "website",
  },
}
...
export default function SafaShopInVadodaraPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Vadodara", "On-site professional service at your Vadodara venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Vadodara", "Perfect fit with maximum comfort guaranteed all day"],
