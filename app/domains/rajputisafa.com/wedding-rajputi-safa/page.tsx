...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Rajputana Safa in India | Safawala India",
  ...
  keywords: "wedding rajputi safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Rajputana Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajputisafa.com/wedding-rajputi-safa",
    type: "website",
  },
}

export default function WeddingRajputiSafaPage() {
  const pageData = {
    title: "Premium Wedding-Grade Rajputana Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["wedding rajputi safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Rajputana Safa in India Destination</h2>
