...
export const metadata: Metadata = {
  ...
  keywords: "safa tying service in rajasthan, safa Rajasthan, wedding safa Rajasthan, safa service Rajasthan",
  openGraph: {
    title: "Safa in Rajasthan | Safawala India",
    description: "Premium safa service in Rajasthan by Safawala India.",
    url: "https://rajputisafa.com/safa-tying-service-in-rajasthan",
    type: "website",
  },
}

export default function SafaTyingServiceInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your Rajasthan venue", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Rajasthan"],
    seoKeywords: ["safa tying service in rajasthan", "safa Rajasthan", "wedding safa Rajasthan", "safa service Rajasthan"],
    faqs: [
  {
