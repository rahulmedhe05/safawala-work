...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajputisafa.com/dulha-pagri-in-rajasthan",
    type: "website",
  },
}
...
export default function DulhaPagriInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Rajasthan venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagri specialists with 40+ years experience in Rajasthan", "Complete barati packages with matching coordination"],
