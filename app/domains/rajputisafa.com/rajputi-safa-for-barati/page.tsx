...
export const metadata: Metadata = {
  title: "Rajputana Barati Safa in India | Safawala India",
  ...
  keywords: "rajputi safa for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajputana Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajputisafa.com/rajputi-safa-for-barati",
    type: "website",
  },
}

export default function RajputiSafaForBaratiPage() {
  const pageData = {
    title: "Rajputana Barati Safa in India",
    ...
    seoKeywords: ["rajputi safa for barati", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Rajputana Barati Safa in India Destination</h2>
