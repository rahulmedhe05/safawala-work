...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa designs, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajputana Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajputisafa.com/rajputi-safa-designs",
    type: "website",
  },
}

export default function RajputiSafaDesignsPage() {
  const pageData = {
    ...
    seoKeywords: ["rajputi safa designs", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
