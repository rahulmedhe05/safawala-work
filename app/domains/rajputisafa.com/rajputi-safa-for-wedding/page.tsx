...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa for wedding, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Rajputana Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajputisafa.com/rajputi-safa-for-wedding",
    type: "website",
  },
}

export default function RajputiSafaForWeddingPage() {
  const pageData = {
    ...
    seoKeywords: ["rajputi safa for wedding", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
