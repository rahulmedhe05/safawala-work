...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for groom in rajasthan, pagdi Rajasthan, wedding pagdi Rajasthan, pagdi service Rajasthan",
  openGraph: {
    title: "Groom Pagdi in Rajasthan | Safawala India",
    description: "Premium pagdi service in Rajasthan by Safawala India.",
    url: "https://rajputisafa.com/pagdi-for-groom-in-rajasthan",
    type: "website",
  },
}

export default function PagdiForGroomInRajasthanPage() {
  const pageData = {
    ...
    seoKeywords: ["pagdi for groom in rajasthan", "pagdi Rajasthan", "wedding pagdi Rajasthan", "pagdi service Rajasthan"],
    faqs: [
  {
