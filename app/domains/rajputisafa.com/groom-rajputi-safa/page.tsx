...
export const metadata: Metadata = {
  title: "Rajputana Groom Safa in India | Safawala India",
  ...
  keywords: "groom rajputi safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajputana Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajputisafa.com/groom-rajputi-safa",
    type: "website",
  },
}

export default function GroomRajputiSafaPage() {
  const pageData = {
    title: "Rajputana Groom Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["groom rajputi safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Rajputana Groom Safa in India Destination</h2>
