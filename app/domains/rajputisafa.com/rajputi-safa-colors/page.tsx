...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajputana Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajputisafa.com/rajputi-safa-colors",
    type: "website",
  },
}

export default function RajputiSafaColorsPage() {
  const pageData = {
    ...
    seoKeywords: ["rajputi safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
