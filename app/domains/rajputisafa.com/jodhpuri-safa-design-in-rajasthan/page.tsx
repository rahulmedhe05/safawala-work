...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajputisafa.com/jodhpuri-safa-design-in-rajasthan",
    type: "website",
  },
}
...
export default function JodhpuriSafaDesignInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Rajasthan venue", "Expert safa specialists with 40+ years experience in Rajasthan", "Authentic traditional tying techniques perfected over generations"],
