...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Rajputana Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://rajputisafa.com/rajputi-safa-tying-service",
    type: "website",
  },
}

export default function RajputiSafaTyingServicePage() {
  const pageData = {
