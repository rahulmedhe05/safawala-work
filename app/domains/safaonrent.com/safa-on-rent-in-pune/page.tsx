...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Safa in Pune | Safawala India",
  description: "Looking for premium safa in Pune? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage t...",
  keywords: "safa on rent in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://safaonrent.com/safa-on-rent-in-pune",
    type: "website",
  },
}

export default function SafaOnRentInPunePage() {
  const pageData = {
    title: "Well-Maintained Rental Collection Safa in Pune",
    shortDescription: "Looking for premium safa in Pune? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium safa service in Pune by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Pune", "Emergency last-minute service available in Pune", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["safa on rent in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Well-Maintained Rental Collection Safa in Pune Destination</h2>
