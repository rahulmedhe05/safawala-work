...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Safa in Goa | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://safaonrent.com/safa-on-rent-in-goa",
    type: "website",
  },
}
...
export default function SafaOnRentInGoaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Goa", "On-site professional service at your Goa venue"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Well-Maintained Rental Collection Safa in Goa Destination</h2>
