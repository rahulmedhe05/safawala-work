...
export const metadata: Metadata = {
  ...
  keywords: "premium safa on rent, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Highest Premium Quality Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safaonrent.com/premium-safa-on-rent",
    type: "website",
  },
}

export default function PremiumSafaOnRentPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["premium safa on rent", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
