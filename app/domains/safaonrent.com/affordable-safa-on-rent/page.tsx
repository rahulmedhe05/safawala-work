...
export const metadata: Metadata = {
  ...
  keywords: "affordable safa on rent, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safaonrent.com/affordable-safa-on-rent",
    type: "website",
  },
}

export default function AffordableSafaOnRentPage() {
  const pageData = {
    ...
    seoKeywords: ["affordable safa on rent", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
