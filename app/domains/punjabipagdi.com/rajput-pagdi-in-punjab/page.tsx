...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Punjab | Safawala India",
  ...
  keywords: "rajput pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Rajputana Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/rajput-pagdi-in-punjab",
    type: "website",
  },
}

export default function RajputPagdiInPunjabPage() {
  const pageData = {
    title: "Rajputana Pagdi in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["rajput pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Rajputana Pagdi in Punjab Destination</h2>
