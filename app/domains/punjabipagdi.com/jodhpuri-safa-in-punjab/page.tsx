...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Jodhpur Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/jodhpuri-safa-in-punjab",
    type: "website",
  },
}

export default function JodhpuriSafaInPunjabPage() {
  const pageData = {
    ...
    seoKeywords: ["jodhpuri safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
