...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/wedding-turban-in-punjab",
    type: "website",
  },
}
...
export default function WeddingTurbanInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Punjab", "On-site professional service at your Punjab venue", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders"],
