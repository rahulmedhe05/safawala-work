...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/dulha-pagdi-in-punjab",
    type: "website",
  },
}
...
export default function DulhaPagdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Punjab", "Free consultation and design preview via WhatsApp"],
