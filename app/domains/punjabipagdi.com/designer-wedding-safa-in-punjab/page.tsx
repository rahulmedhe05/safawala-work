...
export const metadata: Metadata = {
  ...
  keywords: "designer wedding safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/designer-wedding-safa-in-punjab",
    type: "website",
  },
}

export default function DesignerWeddingSafaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "On-site professional service at your Punjab venue", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["designer wedding safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
