...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Rajputana Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/rajputi-safa-in-punjab",
    type: "website",
  },
}

export default function RajputiSafaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Punjab", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in Punjab", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["rajputi safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
