...
export const metadata: Metadata = {
  title: "Jodhpur Pagdi in Punjab | Safawala India",
  ...
  keywords: "jodhpuri pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Jodhpur Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/jodhpuri-pagdi-in-punjab",
    type: "website",
  },
}

export default function JodhpuriPagdiInPunjabPage() {
  const pageData = {
    title: "Jodhpur Pagdi in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Punjab", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Punjab venue", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["jodhpuri pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Jodhpur Pagdi in Punjab Destination</h2>
