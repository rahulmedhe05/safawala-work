...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa for rent in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/wedding-safa-for-rent-in-punjab",
    type: "website",
  },
}

export default function WeddingSafaForRentInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Emergency last-minute service available in Punjab", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Punjab"],
    seoKeywords: ["wedding safa for rent in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
