...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/paghdi-in-punjab",
    type: "website",
  },
}
...
export default function PaghdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Punjab venue", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Punjab", "Emergency last-minute service available in Punjab", "Perfect fit with maximum comfort guaranteed all day"],
