...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/customized-sehra-for-baraat-in-punjab",
    type: "website",
  },
}
...
export default function CustomizedSehraForBaraatInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Punjab", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Punjab venue"],
