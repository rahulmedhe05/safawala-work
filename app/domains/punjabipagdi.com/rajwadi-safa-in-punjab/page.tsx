...
export const metadata: Metadata = {
  title: "Royal courts Safa in Punjab | Safawala India",
  ...
  keywords: "rajwadi safa in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Royal courts Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/rajwadi-safa-in-punjab",
    type: "website",
  },
}

export default function RajwadiSafaInPunjabPage() {
  const pageData = {
    title: "Royal courts Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "On-site professional service at your Punjab venue", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in Punjab"],
    seoKeywords: ["rajwadi safa in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal courts Safa in Punjab Destination</h2>
