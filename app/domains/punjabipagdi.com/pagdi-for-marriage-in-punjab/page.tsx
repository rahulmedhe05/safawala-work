...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/pagdi-for-marriage-in-punjab",
    type: "website",
  },
}
...
export default function PagdiForMarriageInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "On-site professional service at your Punjab venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Punjab", "Emergency last-minute service available in Punjab"],
