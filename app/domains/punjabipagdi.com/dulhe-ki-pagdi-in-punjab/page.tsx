...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/dulhe-ki-pagdi-in-punjab",
    type: "website",
  },
}
...
export default function DulheKiPagdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Punjab venue", "Emergency last-minute service available in Punjab", "Competitive pricing for individual and bulk orders"],
