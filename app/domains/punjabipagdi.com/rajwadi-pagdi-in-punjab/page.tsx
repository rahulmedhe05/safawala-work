...
export const metadata: Metadata = {
  title: "Royal courts Pagdi in Punjab | Safawala India",
  ...
  keywords: "rajwadi pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Royal courts Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/rajwadi-pagdi-in-punjab",
    type: "website",
  },
}

export default function RajwadiPagdiInPunjabPage() {
  const pageData = {
    title: "Royal courts Pagdi in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Punjab", "On-site professional service at your Punjab venue", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["rajwadi pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal courts Pagdi in Punjab Destination</h2>
