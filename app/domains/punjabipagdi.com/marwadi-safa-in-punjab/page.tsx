...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/marwadi-safa-in-punjab",
    type: "website",
  },
}
...
export default function MarwadiSafaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
