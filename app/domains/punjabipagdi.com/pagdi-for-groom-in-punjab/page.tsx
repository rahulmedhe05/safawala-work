...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/pagdi-for-groom-in-punjab",
    type: "website",
  },
}
...
export default function PagdiForGroomInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Expert pagdi specialists with 40+ years experience in Punjab", "Emergency last-minute service available in Punjab", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit"],
