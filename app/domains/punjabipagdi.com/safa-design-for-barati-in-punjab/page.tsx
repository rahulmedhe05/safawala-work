...
export const metadata: Metadata = {
  ...
  keywords: "safa design for barati in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Barati Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/safa-design-for-barati-in-punjab",
    type: "website",
  },
}

export default function SafaDesignForBaratiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "On-site professional service at your Punjab venue", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Punjab", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["safa design for barati in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
