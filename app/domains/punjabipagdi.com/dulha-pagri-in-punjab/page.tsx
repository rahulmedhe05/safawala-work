...
export const metadata: Metadata = {
  title: "Dulha (Groom) Pagri in Punjab | Safawala India",
  ...
  keywords: "dulha pagri in punjab, pagri Punjab, wedding pagri Punjab, pagri service Punjab",
  openGraph: {
    title: "Dulha (Groom) Pagri in Punjab | Safawala India",
    description: "Premium pagri service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/dulha-pagri-in-punjab",
    type: "website",
  },
}

export default function DulhaPagriInPunjabPage() {
  const pageData = {
    title: "Dulha (Groom) Pagri in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your Punjab venue", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert pagri specialists with 40+ years experience in Punjab", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["dulha pagri in punjab", "pagri Punjab", "wedding pagri Punjab", "pagri service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Dulha (Groom) Pagri in Punjab Destination</h2>
