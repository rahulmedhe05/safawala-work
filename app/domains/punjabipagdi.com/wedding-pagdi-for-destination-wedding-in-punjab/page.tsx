...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/wedding-pagdi-for-destination-wedding-in-punjab",
    type: "website",
  },
}
...
export default function WeddingPagdiForDestinationWeddingInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in Punjab", "On-site professional service at your Punjab venue", "Complete barati packages with matching coordination"],
