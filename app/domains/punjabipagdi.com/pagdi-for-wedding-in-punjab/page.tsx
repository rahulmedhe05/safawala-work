...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for wedding in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/pagdi-for-wedding-in-punjab",
    type: "website",
  },
}

export default function PagdiForWeddingInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Punjab venue", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Punjab"],
    seoKeywords: ["pagdi for wedding in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
