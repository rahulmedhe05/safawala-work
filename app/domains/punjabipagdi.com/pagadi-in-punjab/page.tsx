...
export const metadata: Metadata = {
  ...
  keywords: "pagadi in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/pagadi-in-punjab",
    type: "website",
  },
}

export default function PagadiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Punjab venue", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Punjab"],
    seoKeywords: ["pagadi in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
