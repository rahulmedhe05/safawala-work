...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/sehrabandi-in-punjab",
    type: "website",
  },
}
...
export default function SehrabandiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Punjab", "Emergency last-minute service available in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
