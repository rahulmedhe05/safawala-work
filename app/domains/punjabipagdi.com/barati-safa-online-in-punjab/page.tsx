...
export const metadata: Metadata = {
  title: "Barati Safa in Punjab | Safawala India",
  ...
  keywords: "barati safa online in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Barati Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/barati-safa-online-in-punjab",
    type: "website",
  },
}

export default function BaratiSafaOnlineInPunjabPage() {
  const pageData = {
    title: "Barati Safa in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Punjab", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "On-site professional service at your Punjab venue", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["barati safa online in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Barati Safa in Punjab Destination</h2>
