...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/safa-on-rent-in-punjab",
    type: "website",
  },
}
...
export default function SafaOnRentInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "On-site professional service at your Punjab venue", "Expert safa specialists with 40+ years experience in Punjab", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
