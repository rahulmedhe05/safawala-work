...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/safa-for-groom-in-punjab",
    type: "website",
  },
}
...
export default function SafaForGroomInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in Punjab", "Free consultation and design preview via WhatsApp"],
