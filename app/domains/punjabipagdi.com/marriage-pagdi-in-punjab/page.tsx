...
export const metadata: Metadata = {
  ...
  keywords: "marriage pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/marriage-pagdi-in-punjab",
    type: "website",
  },
}

export default function MarriagePagdiInPunjabPage() {
  const pageData = {
