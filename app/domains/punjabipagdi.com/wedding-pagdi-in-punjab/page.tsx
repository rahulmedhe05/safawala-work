...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/wedding-pagdi-in-punjab",
    type: "website",
  },
}

export default function WeddingPagdiInPunjabPage() {
  const pageData = {
