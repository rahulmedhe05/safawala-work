...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/groom-safa-in-punjab",
    type: "website",
  },
}
...
export default function GroomSafaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Emergency last-minute service available in Punjab"],
