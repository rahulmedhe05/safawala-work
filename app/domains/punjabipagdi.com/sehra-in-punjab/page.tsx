...
export const metadata: Metadata = {
  ...
  keywords: "sehra in punjab, sehra Punjab, wedding sehra Punjab, sehra service Punjab",
  openGraph: {
    title: "Sehra in Punjab | Safawala India",
    description: "Premium sehra service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/sehra-in-punjab",
    type: "website",
  },
}

export default function SehraInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Punjab"],
    seoKeywords: ["sehra in punjab", "sehra Punjab", "wedding sehra Punjab", "sehra service Punjab"],
    faqs: [
  {
