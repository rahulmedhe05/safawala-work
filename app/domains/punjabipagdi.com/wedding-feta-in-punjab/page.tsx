...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/wedding-feta-in-punjab",
    type: "website",
  },
}
...
export default function WeddingFetaInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert feta specialists with 40+ years experience in Punjab", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
