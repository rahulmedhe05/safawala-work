...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/jodhpuri-pagri-in-punjab",
    type: "website",
  },
}
...
export default function JodhpuriPagriInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your Punjab venue", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Punjab", "Expert pagri specialists with 40+ years experience in Punjab", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day"],
