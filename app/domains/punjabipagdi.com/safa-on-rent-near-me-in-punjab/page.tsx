...
export const metadata: Metadata = {
  ...
  keywords: "safa on rent near me in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Well-Maintained Rental Collection Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/safa-on-rent-near-me-in-punjab",
    type: "website",
  },
}

export default function SafaOnRentNearMeInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Punjab", "Competitive pricing for individual and bulk orders", "On-site professional service at your Punjab venue"],
    seoKeywords: ["safa on rent near me in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
