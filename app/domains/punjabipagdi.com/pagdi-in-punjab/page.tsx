...
export const metadata: Metadata = {
  ...
  keywords: "pagdi in punjab, pagdi Punjab, wedding pagdi Punjab, pagdi service Punjab",
  openGraph: {
    title: "Pagdi in Punjab | Safawala India",
    description: "Premium pagdi service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/pagdi-in-punjab",
    type: "website",
  },
}

export default function PagdiInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your Punjab venue", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Punjab", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["pagdi in punjab", "pagdi Punjab", "wedding pagdi Punjab", "pagdi service Punjab"],
    faqs: [
  {
  ...
  {
    "question": "Do you provide matching Pagdi for barati in Punjab?",
