...
export const metadata: Metadata = {
  title: "Pagri in Punjab | Safawala India",
  ...
  keywords: "pagri in punjab, pagri Punjab, wedding pagri Punjab, pagri service Punjab",
  openGraph: {
    title: "Pagri in Punjab | Safawala India",
    description: "Premium pagri service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/pagri-in-punjab",
    type: "website",
  },
}

export default function PagriInPunjabPage() {
  const pageData = {
    title: "Pagri in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["pagri in punjab", "pagri Punjab", "wedding pagri Punjab", "pagri service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Pagri in Punjab Destination</h2>
