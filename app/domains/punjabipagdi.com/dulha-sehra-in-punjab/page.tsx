...
export const metadata: Metadata = {
  title: "Dulha (Groom) Sehra in Punjab | Safawala India",
  ...
  keywords: "dulha sehra in punjab, sehra Punjab, wedding sehra Punjab, sehra service Punjab",
  openGraph: {
    title: "Dulha (Groom) Sehra in Punjab | Safawala India",
    description: "Premium sehra service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/dulha-sehra-in-punjab",
    type: "website",
  },
}

export default function DulhaSehraInPunjabPage() {
  const pageData = {
    title: "Dulha (Groom) Sehra in Punjab",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Punjab", "On-site professional service at your Punjab venue", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Punjab", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["dulha sehra in punjab", "sehra Punjab", "wedding sehra Punjab", "sehra service Punjab"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Dulha (Groom) Sehra in Punjab Destination</h2>
