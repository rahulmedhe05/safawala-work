...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagri in Punjab | Safawala India",
  description: "Looking for premium pagri in Punjab? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritag...",
  keywords: "wedding pagri in punjab, pagri Punjab, wedding pagri Punjab, pagri service Punjab",
  openGraph: {
    title: "Premium Wedding-Grade Pagri in Punjab | Safawala India",
    description: "Premium pagri service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/wedding-pagri-in-punjab",
    type: "website",
  },
}

export default function WeddingPagriInPunjabPage() {
  const pageData = {
    title: "Premium Wedding-Grade Pagri in Punjab",
    shortDescription: "Looking for premium pagri in Punjab? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagri service in Punjab by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagri specialists with 40+ years experience in Punjab", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Emergency last-minute service available in Punjab"],
    seoKeywords: ["wedding pagri in punjab", "pagri Punjab", "wedding pagri Punjab", "pagri service Punjab"],
    faqs: [
  {
  ...
  {
    "question": "What is the price of Pagri in Punjab?",
    "answer": "Our Pagri prices in Punjab start from \u20b9500 for basic options and go up to \u20b95000+ for premium designer pieces. We offer packages for individuals and bulk orders for barati. Contact us for a customized quote based on your specific requirements."
  },
  {
  ...
  {
    "question": "Do you provide on-site Pagri tying service in Punjab?",
    "answer": "Yes, we provide professional on-site Pagri tying service across all Punjab areas. Our expert turban specialists will come to your venue fully equipped to ensure perfect styling for the groom and barati."
  },
  {
    "question": "Do you offer Pagri for destination weddings outside Punjab?",
    "answer": "Yes, we provide Pagri services for destination weddings across India and internationally. Our team regularly travels to provide services at luxury hotels, resorts, and wedding venues outside Punjab."
  }
],
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Pagri in Punjab Destination</h2>

<p>Discover the art of Pagri with Safawala Punjab. We combine traditional expertise with contemporary elegance to create stunning turbans that make you the center of attraction.</p>


<h2>Why Choose Safawala Punjab for Pagri?</h2>

<p>When it comes to <strong>pagri</strong> in Punjab, Safawala stands apart as the region's most trusted turban specialists. Here's why families across Punjab choose us:</p>

<h3>40+ Years of Turban Excellence</h3>
<p>Our pagri expertise comes from four generations of dedicated craftsmanship. We understand the cultural significance of every turban and deliver perfection for your special occasions in Punjab.</p>
...
<p>We provide on-site pagri services across all Punjab areas. Our team arrives fully prepared with complete collections, professional equipment, and backup options.</p>



<h2>Our Pagri Services in Punjab</h2>
...
<h2>Book Your Pagri in Punjab</h2>

<p>Ready to experience the finest pagri service in Punjab? Booking is simple:</p>
