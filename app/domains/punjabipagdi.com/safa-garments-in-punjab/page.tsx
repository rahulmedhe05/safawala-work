...
export const metadata: Metadata = {
  ...
  keywords: "safa garments in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/safa-garments-in-punjab",
    type: "website",
  },
}

export default function SafaGarmentsInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "On-site professional service at your Punjab venue", "Emergency last-minute service available in Punjab", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safa garments in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
