...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://punjabipagdi.com/wedding-safa-bandhej-in-punjab",
    type: "website",
  },
}
...
export default function WeddingSafaBandhejInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Punjab", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "On-site professional service at your Punjab venue", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp"],
