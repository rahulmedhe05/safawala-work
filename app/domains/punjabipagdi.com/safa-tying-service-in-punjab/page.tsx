...
export const metadata: Metadata = {
  ...
  keywords: "safa tying service in punjab, safa Punjab, wedding safa Punjab, safa service Punjab",
  openGraph: {
    title: "Safa in Punjab | Safawala India",
    description: "Premium safa service in Punjab by Safawala India.",
    url: "https://punjabipagdi.com/safa-tying-service-in-punjab",
    type: "website",
  },
}

export default function SafaTyingServiceInPunjabPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Punjab venue", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Punjab", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["safa tying service in punjab", "safa Punjab", "wedding safa Punjab", "safa service Punjab"],
    faqs: [
  {
