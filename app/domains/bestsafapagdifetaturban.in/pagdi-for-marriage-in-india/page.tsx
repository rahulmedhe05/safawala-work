...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bestsafapagdifetaturban.in/pagdi-for-marriage-in-india",
    type: "website",
  },
}
...
export default function PagdiForMarriageInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in India"],
