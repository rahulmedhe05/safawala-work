...
export const metadata: Metadata = {
  ...
  keywords: "pagdi tying service, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://pagdi.com/pagdi-tying-service",
    type: "website",
  },
}

export default function PagdiTyingServicePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in India", "On-site professional service at your India venue"],
    seoKeywords: ["pagdi tying service", "pagdi India", "wedding pagdi India", "pagdi service India"],
    faqs: [
  {
