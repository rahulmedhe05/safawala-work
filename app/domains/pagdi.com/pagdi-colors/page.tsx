...
export const metadata: Metadata = {
  ...
  keywords: "pagdi colors, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://pagdi.com/pagdi-colors",
    type: "website",
  },
}

export default function PagdiColorsPage() {
  const pageData = {
    ...
    seoKeywords: ["pagdi colors", "pagdi India", "wedding pagdi India", "pagdi service India"],
    faqs: [
  {
