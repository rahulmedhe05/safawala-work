...
export const metadata: Metadata = {
  ...
  keywords: "pagdi designs, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://pagdi.com/pagdi-designs",
    type: "website",
  },
}

export default function PagdiDesignsPage() {
  const pageData = {
    ...
    seoKeywords: ["pagdi designs", "pagdi India", "wedding pagdi India", "pagdi service India"],
    faqs: [
  {
