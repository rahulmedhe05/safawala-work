...
export const metadata: Metadata = {
  ...
  keywords: "premium pagdi, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Highest Premium Quality Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://pagdi.com/premium-pagdi",
    type: "website",
  },
}

export default function PremiumPagdiPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["premium pagdi", "pagdi India", "wedding pagdi India", "pagdi service India"],
    faqs: [
  {
