...
export const metadata: Metadata = {
  ...
  keywords: "groom pagdi, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Groom Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://pagdi.com/groom-pagdi",
    type: "website",
  },
}

export default function GroomPagdiPage() {
  const pageData = {
    ...
    seoKeywords: ["groom pagdi", "pagdi India", "wedding pagdi India", "pagdi service India"],
    faqs: [
  {
