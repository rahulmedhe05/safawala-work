...
export const metadata: Metadata = {
  title: "Barati Pagdi in India | Safawala India",
  ...
  keywords: "pagdi for barati, pagdi India, wedding pagdi India, pagdi service India",
  openGraph: {
    title: "Barati Pagdi in India | Safawala India",
    description: "Premium pagdi service in India by Safawala India.",
    url: "https://pagdi.com/pagdi-for-barati",
    type: "website",
  },
}

export default function PagdiForBaratiPage() {
  const pageData = {
    title: "Barati Pagdi in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["pagdi for barati", "pagdi India", "wedding pagdi India", "pagdi service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Barati Pagdi in India Destination</h2>
