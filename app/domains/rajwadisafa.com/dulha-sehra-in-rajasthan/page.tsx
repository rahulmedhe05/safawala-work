...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajwadisafa.com/dulha-sehra-in-rajasthan",
    type: "website",
  },
}
...
export default function DulhaSehraInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Rajasthan venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
