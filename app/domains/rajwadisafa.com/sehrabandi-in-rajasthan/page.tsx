...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in rajasthan, sehra Rajasthan, wedding sehra Rajasthan, sehra service Rajasthan",
  openGraph: {
    title: "Sehra in Rajasthan | Safawala India",
    description: "Premium sehra service in Rajasthan by Safawala India.",
    url: "https://rajwadisafa.com/sehrabandi-in-rajasthan",
    type: "website",
  },
}

export default function SehrabandiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Rajasthan", "On-site professional service at your Rajasthan venue"],
    seoKeywords: ["sehrabandi in rajasthan", "sehra Rajasthan", "wedding sehra Rajasthan", "sehra service Rajasthan"],
    faqs: [
  {
