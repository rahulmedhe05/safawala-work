...
export const metadata: Metadata = {
  title: "Dulha (Groom) Sehra in Rajasthan | Safawala India",
  ...
  keywords: "sehra dulha in rajasthan, sehra Rajasthan, wedding sehra Rajasthan, sehra service Rajasthan",
  openGraph: {
    title: "Dulha (Groom) Sehra in Rajasthan | Safawala India",
    description: "Premium sehra service in Rajasthan by Safawala India.",
    url: "https://rajwadisafa.com/sehra-dulha-in-rajasthan",
    type: "website",
  },
}

export default function SehraDulhaInRajasthanPage() {
  const pageData = {
    title: "Dulha (Groom) Sehra in Rajasthan",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Rajasthan venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Rajasthan"],
    seoKeywords: ["sehra dulha in rajasthan", "sehra Rajasthan", "wedding sehra Rajasthan", "sehra service Rajasthan"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Dulha (Groom) Sehra in Rajasthan Destination</h2>
