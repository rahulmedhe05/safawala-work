...
export const metadata: Metadata = {
  title: "Groom Sehra in Rajasthan | Safawala India",
  ...
  keywords: "sehra for groom in rajasthan, sehra Rajasthan, wedding sehra Rajasthan, sehra service Rajasthan",
  openGraph: {
    title: "Groom Sehra in Rajasthan | Safawala India",
    description: "Premium sehra service in Rajasthan by Safawala India.",
    url: "https://rajwadisafa.com/sehra-for-groom-in-rajasthan",
    type: "website",
  },
}

export default function SehraForGroomInRajasthanPage() {
  const pageData = {
    title: "Groom Sehra in Rajasthan",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Rajasthan", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert sehra specialists with 40+ years experience in Rajasthan"],
    seoKeywords: ["sehra for groom in rajasthan", "sehra Rajasthan", "wedding sehra Rajasthan", "sehra service Rajasthan"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Sehra in Rajasthan Destination</h2>
