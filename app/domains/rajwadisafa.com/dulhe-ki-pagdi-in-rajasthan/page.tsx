...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajwadisafa.com/dulhe-ki-pagdi-in-rajasthan",
    type: "website",
  },
}
...
export default function DulheKiPagdiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Rajasthan", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Rajasthan venue", "Emergency last-minute service available in Rajasthan"],
