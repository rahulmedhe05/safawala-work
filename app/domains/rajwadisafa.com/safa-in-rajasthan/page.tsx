...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://rajwadisafa.com/safa-in-rajasthan",
    type: "website",
  },
}
...
export default function SafaInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Rajasthan", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "On-site professional service at your Rajasthan venue", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
