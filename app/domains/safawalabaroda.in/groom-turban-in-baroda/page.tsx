...
export const metadata: Metadata = {
  ...
  keywords: "groom turban in baroda, turban Baroda, wedding turban Baroda, turban service Baroda",
  openGraph: {
    title: "Groom Turban in Baroda | Safawala Baroda",
    description: "Premium turban service in Baroda by Safawala Baroda.",
    url: "https://safawalabaroda.in/groom-turban-in-baroda",
    type: "website",
  },
}

export default function GroomTurbanInBarodaPage() {
  const pageData = {
