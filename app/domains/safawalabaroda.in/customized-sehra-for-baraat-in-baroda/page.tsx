...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/customized-sehra-for-baraat-in-baroda",
    type: "website",
  },
}
...
export default function CustomizedSehraForBaraatInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Emergency last-minute service available in Baroda", "Expert sehra specialists with 40+ years experience in Baroda", "On-site professional service at your Baroda venue"],
