...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/safa-on-rent-in-baroda",
    type: "website",
  },
}
...
export default function SafaOnRentInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "On-site professional service at your Baroda venue", "Expert safa specialists with 40+ years experience in Baroda", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Baroda", "Authentic traditional tying techniques perfected over generations"],
