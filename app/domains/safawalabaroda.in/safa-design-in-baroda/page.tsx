...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/safa-design-in-baroda",
    type: "website",
  },
}
...
export default function SafaDesignInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Baroda", "On-site professional service at your Baroda venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Baroda", "Complete barati packages with matching coordination"],
