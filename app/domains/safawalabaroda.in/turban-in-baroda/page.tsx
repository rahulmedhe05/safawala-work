...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/turban-in-baroda",
    type: "website",
  },
}
...
export default function TurbanInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Baroda", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Baroda venue"],
