...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/traditional-wedding-safa-in-baroda",
    type: "website",
  },
}
...
export default function TraditionalWeddingSafaInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Baroda", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
