...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/jodhpuri-safa-design-in-baroda",
    type: "website",
  },
}
...
export default function JodhpuriSafaDesignInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Baroda", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Baroda venue", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders"],
