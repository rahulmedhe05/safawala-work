...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/marathi-pheta-in-baroda",
    type: "website",
  },
}
...
export default function MarathiPhetaInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "On-site professional service at your Baroda venue", "Emergency last-minute service available in Baroda", "Expert safa specialists with 40+ years experience in Baroda", "Free consultation and design preview via WhatsApp"],
