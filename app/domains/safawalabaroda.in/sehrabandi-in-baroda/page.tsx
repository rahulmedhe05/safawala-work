...
export const metadata: Metadata = {
  title: "Sehra in Baroda | Safawala Baroda",
  ...
  openGraph: {
    ...
    url: "https://safawalabaroda.in/sehrabandi-in-baroda",
    type: "website",
  },
}
...
export default function SehrabandiInBarodaPage() {
  const pageData = {
    ...
    areas: BARODA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Baroda", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Baroda venue", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Baroda - Your Premier Sehra in Baroda Destination</h2>
