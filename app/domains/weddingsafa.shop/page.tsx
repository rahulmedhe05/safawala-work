...
export const metadata: Metadata = {
  title: "Wedding Safa | Wedding safa shop | Book Online India",
  description: "Wedding Safa - Wedding safa shop. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "wedding safa, wedding-safa, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Wedding Safa | Premium Turban Service",
    description: "Wedding safa shop. Expert turban service across India.",
    url: "https://weddingsafa.shop",
    type: "website",
  },
}

const SPECIALTIES = ['Buy Online', 'Rent Available', 'All Styles', 'Pan India Delivery']
...
export default function WeddingSafaHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Wedding safa shop. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Wedding Safa" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Wedding Safa Specialties</h2>
      ...
      <DynamicAboutSection location="Wedding Safa" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Wedding Safa" state="India" domain="weddingsafa.shop" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
