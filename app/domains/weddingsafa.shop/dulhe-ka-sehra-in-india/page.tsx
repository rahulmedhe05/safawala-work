...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://weddingsafa.shop/dulhe-ka-sehra-in-india",
    type: "website",
  },
}
...
export default function DulheKaSehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Complete barati packages with matching coordination"],
