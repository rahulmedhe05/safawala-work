...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://weddingsafa.shop/sehrabandi-in-india",
    type: "website",
  },
}
...
export default function SehrabandiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Expert sehra specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
