...
export const metadata: Metadata = {
  title: "Pagri Shop | Pagri online shop | Book Online India",
  description: "Pagri Shop - Pagri online shop. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "pagri shop, pagri-shop, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Pagri Shop | Premium Turban Service",
    description: "Pagri online shop. Expert turban service across India.",
    url: "https://pagri.shop",
    type: "website",
  },
}

const SPECIALTIES = ['Buy Pagri', 'Rent Pagri', 'Accessories', 'Gift Cards']
...
export default function PagriShopHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Pagri online shop. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Pagri Shop" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Pagri Shop Specialties</h2>
      ...
      <DynamicAboutSection location="Pagri Shop" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Pagri Shop" state="India" domain="pagri.shop" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
