...
export const metadata: Metadata = {
  ...
  keywords: "groom sehra in indore, sehra Indore, wedding sehra Indore, sehra service Indore",
  openGraph: {
    title: "Groom Sehra in Indore | Safawala Indore",
    description: "Premium sehra service in Indore by Safawala Indore.",
    url: "https://safawalaindore.com/groom-sehra-in-indore",
    type: "website",
  },
}

export default function GroomSehraInIndorePage() {
  const pageData = {
    ...
    areas: INDORE_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Expert sehra specialists with 40+ years experience in Indore", "Emergency last-minute service available in Indore", "Free consultation and design preview via WhatsApp", "On-site professional service at your Indore venue"],
    seoKeywords: ["groom sehra in indore", "sehra Indore", "wedding sehra Indore", "sehra service Indore"],
    faqs: [
  {
