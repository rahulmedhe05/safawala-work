...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa design in rajasthan, safa Rajasthan, wedding safa Rajasthan, safa service Rajasthan",
  openGraph: {
    title: "Jodhpur Safa in Rajasthan | Safawala India",
    description: "Premium safa service in Rajasthan by Safawala India.",
    url: "https://leheriyasafa.com/jodhpuri-safa-design-in-rajasthan",
    type: "website",
  },
}

export default function JodhpuriSafaDesignInRajasthanPage() {
  const pageData = {
    ...
    seoKeywords: ["jodhpuri safa design in rajasthan", "safa Rajasthan", "wedding safa Rajasthan", "safa service Rajasthan"],
    faqs: [
  {
