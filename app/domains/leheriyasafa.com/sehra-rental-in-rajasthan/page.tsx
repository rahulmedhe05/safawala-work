...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://leheriyasafa.com/sehra-rental-in-rajasthan",
    type: "website",
  },
}
...
export default function SehraRentalInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Rajasthan", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
