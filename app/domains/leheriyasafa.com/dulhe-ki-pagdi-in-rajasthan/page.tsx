...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://leheriyasafa.com/dulhe-ki-pagdi-in-rajasthan",
    type: "website",
  },
}
...
export default function DulheKiPagdiInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Rajasthan", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Rajasthan venue", "Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in Rajasthan"],
