...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://leheriyasafa.com/wedding-pagdi-shop-in-rajasthan",
    type: "website",
  },
}
...
export default function WeddingPagdiShopInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Rajasthan", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Rajasthan venue", "Expert pagdi specialists with 40+ years experience in Rajasthan", "Complete barati packages with matching coordination"],
