...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://leheriyasafa.com/pagdi-for-marriage-in-rajasthan",
    type: "website",
  },
}
...
export default function PagdiForMarriageInRajasthanPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Rajasthan venue", "Expert pagdi specialists with 40+ years experience in Rajasthan"],
