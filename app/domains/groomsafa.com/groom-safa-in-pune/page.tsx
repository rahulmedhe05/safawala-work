...
export const metadata: Metadata = {
  title: "Groom Safa in Pune | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://groomsafa.com/groom-safa-in-pune",
    type: "website",
  },
}
...
export default function GroomSafaInPunePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Pune", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Safa in Pune Destination</h2>
