...
export const metadata: Metadata = {
  title: "Groom Safa in Goa | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://groomsafa.com/groom-safa-in-goa",
    type: "website",
  },
}
...
export default function GroomSafaInGoaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Goa", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Safa in Goa Destination</h2>
