...
export const metadata: Metadata = {
  ...
  keywords: "affordable groom safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Groom Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://groomsafa.com/affordable-groom-safa",
    type: "website",
  },
}

export default function AffordableGroomSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["affordable groom safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
