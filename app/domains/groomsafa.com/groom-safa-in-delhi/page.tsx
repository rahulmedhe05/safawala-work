...
export const metadata: Metadata = {
  title: "Groom Safa in Delhi | Safawala India",
  ...
  openGraph: {
    ...
    url: "https://groomsafa.com/groom-safa-in-delhi",
    type: "website",
  },
}
...
export default function GroomSafaInDelhiPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "On-site professional service at your Delhi venue", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in Delhi"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Groom Safa in Delhi Destination</h2>
