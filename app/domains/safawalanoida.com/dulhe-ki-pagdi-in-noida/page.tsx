...
export const metadata: Metadata = {
  ...
  keywords: "dulhe ki pagdi in noida, pagdi Noida, wedding pagdi Noida, pagdi service Noida",
  openGraph: {
    title: "Pagdi in Noida | Safawala Noida",
    description: "Premium pagdi service in Noida by Safawala Noida.",
    url: "https://safawalanoida.com/dulhe-ki-pagdi-in-noida",
    type: "website",
  },
}

export default function DulheKiPagdiInNoidaPage() {
  const pageData = {
    ...
    areas: NOIDA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in Noida", "On-site professional service at your Noida venue", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["dulhe ki pagdi in noida", "pagdi Noida", "wedding pagdi Noida", "pagdi service Noida"],
    faqs: [
  {
