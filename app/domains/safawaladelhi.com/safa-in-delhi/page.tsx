...
export const metadata: Metadata = {
  ...
  keywords: "safa in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Safa in Delhi | Safawala Delhi",
    description: "Premium safa service in Delhi by Safawala Delhi.",
    url: "https://safawaladelhi.com/safa-in-delhi",
    type: "website",
  },
}

export default function SafaInDelhiPage() {
  const pageData = {
    title: "Safa in Delhi",
    ...
    areas: DELHI_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Delhi", "Expert safa specialists with 40+ years experience in Delhi", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["safa in delhi", "safa Delhi", "wedding safa Delhi", "safa service Delhi"],
    faqs: [
  {
