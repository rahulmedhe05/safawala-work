...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa in delhi, safa Delhi, wedding safa Delhi, safa service Delhi",
  openGraph: {
    title: "Rajputana Safa in Delhi | Safawala Delhi",
    description: "Premium safa service in Delhi by Safawala Delhi.",
    url: "https://safawaladelhi.com/rajputi-safa-in-delhi",
    type: "website",
  },
}

export default function RajputiSafaInDelhiPage() {
  const pageData = {
    ...
    areas: DELHI_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your Delhi venue", "Expert safa specialists with 40+ years experience in Delhi", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination"],
    seoKeywords: ["rajputi safa in delhi", "safa Delhi", "wedding safa Delhi", "safa service Delhi"],
    faqs: [
  {
