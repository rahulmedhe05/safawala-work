...
export const metadata: Metadata = {
  ...
  keywords: "sehra for groom in delhi, sehra Delhi, wedding sehra Delhi, sehra service Delhi",
  openGraph: {
    title: "Groom Sehra in Delhi | Safawala Delhi",
    description: "Premium sehra service in Delhi by Safawala Delhi.",
    url: "https://safawaladelhi.com/sehra-for-groom-in-delhi",
    type: "website",
  },
}

export default function SehraForGroomInDelhiPage() {
  const pageData = {
    ...
    seoKeywords: ["sehra for groom in delhi", "sehra Delhi", "wedding sehra Delhi", "sehra service Delhi"],
    faqs: [
  {
