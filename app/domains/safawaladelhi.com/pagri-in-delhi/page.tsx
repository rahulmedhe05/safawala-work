...
export const metadata: Metadata = {
  title: "Pagri in Delhi | Safawala Delhi",
  ...
  keywords: "pagri in delhi, pagri Delhi, wedding pagri Delhi, pagri service Delhi",
  openGraph: {
    title: "Pagri in Delhi | Safawala Delhi",
    description: "Premium pagri service in Delhi by Safawala Delhi.",
    url: "https://safawaladelhi.com/pagri-in-delhi",
    type: "website",
  },
}

export default function PagriInDelhiPage() {
  const pageData = {
    title: "Pagri in Delhi",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Delhi - Your Premier Pagri in Delhi Destination</h2>
