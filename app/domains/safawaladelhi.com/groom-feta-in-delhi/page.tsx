...
export const metadata: Metadata = {
  ...
  keywords: "groom feta in delhi, feta Delhi, wedding feta Delhi, feta service Delhi",
  openGraph: {
    title: "Groom Feta in Delhi | Safawala Delhi",
    description: "Premium feta service in Delhi by Safawala Delhi.",
    url: "https://safawaladelhi.com/groom-feta-in-delhi",
    type: "website",
  },
}

export default function GroomFetaInDelhiPage() {
  const pageData = {
    ...
    areas: DELHI_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Expert feta specialists with 40+ years experience in Delhi", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["groom feta in delhi", "feta Delhi", "wedding feta Delhi", "feta service Delhi"],
    faqs: [
  {
