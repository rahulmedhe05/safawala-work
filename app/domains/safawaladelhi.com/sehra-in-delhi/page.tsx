...
export const metadata: Metadata = {
  ...
  keywords: "sehra in delhi, sehra Delhi, wedding sehra Delhi, sehra service Delhi",
  openGraph: {
    title: "Sehra in Delhi | Safawala Delhi",
    description: "Premium sehra service in Delhi by Safawala Delhi.",
    url: "https://safawaladelhi.com/sehra-in-delhi",
    type: "website",
  },
}

export default function SehraInDelhiPage() {
  const pageData = {
    ...
    seoKeywords: ["sehra in delhi", "sehra Delhi", "wedding sehra Delhi", "sehra service Delhi"],
    faqs: [
  {
