...
export const metadata: Metadata = {
  ...
  keywords: "dulha sehra in delhi, sehra Delhi, wedding sehra Delhi, sehra service Delhi",
  openGraph: {
    title: "Dulha (Groom) Sehra in Delhi | Safawala Delhi",
    description: "Premium sehra service in Delhi by Safawala Delhi.",
    url: "https://safawaladelhi.com/dulha-sehra-in-delhi",
    type: "website",
  },
}

export default function DulhaSehraInDelhiPage() {
  const pageData = {
    ...
    seoKeywords: ["dulha sehra in delhi", "sehra Delhi", "wedding sehra Delhi", "sehra service Delhi"],
    faqs: [
  {
