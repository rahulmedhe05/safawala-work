...
export const metadata: Metadata = {
  ...
  keywords: "indian turban designs, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://indianturban.com/indian-turban-designs",
    type: "website",
  },
}

export default function IndianTurbanDesignsPage() {
  const pageData = {
    ...
    seoKeywords: ["indian turban designs", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
