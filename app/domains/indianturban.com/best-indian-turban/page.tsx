...
export const metadata: Metadata = {
  ...
  keywords: "best indian turban, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://indianturban.com/best-indian-turban",
    type: "website",
  },
}

export default function BestIndianTurbanPage() {
  const pageData = {
    ...
    seoKeywords: ["best indian turban", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
