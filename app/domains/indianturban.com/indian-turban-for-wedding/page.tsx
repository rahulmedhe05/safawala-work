...
export const metadata: Metadata = {
  ...
  keywords: "indian turban for wedding, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Premium Wedding-Grade Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://indianturban.com/indian-turban-for-wedding",
    type: "website",
  },
}

export default function IndianTurbanForWeddingPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Expert turban specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["indian turban for wedding", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
