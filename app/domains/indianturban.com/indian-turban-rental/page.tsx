...
export const metadata: Metadata = {
  ...
  keywords: "indian turban rental, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Well-Maintained Rental Collection Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://indianturban.com/indian-turban-rental",
    type: "website",
  },
}

export default function IndianTurbanRentalPage() {
  const pageData = {
    ...
    seoKeywords: ["indian turban rental", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
