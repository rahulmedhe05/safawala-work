...
export const metadata: Metadata = {
  ...
  keywords: "indian turban colors, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://indianturban.com/indian-turban-colors",
    type: "website",
  },
}

export default function IndianTurbanColorsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert turban specialists with 40+ years experience in India"],
    seoKeywords: ["indian turban colors", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
