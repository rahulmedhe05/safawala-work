...
export const metadata: Metadata = {
  ...
  keywords: "safewala weddings, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safewala.com/safewala-weddings",
    type: "website",
  },
}

export default function SafewalaWeddingsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safewala weddings", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
