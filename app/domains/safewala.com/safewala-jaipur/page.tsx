...
export const metadata: Metadata = {
  ...
  keywords: "safewala jaipur, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safewala.com/safewala-jaipur",
    type: "website",
  },
}

export default function SafewalaJaipurPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination"],
    seoKeywords: ["safewala jaipur", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
