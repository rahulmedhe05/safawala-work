...
export const metadata: Metadata = {
  ...
  keywords: "contact safewala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safewala.com/contact-safewala",
    type: "website",
  },
}

export default function ContactSafewalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["contact safewala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
