...
export const metadata: Metadata = {
  ...
  keywords: "about safewala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safewala.com/about-safewala",
    type: "website",
  },
}

export default function AboutSafewalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["about safewala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
