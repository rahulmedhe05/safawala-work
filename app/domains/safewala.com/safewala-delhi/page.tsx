...
export const metadata: Metadata = {
  ...
  keywords: "safewala delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safewala.com/safewala-delhi",
    type: "website",
  },
}

export default function SafewalaDelhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safewala delhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
