...
export const metadata: Metadata = {
  ...
  keywords: "safewala mumbai, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safewala.com/safewala-mumbai",
    type: "website",
  },
}

export default function SafewalaMumbaiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safewala mumbai", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
