...
export const metadata: Metadata = {
  title: "Mewar Safa in India | Safawala India",
  ...
  keywords: "mewadi safa designs, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Mewar Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mewadisafa.com/mewadi-safa-designs",
    type: "website",
  },
}

export default function MewadiSafaDesignsPage() {
  const pageData = {
    title: "Mewar Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India"],
    seoKeywords: ["mewadi safa designs", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Mewar Safa in India Destination</h2>
