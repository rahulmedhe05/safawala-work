...
export const metadata: Metadata = {
  ...
  keywords: "mewadi safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Mewar Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mewadisafa.com/mewadi-safa-colors",
    type: "website",
  },
}

export default function MewadiSafaColorsPage() {
  const pageData = {
    ...
    seoKeywords: ["mewadi safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
