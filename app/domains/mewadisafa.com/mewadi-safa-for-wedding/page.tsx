...
export const metadata: Metadata = {
  ...
  keywords: "mewadi safa for wedding, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Mewar Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mewadisafa.com/mewadi-safa-for-wedding",
    type: "website",
  },
}

export default function MewadiSafaForWeddingPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
    seoKeywords: ["mewadi safa for wedding", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
