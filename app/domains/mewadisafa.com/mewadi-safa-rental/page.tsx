...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Mewar Safa in India | Safawala India",
  ...
  keywords: "mewadi safa rental, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Well-Maintained Rental Collection Mewar Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mewadisafa.com/mewadi-safa-rental",
    type: "website",
  },
}

export default function MewadiSafaRentalPage() {
  const pageData = {
    title: "Well-Maintained Rental Collection Mewar Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India"],
    seoKeywords: ["mewadi safa rental", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Well-Maintained Rental Collection Mewar Safa in India Destination</h2>
