...
export const metadata: Metadata = {
  title: "Mewar Barati Safa in India | Safawala India",
  ...
  keywords: "mewadi safa for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Mewar Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mewadisafa.com/mewadi-safa-for-barati",
    type: "website",
  },
}

export default function MewadiSafaForBaratiPage() {
  const pageData = {
    title: "Mewar Barati Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["mewadi safa for barati", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Mewar Barati Safa in India Destination</h2>
