...
export const metadata: Metadata = {
  ...
  keywords: "mewadi safa tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Mewar Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mewadisafa.com/mewadi-safa-tying-service",
    type: "website",
  },
}

export default function MewadiSafaTyingServicePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["mewadi safa tying service", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
