...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Mewar Safa in India | Safawala India",
  ...
  keywords: "wedding mewadi safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Mewar Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://mewadisafa.com/wedding-mewadi-safa",
    type: "website",
  },
}

export default function WeddingMewadiSafaPage() {
  const pageData = {
    title: "Premium Wedding-Grade Mewar Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["wedding mewadi safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Mewar Safa in India Destination</h2>
