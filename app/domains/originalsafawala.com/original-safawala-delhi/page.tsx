...
export const metadata: Metadata = {
  ...
  keywords: "original safawala delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://originalsafawala.com/original-safawala-delhi",
    type: "website",
  },
}

export default function OriginalSafawalaDelhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["original safawala delhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
