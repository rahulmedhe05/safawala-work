...
export const metadata: Metadata = {
  ...
  keywords: "original safawala mumbai, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://originalsafawala.com/original-safawala-mumbai",
    type: "website",
  },
}

export default function OriginalSafawalaMumbaiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue"],
    seoKeywords: ["original safawala mumbai", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
