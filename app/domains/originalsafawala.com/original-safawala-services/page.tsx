...
export const metadata: Metadata = {
  ...
  keywords: "original safawala services, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://originalsafawala.com/original-safawala-services",
    type: "website",
  },
}

export default function OriginalSafawalaServicesPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["original safawala services", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
