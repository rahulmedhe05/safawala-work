...
export const metadata: Metadata = {
  ...
  keywords: "contact original safawala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://originalsafawala.com/contact-original-safawala",
    type: "website",
  },
}

export default function ContactOriginalSafawalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue"],
    seoKeywords: ["contact original safawala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
