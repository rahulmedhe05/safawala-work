...
export const metadata: Metadata = {
  ...
  keywords: "about original safawala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://originalsafawala.com/about-original-safawala",
    type: "website",
  },
}

export default function AboutOriginalSafawalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["about original safawala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
