...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Feta in Dubai | Safawala Dubai",
  ...
  keywords: "wedding feta in dubai, feta Dubai, wedding feta Dubai, feta service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Feta in Dubai | Safawala Dubai",
    description: "Premium feta service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/wedding-feta-in-dubai",
    type: "website",
  },
}

export default function WeddingFetaInDubaiPage() {
  const pageData = {
    title: "Premium Wedding-Grade Feta in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Expert feta specialists with 40+ years experience in Dubai"],
    seoKeywords: ["wedding feta in dubai", "feta Dubai", "wedding feta Dubai", "feta service Dubai"],
    faqs: [
  {
    "question": "Do you provide on-site Feta tying service in Dubai?",
    "answer": "Yes, we provide professional on-site Feta tying service across all Dubai areas. Our expert turban specialists will come to your venue fully equipped to ensure perfect styling for the groom and barati."
  },
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Premium Wedding-Grade Feta in Dubai Destination</h2>

<p>Safawala Dubai presents the most exquisite Feta collection in the region. Our master craftsmen specialize in creating the perfect turban experience for international destination weddings.</p>
