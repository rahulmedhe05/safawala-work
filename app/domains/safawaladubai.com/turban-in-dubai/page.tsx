...
export const metadata: Metadata = {
  title: "Turban in Dubai | Safawala Dubai",
  ...
  keywords: "turban in dubai, turban Dubai, wedding turban Dubai, turban service Dubai",
  openGraph: {
    title: "Turban in Dubai | Safawala Dubai",
    description: "Premium turban service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/turban-in-dubai",
    type: "website",
  },
}

export default function TurbanInDubaiPage() {
  const pageData = {
    title: "Turban in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Dubai", "On-site professional service at your Dubai venue", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["turban in dubai", "turban Dubai", "wedding turban Dubai", "turban service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Turban in Dubai Destination</h2>
