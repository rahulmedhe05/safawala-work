...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagri in Dubai | Safawala Dubai",
  ...
  keywords: "wedding pagri in dubai, pagri Dubai, wedding pagri Dubai, pagri service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Pagri in Dubai | Safawala Dubai",
    description: "Premium pagri service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/wedding-pagri-in-dubai",
    type: "website",
  },
}

export default function WeddingPagriInDubaiPage() {
  const pageData = {
    title: "Premium Wedding-Grade Pagri in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Emergency last-minute service available in Dubai", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Dubai venue"],
    seoKeywords: ["wedding pagri in dubai", "pagri Dubai", "wedding pagri Dubai", "pagri service Dubai"],
    faqs: [
  {
  ...
  {
    "question": "Can I see Pagri designs before booking in Dubai?",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Premium Wedding-Grade Pagri in Dubai Destination</h2>

<p>Welcome to Safawala Dubai - your premier destination for Pagri services. With over 40 years of expertise in traditional turban craftsmanship, we bring royal elegance to your special day.</p>
