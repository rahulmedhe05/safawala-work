...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa design in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Rajputana Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/rajputi-safa-design-in-dubai",
    type: "website",
  },
}

export default function RajputiSafaDesignInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Dubai", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["rajputi safa design in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
