...
export const metadata: Metadata = {
  ...
  keywords: "safa in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/safa-in-dubai",
    type: "website",
  },
}

export default function SafaInDubaiPage() {
  const pageData = {
    title: "Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your Dubai venue", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Dubai", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["safa in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
