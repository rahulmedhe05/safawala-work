...
export const metadata: Metadata = {
  ...
  keywords: "pagadi in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/pagadi-in-dubai",
    type: "website",
  },
}

export default function PagadiInDubaiPage() {
  const pageData = {
    title: "Safa in Dubai",
