...
export const metadata: Metadata = {
  ...
  keywords: "marriage pagdi in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/marriage-pagdi-in-dubai",
    type: "website",
  },
}

export default function MarriagePagdiInDubaiPage() {
  const pageData = {
    ...
    seoKeywords: ["marriage pagdi in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
