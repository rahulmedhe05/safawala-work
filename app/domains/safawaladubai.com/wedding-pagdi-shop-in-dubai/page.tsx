...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi shop in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/wedding-pagdi-shop-in-dubai",
    type: "website",
  },
}

export default function WeddingPagdiShopInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert pagdi specialists with 40+ years experience in Dubai", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Dubai", "Complete barati packages with matching coordination"],
    seoKeywords: ["wedding pagdi shop in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
