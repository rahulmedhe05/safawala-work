...
export const metadata: Metadata = {
  ...
  keywords: "paghdi in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/paghdi-in-dubai",
    type: "website",
  },
}

export default function PaghdiInDubaiPage() {
  const pageData = {
    title: "Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in Dubai", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Dubai", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["paghdi in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
