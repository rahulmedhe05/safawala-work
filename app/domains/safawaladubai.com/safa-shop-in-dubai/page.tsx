...
export const metadata: Metadata = {
  ...
  keywords: "safa shop in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/safa-shop-in-dubai",
    type: "website",
  },
}

export default function SafaShopInDubaiPage() {
  const pageData = {
    title: "Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "On-site professional service at your Dubai venue", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Dubai"],
    seoKeywords: ["safa shop in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
