...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/wedding-safa-in-dubai",
    type: "website",
  },
}

export default function WeddingSafaInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Emergency last-minute service available in Dubai", "Expert safa specialists with 40+ years experience in Dubai", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "On-site professional service at your Dubai venue"],
    seoKeywords: ["wedding safa in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
