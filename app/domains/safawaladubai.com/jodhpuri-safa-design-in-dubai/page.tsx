...
export const metadata: Metadata = {
  title: "Jodhpur Safa in Dubai | Safawala Dubai",
  ...
  keywords: "jodhpuri safa design in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Jodhpur Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/jodhpuri-safa-design-in-dubai",
    type: "website",
  },
}

export default function JodhpuriSafaDesignInDubaiPage() {
  const pageData = {
    title: "Jodhpur Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Dubai", "Free consultation and design preview via WhatsApp", "On-site professional service at your Dubai venue", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["jodhpuri safa design in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Jodhpur Safa in Dubai Destination</h2>
