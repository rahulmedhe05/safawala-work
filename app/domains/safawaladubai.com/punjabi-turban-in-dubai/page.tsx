...
export const metadata: Metadata = {
  title: "Punjab Turban in Dubai | Safawala Dubai",
  ...
  keywords: "punjabi turban in dubai, turban Dubai, wedding turban Dubai, turban service Dubai",
  openGraph: {
    title: "Punjab Turban in Dubai | Safawala Dubai",
    description: "Premium turban service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/punjabi-turban-in-dubai",
    type: "website",
  },
}

export default function PunjabiTurbanInDubaiPage() {
  const pageData = {
    title: "Punjab Turban in Dubai",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Punjab Turban in Dubai Destination</h2>
