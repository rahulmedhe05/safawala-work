...
export const metadata: Metadata = {
  ...
  keywords: "dulhe ki pagdi in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/dulhe-ki-pagdi-in-dubai",
    type: "website",
  },
}

export default function DulheKiPagdiInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Dubai", "Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Dubai venue", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["dulhe ki pagdi in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
