...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Jodhpur Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/jodhpuri-safa-in-dubai",
    type: "website",
  },
}

export default function JodhpuriSafaInDubaiPage() {
  const pageData = {
    ...
    seoKeywords: ["jodhpuri safa in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
