...
export const metadata: Metadata = {
  ...
  keywords: "sehra in dubai, sehra Dubai, wedding sehra Dubai, sehra service Dubai",
  openGraph: {
    title: "Sehra in Dubai | Safawala Dubai",
    description: "Premium sehra service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/sehra-in-dubai",
    type: "website",
  },
}

export default function SehraInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert sehra specialists with 40+ years experience in Dubai", "Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["sehra in dubai", "sehra Dubai", "wedding sehra Dubai", "sehra service Dubai"],
    faqs: [
  {
