...
export const metadata: Metadata = {
  title: "Jodhpur Pagdi in Dubai | Safawala Dubai",
  ...
  keywords: "jodhpuri pagdi in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Jodhpur Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/jodhpuri-pagdi-in-dubai",
    type: "website",
  },
}

export default function JodhpuriPagdiInDubaiPage() {
  const pageData = {
    title: "Jodhpur Pagdi in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Dubai venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["jodhpuri pagdi in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Jodhpur Pagdi in Dubai Destination</h2>
