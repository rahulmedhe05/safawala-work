...
export const metadata: Metadata = {
  title: "Marwar Safa in Dubai | Safawala Dubai",
  ...
  keywords: "marwadi safa in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Marwar Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/marwadi-safa-in-dubai",
    type: "website",
  },
}

export default function MarwadiSafaInDubaiPage() {
  const pageData = {
    title: "Marwar Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Dubai", "Complete barati packages with matching coordination", "On-site professional service at your Dubai venue"],
    seoKeywords: ["marwadi safa in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Marwar Safa in Dubai Destination</h2>
