...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for marriage in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/pagdi-for-marriage-in-dubai",
    type: "website",
  },
}

export default function PagdiForMarriageInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Dubai", "Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
    seoKeywords: ["pagdi for marriage in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
