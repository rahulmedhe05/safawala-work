...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for wedding in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/pagdi-for-wedding-in-dubai",
    type: "website",
  },
}

export default function PagdiForWeddingInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "On-site professional service at your Dubai venue", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Dubai", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["pagdi for wedding in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
