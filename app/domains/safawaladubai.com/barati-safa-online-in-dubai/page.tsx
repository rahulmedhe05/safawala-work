...
export const metadata: Metadata = {
  ...
  keywords: "barati safa online in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Barati Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/barati-safa-online-in-dubai",
    type: "website",
  },
}

export default function BaratiSafaOnlineInDubaiPage() {
  const pageData = {
