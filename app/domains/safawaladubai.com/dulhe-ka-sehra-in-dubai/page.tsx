...
export const metadata: Metadata = {
  title: "Sehra in Dubai | Safawala Dubai",
  ...
  keywords: "dulhe ka sehra in dubai, sehra Dubai, wedding sehra Dubai, sehra service Dubai",
  openGraph: {
    title: "Sehra in Dubai | Safawala Dubai",
    description: "Premium sehra service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/dulhe-ka-sehra-in-dubai",
    type: "website",
  },
}

export default function DulheKaSehraInDubaiPage() {
  const pageData = {
    title: "Sehra in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "On-site professional service at your Dubai venue", "Expert sehra specialists with 40+ years experience in Dubai"],
    seoKeywords: ["dulhe ka sehra in dubai", "sehra Dubai", "wedding sehra Dubai", "sehra service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Sehra in Dubai Destination</h2>
