...
export const metadata: Metadata = {
  ...
  keywords: "safa tying service in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/safa-tying-service-in-dubai",
    type: "website",
  },
}

export default function SafaTyingServiceInDubaiPage() {
  const pageData = {
    title: "Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Dubai", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "On-site professional service at your Dubai venue", "Emergency last-minute service available in Dubai"],
    seoKeywords: ["safa tying service in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
