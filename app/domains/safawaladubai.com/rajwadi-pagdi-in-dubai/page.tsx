...
export const metadata: Metadata = {
  title: "Royal courts Pagdi in Dubai | Safawala Dubai",
  ...
  keywords: "rajwadi pagdi in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Royal courts Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/rajwadi-pagdi-in-dubai",
    type: "website",
  },
}

export default function RajwadiPagdiInDubaiPage() {
  const pageData = {
    title: "Royal courts Pagdi in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in Dubai", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Dubai venue", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["rajwadi pagdi in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Royal courts Pagdi in Dubai Destination</h2>
