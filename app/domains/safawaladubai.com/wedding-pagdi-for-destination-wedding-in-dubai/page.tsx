...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagdi in Dubai | Safawala Dubai",
  ...
  keywords: "wedding pagdi for destination wedding in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/wedding-pagdi-for-destination-wedding-in-dubai",
    type: "website",
  },
}

export default function WeddingPagdiForDestinationWeddingInDubaiPage() {
  const pageData = {
    title: "Premium Wedding-Grade Pagdi in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "On-site professional service at your Dubai venue", "Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in Dubai"],
    seoKeywords: ["wedding pagdi for destination wedding in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Premium Wedding-Grade Pagdi in Dubai Destination</h2>
