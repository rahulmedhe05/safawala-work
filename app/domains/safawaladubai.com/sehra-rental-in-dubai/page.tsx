...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Sehra in Dubai | Safawala Dubai",
  ...
  keywords: "sehra rental in dubai, sehra Dubai, wedding sehra Dubai, sehra service Dubai",
  openGraph: {
    title: "Well-Maintained Rental Collection Sehra in Dubai | Safawala Dubai",
    description: "Premium sehra service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/sehra-rental-in-dubai",
    type: "website",
  },
}

export default function SehraRentalInDubaiPage() {
  const pageData = {
    title: "Well-Maintained Rental Collection Sehra in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in Dubai", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Dubai"],
    seoKeywords: ["sehra rental in dubai", "sehra Dubai", "wedding sehra Dubai", "sehra service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Well-Maintained Rental Collection Sehra in Dubai Destination</h2>
