...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Dubai | Safawala Dubai",
  ...
  keywords: "rajput pagdi in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Rajputana Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/rajput-pagdi-in-dubai",
    type: "website",
  },
}

export default function RajputPagdiInDubaiPage() {
  const pageData = {
    title: "Rajputana Pagdi in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Dubai", "On-site professional service at your Dubai venue", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["rajput pagdi in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Rajputana Pagdi in Dubai Destination</h2>
