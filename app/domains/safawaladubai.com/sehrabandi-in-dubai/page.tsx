...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in dubai, sehra Dubai, wedding sehra Dubai, sehra service Dubai",
  openGraph: {
    title: "Sehra in Dubai | Safawala Dubai",
    description: "Premium sehra service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/sehrabandi-in-dubai",
    type: "website",
  },
}

export default function SehrabandiInDubaiPage() {
  const pageData = {
    ...
    seoKeywords: ["sehrabandi in dubai", "sehra Dubai", "wedding sehra Dubai", "sehra service Dubai"],
    faqs: [
  {
