...
export const metadata: Metadata = {
  title: "Groom Sehra in Dubai | Safawala Dubai",
  ...
  keywords: "sehra for groom in dubai, sehra Dubai, wedding sehra Dubai, sehra service Dubai",
  openGraph: {
    title: "Groom Sehra in Dubai | Safawala Dubai",
    description: "Premium sehra service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/sehra-for-groom-in-dubai",
    type: "website",
  },
}

export default function SehraForGroomInDubaiPage() {
  const pageData = {
    title: "Groom Sehra in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Emergency last-minute service available in Dubai", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your Dubai venue", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["sehra for groom in dubai", "sehra Dubai", "wedding sehra Dubai", "sehra service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Groom Sehra in Dubai Destination</h2>

<p>Safawala Dubai presents the most exquisite Sehra collection in the region. Our master craftsmen specialize in creating the perfect turban experience for international destination weddings.</p>
