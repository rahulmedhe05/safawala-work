...
export const metadata: Metadata = {
  title: "Jodhpur Pagri in Dubai | Safawala Dubai",
  ...
  keywords: "jodhpuri pagri in dubai, pagri Dubai, wedding pagri Dubai, pagri service Dubai",
  openGraph: {
    title: "Jodhpur Pagri in Dubai | Safawala Dubai",
    description: "Premium pagri service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/jodhpuri-pagri-in-dubai",
    type: "website",
  },
}

export default function JodhpuriPagriInDubaiPage() {
  const pageData = {
    title: "Jodhpur Pagri in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Expert pagri specialists with 40+ years experience in Dubai", "Emergency last-minute service available in Dubai", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination"],
    seoKeywords: ["jodhpuri pagri in dubai", "pagri Dubai", "wedding pagri Dubai", "pagri service Dubai"],
    faqs: [
  {
  ...
  {
    "question": "Do you provide matching Pagri for barati in Dubai?",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Jodhpur Pagri in Dubai Destination</h2>
