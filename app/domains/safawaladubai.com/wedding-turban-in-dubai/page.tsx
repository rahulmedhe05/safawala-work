...
export const metadata: Metadata = {
  ...
  keywords: "wedding turban in dubai, turban Dubai, wedding turban Dubai, turban service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Turban in Dubai | Safawala Dubai",
    description: "Premium turban service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/wedding-turban-in-dubai",
    type: "website",
  },
}

export default function WeddingTurbanInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Dubai", "Expert turban specialists with 40+ years experience in Dubai", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["wedding turban in dubai", "turban Dubai", "wedding turban Dubai", "turban service Dubai"],
    faqs: [
  {
