...
export const metadata: Metadata = {
  title: "Royal courts Safa in Dubai | Safawala Dubai",
  ...
  keywords: "rajwadi safa in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Royal courts Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/rajwadi-safa-in-dubai",
    type: "website",
  },
}

export default function RajwadiSafaInDubaiPage() {
  const pageData = {
    title: "Royal courts Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["On-site professional service at your Dubai venue", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in Dubai", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["rajwadi safa in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Royal courts Safa in Dubai Destination</h2>
