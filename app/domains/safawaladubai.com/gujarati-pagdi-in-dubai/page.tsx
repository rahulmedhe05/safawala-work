...
export const metadata: Metadata = {
  title: "Gujarat Pagdi in Dubai | Safawala Dubai",
  ...
  keywords: "gujarati pagdi in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Gujarat Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/gujarati-pagdi-in-dubai",
    type: "website",
  },
}

export default function GujaratiPagdiInDubaiPage() {
  const pageData = {
    title: "Gujarat Pagdi in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Dubai", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your Dubai venue", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["gujarati pagdi in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Gujarat Pagdi in Dubai Destination</h2>
