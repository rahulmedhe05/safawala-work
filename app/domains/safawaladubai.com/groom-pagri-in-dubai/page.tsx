...
export const metadata: Metadata = {
  title: "Groom Pagri in Dubai | Safawala Dubai",
  ...
  keywords: "groom pagri in dubai, pagri Dubai, wedding pagri Dubai, pagri service Dubai",
  openGraph: {
    title: "Groom Pagri in Dubai | Safawala Dubai",
    description: "Premium pagri service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/groom-pagri-in-dubai",
    type: "website",
  },
}

export default function GroomPagriInDubaiPage() {
  const pageData = {
    title: "Groom Pagri in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["On-site professional service at your Dubai venue", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["groom pagri in dubai", "pagri Dubai", "wedding pagri Dubai", "pagri service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Groom Pagri in Dubai Destination</h2>
