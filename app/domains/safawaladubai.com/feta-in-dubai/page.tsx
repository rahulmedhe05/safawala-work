...
export const metadata: Metadata = {
  title: "Feta in Dubai | Safawala Dubai",
  description: "Looking for premium feta in Dubai? Safawala Dubai is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage ...",
  keywords: "feta in dubai, feta Dubai, wedding feta Dubai, feta service Dubai",
  openGraph: {
    title: "Feta in Dubai | Safawala Dubai",
    description: "Premium feta service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/feta-in-dubai",
    type: "website",
  },
}

export default function FetaInDubaiPage() {
  const pageData = {
    title: "Feta in Dubai",
    shortDescription: "Looking for premium feta in Dubai? Safawala Dubai is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium feta service in Dubai by Safawala Dubai.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: DUBAI_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Dubai", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your Dubai venue"],
    seoKeywords: ["feta in dubai", "feta Dubai", "wedding feta Dubai", "feta service Dubai"],
    faqs: [
  {
    "question": "What is the price of Feta in Dubai?",
    "answer": "Our Feta prices in Dubai start from \u20b9500 for basic options and go up to \u20b95000+ for premium designer pieces. We offer packages for individuals and bulk orders for barati. Contact us for a customized quote based on your specific requirements."
  },
  {
    "question": "Can I see Feta designs before booking in Dubai?",
  ...
  {
    "question": "Do you offer Feta for destination weddings outside Dubai?",
    "answer": "Yes, we provide Feta services for destination weddings across India and internationally. Our team regularly travels to provide services at luxury hotels, resorts, and wedding venues outside Dubai."
  },
  {
  ...
  {
    "question": "Do you provide matching Feta for barati in Dubai?",
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Feta in Dubai Destination</h2>

<p>Looking for the finest Feta in Dubai? Safawala Dubai is the trusted choice of thousands of families for authentic, premium turban services. Experience our 40+ years legacy of excellence.</p>


<h2>Why Choose Safawala Dubai for Feta?</h2>

<p>When it comes to <strong>feta</strong> in Dubai, Safawala stands apart as the region's most trusted turban specialists. Here's why families across Dubai choose us:</p>

<h3>40+ Years of Turban Excellence</h3>
<p>Our feta expertise comes from four generations of dedicated craftsmanship. We understand the cultural significance of every turban and deliver perfection for your special occasions in Dubai.</p>
...
<p>We provide on-site feta services across all Dubai areas. Our team arrives fully prepared with complete collections, professional equipment, and backup options.</p>



<h2>Our Feta Services in Dubai</h2>
...
<h2>Book Your Feta in Dubai</h2>

<p>Ready to experience the finest feta service in Dubai? Booking is simple:</p>
...
<p>At Safawala Dubai, every turban tells a story of tradition, craftsmanship, and celebration. We take pride in being part of your special moments, ensuring each feta reflects the joy and grandeur of international destination weddings.</p>
