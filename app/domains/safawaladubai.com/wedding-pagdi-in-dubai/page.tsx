...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi in dubai, pagdi Dubai, wedding pagdi Dubai, pagdi service Dubai",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Dubai | Safawala Dubai",
    description: "Premium pagdi service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/wedding-pagdi-in-dubai",
    type: "website",
  },
}

export default function WeddingPagdiInDubaiPage() {
  const pageData = {
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Dubai", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["wedding pagdi in dubai", "pagdi Dubai", "wedding pagdi Dubai", "pagdi service Dubai"],
    faqs: [
  {
