...
export const metadata: Metadata = {
  ...
  keywords: "groom sehra in dubai, sehra Dubai, wedding sehra Dubai, sehra service Dubai",
  openGraph: {
    title: "Groom Sehra in Dubai | Safawala Dubai",
    description: "Premium sehra service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/groom-sehra-in-dubai",
    type: "website",
  },
}

export default function GroomSehraInDubaiPage() {
  const pageData = {
