...
export const metadata: Metadata = {
  title: "Rajputana Safa in Dubai | Safawala Dubai",
  ...
  keywords: "rajputi safa in dubai, safa Dubai, wedding safa Dubai, safa service Dubai",
  openGraph: {
    title: "Rajputana Safa in Dubai | Safawala Dubai",
    description: "Premium safa service in Dubai by Safawala Dubai.",
    url: "https://safawaladubai.com/rajputi-safa-in-dubai",
    type: "website",
  },
}

export default function RajputiSafaInDubaiPage() {
  const pageData = {
    title: "Rajputana Safa in Dubai",
    ...
    areas: DUBAI_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in Dubai", "Emergency last-minute service available in Dubai", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["rajputi safa in dubai", "safa Dubai", "wedding safa Dubai", "safa service Dubai"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Dubai - Your Premier Rajputana Safa in Dubai Destination</h2>
