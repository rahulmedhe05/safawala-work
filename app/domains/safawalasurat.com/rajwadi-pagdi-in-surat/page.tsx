...
export const metadata: Metadata = {
  title: "Royal courts Pagdi in Surat | Safawala Surat",
  ...
  keywords: "rajwadi pagdi in surat, pagdi Surat, wedding pagdi Surat, pagdi service Surat",
  openGraph: {
    title: "Royal courts Pagdi in Surat | Safawala Surat",
    description: "Premium pagdi service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/rajwadi-pagdi-in-surat",
    type: "website",
  },
}

export default function RajwadiPagdiInSuratPage() {
  const pageData = {
    title: "Royal courts Pagdi in Surat",
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Surat", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Surat venue"],
    seoKeywords: ["rajwadi pagdi in surat", "pagdi Surat", "wedding pagdi Surat", "pagdi service Surat"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Surat - Your Premier Royal courts Pagdi in Surat Destination</h2>
