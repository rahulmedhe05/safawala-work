...
export const metadata: Metadata = {
  ...
  keywords: "jodhpuri safa in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Jodhpur Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/jodhpuri-safa-in-surat",
    type: "website",
  },
}

export default function JodhpuriSafaInSuratPage() {
  const pageData = {
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in Surat", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Surat venue", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["jodhpuri safa in surat", "safa Surat", "wedding safa Surat", "safa service Surat"],
    faqs: [
  {
