...
export const metadata: Metadata = {
  title: "Royal palaces Safa in Surat | Safawala Surat",
  ...
  keywords: "maharaja safa in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Royal palaces Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/maharaja-safa-in-surat",
    type: "website",
  },
}

export default function MaharajaSafaInSuratPage() {
  const pageData = {
    title: "Royal palaces Safa in Surat",
    ...
    seoKeywords: ["maharaja safa in surat", "safa Surat", "wedding safa Surat", "safa service Surat"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Surat - Your Premier Royal palaces Safa in Surat Destination</h2>
