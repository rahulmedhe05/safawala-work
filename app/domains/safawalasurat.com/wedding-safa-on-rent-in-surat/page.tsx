...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa on rent in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/wedding-safa-on-rent-in-surat",
    type: "website",
  },
}

export default function WeddingSafaOnRentInSuratPage() {
  const pageData = {
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in Surat", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Surat", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["wedding safa on rent in surat", "safa Surat", "wedding safa Surat", "safa service Surat"],
    faqs: [
  {
