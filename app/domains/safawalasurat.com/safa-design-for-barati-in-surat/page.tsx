...
export const metadata: Metadata = {
  ...
  keywords: "safa design for barati in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Barati Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/safa-design-for-barati-in-surat",
    type: "website",
  },
}

export default function SafaDesignForBaratiInSuratPage() {
  const pageData = {
