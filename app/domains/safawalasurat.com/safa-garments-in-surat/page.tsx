...
export const metadata: Metadata = {
  ...
  keywords: "safa garments in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/safa-garments-in-surat",
    type: "website",
  },
}

export default function SafaGarmentsInSuratPage() {
  const pageData = {
    title: "Safa in Surat",
