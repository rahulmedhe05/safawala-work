...
export const metadata: Metadata = {
  ...
  keywords: "custom wedding safa in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/custom-wedding-safa-in-surat",
    type: "website",
  },
}

export default function CustomWeddingSafaInSuratPage() {
  const pageData = {
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["On-site professional service at your Surat venue", "Emergency last-minute service available in Surat", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in Surat"],
    seoKeywords: ["custom wedding safa in surat", "safa Surat", "wedding safa Surat", "safa service Surat"],
    faqs: [
  {
