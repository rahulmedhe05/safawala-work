...
export const metadata: Metadata = {
  title: "Punjab Turban in Surat | Safawala Surat",
  ...
  keywords: "punjabi turban in surat, turban Surat, wedding turban Surat, turban service Surat",
  openGraph: {
    title: "Punjab Turban in Surat | Safawala Surat",
    description: "Premium turban service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/punjabi-turban-in-surat",
    type: "website",
  },
}

export default function PunjabiTurbanInSuratPage() {
  const pageData = {
    title: "Punjab Turban in Surat",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Surat - Your Premier Punjab Turban in Surat Destination</h2>
