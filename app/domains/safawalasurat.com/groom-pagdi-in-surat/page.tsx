...
export const metadata: Metadata = {
  ...
  keywords: "groom pagdi in surat, pagdi Surat, wedding pagdi Surat, pagdi service Surat",
  openGraph: {
    title: "Groom Pagdi in Surat | Safawala Surat",
    description: "Premium pagdi service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/groom-pagdi-in-surat",
    type: "website",
  },
}

export default function GroomPagdiInSuratPage() {
  const pageData = {
