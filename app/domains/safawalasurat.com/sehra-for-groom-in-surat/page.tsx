...
export const metadata: Metadata = {
  title: "Groom Sehra in Surat | Safawala Surat",
  ...
  keywords: "sehra for groom in surat, sehra Surat, wedding sehra Surat, sehra service Surat",
  openGraph: {
    title: "Groom Sehra in Surat | Safawala Surat",
    description: "Premium sehra service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/sehra-for-groom-in-surat",
    type: "website",
  },
}

export default function SehraForGroomInSuratPage() {
  const pageData = {
    title: "Groom Sehra in Surat",
    ...
    seoKeywords: ["sehra for groom in surat", "sehra Surat", "wedding sehra Surat", "sehra service Surat"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Surat - Your Premier Groom Sehra in Surat Destination</h2>
