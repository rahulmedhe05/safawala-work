...
export const metadata: Metadata = {
  ...
  keywords: "safa shop in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/safa-shop-in-surat",
    type: "website",
  },
}

export default function SafaShopInSuratPage() {
  const pageData = {
    title: "Safa in Surat",
