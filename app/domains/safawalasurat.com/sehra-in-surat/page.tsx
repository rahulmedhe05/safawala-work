...
export const metadata: Metadata = {
  ...
  keywords: "sehra in surat, sehra Surat, wedding sehra Surat, sehra service Surat",
  openGraph: {
    title: "Sehra in Surat | Safawala Surat",
    description: "Premium sehra service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/sehra-in-surat",
    type: "website",
  },
}

export default function SehraInSuratPage() {
  const pageData = {
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["Emergency last-minute service available in Surat", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in Surat", "On-site professional service at your Surat venue"],
    seoKeywords: ["sehra in surat", "sehra Surat", "wedding sehra Surat", "sehra service Surat"],
    faqs: [
  {
