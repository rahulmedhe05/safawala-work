...
export const metadata: Metadata = {
  title: "Jodhpur Pagdi in Surat | Safawala Surat",
  ...
  keywords: "jodhpuri pagdi in surat, pagdi Surat, wedding pagdi Surat, pagdi service Surat",
  openGraph: {
    title: "Jodhpur Pagdi in Surat | Safawala Surat",
    description: "Premium pagdi service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/jodhpuri-pagdi-in-surat",
    type: "website",
  },
}

export default function JodhpuriPagdiInSuratPage() {
  const pageData = {
    title: "Jodhpur Pagdi in Surat",
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Surat"],
    seoKeywords: ["jodhpuri pagdi in surat", "pagdi Surat", "wedding pagdi Surat", "pagdi service Surat"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Surat - Your Premier Jodhpur Pagdi in Surat Destination</h2>
