...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in surat, sehra Surat, wedding sehra Surat, sehra service Surat",
  openGraph: {
    title: "Sehra in Surat | Safawala Surat",
    description: "Premium sehra service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/sehrabandi-in-surat",
    type: "website",
  },
}

export default function SehrabandiInSuratPage() {
  const pageData = {
    ...
    seoKeywords: ["sehrabandi in surat", "sehra Surat", "wedding sehra Surat", "sehra service Surat"],
    faqs: [
  {
