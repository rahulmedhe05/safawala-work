...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Surat | Safawala Surat",
  description: "Looking for premium pagdi in Surat? Safawala Surat is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage...",
  keywords: "rajput pagdi in surat, pagdi Surat, wedding pagdi Surat, pagdi service Surat",
  openGraph: {
    title: "Rajputana Pagdi in Surat | Safawala Surat",
    description: "Premium pagdi service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/rajput-pagdi-in-surat",
    type: "website",
  },
}

export default function RajputPagdiInSuratPage() {
  const pageData = {
    title: "Rajputana Pagdi in Surat",
    shortDescription: "Looking for premium pagdi in Surat? Safawala Surat is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagdi service in Surat by Safawala Surat.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: SURAT_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert pagdi specialists with 40+ years experience in Surat", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Emergency last-minute service available in Surat"],
    seoKeywords: ["rajput pagdi in surat", "pagdi Surat", "wedding pagdi Surat", "pagdi service Surat"],
    faqs: [
  {
    "question": "How early should I book Pagdi for my Surat wedding?",
  ...
  {
    "question": "What is the price of Pagdi in Surat?",
    "answer": "Our Pagdi prices in Surat start from \u20b9500 for basic options and go up to \u20b95000+ for premium designer pieces. We offer packages for individuals and bulk orders for barati. Contact us for a customized quote based on your specific requirements."
  },
  {
    "question": "Do you offer Pagdi for destination weddings outside Surat?",
    "answer": "Yes, we provide Pagdi services for destination weddings across India and internationally. Our team regularly travels to provide services at luxury hotels, resorts, and wedding venues outside Surat."
  },
  {
  ...
  {
    "question": "Do you provide on-site Pagdi tying service in Surat?",
    "answer": "Yes, we provide professional on-site Pagdi tying service across all Surat areas. Our expert turban specialists will come to your venue fully equipped to ensure perfect styling for the groom and barati."
  }
],
    content: `
<h2>Welcome to Safawala Surat - Your Premier Rajputana Pagdi in Surat Destination</h2>

<p>Safawala Surat presents the most exquisite Pagdi collection in the region. Our master craftsmen specialize in creating the perfect turban experience for vibrant diamond city celebrations.</p>


<h2>Why Choose Safawala Surat for Pagdi?</h2>

<p>When it comes to <strong>pagdi</strong> in Surat, Safawala stands apart as the region's most trusted turban specialists. Here's why families across Surat choose us:</p>

<h3>40+ Years of Turban Excellence</h3>
<p>Our pagdi expertise comes from four generations of dedicated craftsmanship. We understand the cultural significance of every turban and deliver perfection for your special occasions in Surat.</p>
...
<p>We provide on-site pagdi services across all Surat areas. Our team arrives fully prepared with complete collections, professional equipment, and backup options.</p>



<h2>Our Pagdi Services in Surat</h2>
...
<h2>Book Your Pagdi in Surat</h2>

<p>Ready to experience the finest pagdi service in Surat? Booking is simple:</p>
...
<p>At Safawala Surat, every turban tells a story of tradition, craftsmanship, and celebration. We take pride in being part of your special moments, ensuring each pagdi reflects the joy and grandeur of vibrant diamond city celebrations.</p>
