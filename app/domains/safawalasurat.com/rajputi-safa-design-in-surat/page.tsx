...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa design in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Rajputana Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/rajputi-safa-design-in-surat",
    type: "website",
  },
}

export default function RajputiSafaDesignInSuratPage() {
  const pageData = {
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["On-site professional service at your Surat venue", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Surat", "Expert safa specialists with 40+ years experience in Surat", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["rajputi safa design in surat", "safa Surat", "wedding safa Surat", "safa service Surat"],
    faqs: [
  {
