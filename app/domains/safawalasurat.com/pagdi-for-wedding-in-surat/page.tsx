...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for wedding in surat, pagdi Surat, wedding pagdi Surat, pagdi service Surat",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Surat | Safawala Surat",
    description: "Premium pagdi service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/pagdi-for-wedding-in-surat",
    type: "website",
  },
}

export default function PagdiForWeddingInSuratPage() {
  const pageData = {
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["On-site professional service at your Surat venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders"],
    seoKeywords: ["pagdi for wedding in surat", "pagdi Surat", "wedding pagdi Surat", "pagdi service Surat"],
    faqs: [
  {
