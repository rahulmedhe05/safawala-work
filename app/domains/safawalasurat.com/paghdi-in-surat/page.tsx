...
export const metadata: Metadata = {
  ...
  keywords: "paghdi in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/paghdi-in-surat",
    type: "website",
  },
}

export default function PaghdiInSuratPage() {
  const pageData = {
    title: "Safa in Surat",
