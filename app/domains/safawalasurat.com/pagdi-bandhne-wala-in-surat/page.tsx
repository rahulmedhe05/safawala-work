...
export const metadata: Metadata = {
  ...
  keywords: "pagdi bandhne wala in surat, pagdi Surat, wedding pagdi Surat, pagdi service Surat",
  openGraph: {
    title: "Pagdi in Surat | Safawala Surat",
    description: "Premium pagdi service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/pagdi-bandhne-wala-in-surat",
    type: "website",
  },
}

export default function PagdiBandhneWalaInSuratPage() {
  const pageData = {
