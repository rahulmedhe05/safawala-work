...
export const metadata: Metadata = {
  ...
  keywords: "groom sehra in surat, sehra Surat, wedding sehra Surat, sehra service Surat",
  openGraph: {
    title: "Groom Sehra in Surat | Safawala Surat",
    description: "Premium sehra service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/groom-sehra-in-surat",
    type: "website",
  },
}

export default function GroomSehraInSuratPage() {
  const pageData = {
    ...
    areas: SURAT_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Surat", "Free consultation and design preview via WhatsApp", "Expert sehra specialists with 40+ years experience in Surat"],
    seoKeywords: ["groom sehra in surat", "sehra Surat", "wedding sehra Surat", "sehra service Surat"],
    faqs: [
  {
