...
export const metadata: Metadata = {
  ...
  keywords: "safa design in surat, safa Surat, wedding safa Surat, safa service Surat",
  openGraph: {
    title: "Safa in Surat | Safawala Surat",
    description: "Premium safa service in Surat by Safawala Surat.",
    url: "https://safawalasurat.com/safa-design-in-surat",
    type: "website",
  },
}

export default function SafaDesignInSuratPage() {
  const pageData = {
    title: "Safa in Surat",
