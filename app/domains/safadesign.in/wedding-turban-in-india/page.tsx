...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safadesign.in/wedding-turban-in-india",
    type: "website",
  },
}
...
export default function WeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Expert turban specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
