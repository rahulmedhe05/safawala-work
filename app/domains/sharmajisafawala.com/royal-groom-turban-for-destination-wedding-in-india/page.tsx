...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://sharmajisafawala.com/royal-groom-turban-for-destination-wedding-in-india",
    type: "website",
  },
}
...
export default function RoyalGroomTurbanForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue"],
