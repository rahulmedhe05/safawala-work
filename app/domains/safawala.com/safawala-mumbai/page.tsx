...
export const metadata: Metadata = {
  ...
  keywords: "safawala mumbai, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawala.com/safawala-mumbai",
    type: "website",
  },
}

export default function SafawalaMumbaiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safawala mumbai", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
