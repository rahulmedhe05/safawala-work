...
export const metadata: Metadata = {
  ...
  keywords: "about safawala, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawala.com/about-safawala",
    type: "website",
  },
}

export default function AboutSafawalaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["about safawala", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
