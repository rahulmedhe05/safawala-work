...
export const metadata: Metadata = {
  ...
  keywords: "safawala delhi, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://safawala.com/safawala-delhi",
    type: "website",
  },
}

export default function SafawalaDelhiPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["safawala delhi", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
