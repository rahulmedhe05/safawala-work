...
export const metadata: Metadata = {
  ...
  keywords: "dulhe ka sehra in nagpur, sehra Nagpur, wedding sehra Nagpur, sehra service Nagpur",
  openGraph: {
    title: "Sehra in Nagpur | Safawala Nagpur",
    description: "Premium sehra service in Nagpur by Safawala Nagpur.",
    url: "https://safawalanagpur.com/dulhe-ka-sehra-in-nagpur",
    type: "website",
  },
}

export default function DulheKaSehraInNagpurPage() {
  const pageData = {
    ...
    areas: NAGPUR_AREAS,
    keyFeatures: ["On-site professional service at your Nagpur venue", "Expert sehra specialists with 40+ years experience in Nagpur", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination"],
    seoKeywords: ["dulhe ka sehra in nagpur", "sehra Nagpur", "wedding sehra Nagpur", "sehra service Nagpur"],
    faqs: [
  {
