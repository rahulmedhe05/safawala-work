...
export const metadata: Metadata = {
  ...
  keywords: "sehra for groom in nagpur, sehra Nagpur, wedding sehra Nagpur, sehra service Nagpur",
  openGraph: {
    title: "Groom Sehra in Nagpur | Safawala Nagpur",
    description: "Premium sehra service in Nagpur by Safawala Nagpur.",
    url: "https://safawalanagpur.com/sehra-for-groom-in-nagpur",
    type: "website",
  },
}

export default function SehraForGroomInNagpurPage() {
  const pageData = {
    ...
    areas: NAGPUR_AREAS,
    keyFeatures: ["On-site professional service at your Nagpur venue", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Expert sehra specialists with 40+ years experience in Nagpur", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["sehra for groom in nagpur", "sehra Nagpur", "wedding sehra Nagpur", "sehra service Nagpur"],
    faqs: [
  {
