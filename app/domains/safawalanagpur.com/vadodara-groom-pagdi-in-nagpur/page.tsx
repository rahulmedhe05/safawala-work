...
export const metadata: Metadata = {
  ...
  keywords: "vadodara groom pagdi in nagpur, pagdi Nagpur, wedding pagdi Nagpur, pagdi service Nagpur",
  openGraph: {
    title: "Groom Pagdi in Nagpur | Safawala Nagpur",
    description: "Premium pagdi service in Nagpur by Safawala Nagpur.",
    url: "https://safawalanagpur.com/vadodara-groom-pagdi-in-nagpur",
    type: "website",
  },
}

export default function VadodaraGroomPagdiInNagpurPage() {
  const pageData = {
    ...
    areas: NAGPUR_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in Nagpur", "On-site professional service at your Nagpur venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Nagpur"],
    seoKeywords: ["vadodara groom pagdi in nagpur", "pagdi Nagpur", "wedding pagdi Nagpur", "pagdi service Nagpur"],
    faqs: [
  {
