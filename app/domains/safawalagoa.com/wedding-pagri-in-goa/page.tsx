...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Pagri in Goa | Safawala Goa",
  ...
  keywords: "wedding pagri in goa, pagri Goa, wedding pagri Goa, pagri service Goa",
  openGraph: {
    title: "Premium Wedding-Grade Pagri in Goa | Safawala Goa",
    description: "Premium pagri service in Goa by Safawala Goa.",
    url: "https://safawalagoa.com/wedding-pagri-in-goa",
    type: "website",
  },
}

export default function WeddingPagriInGoaPage() {
  const pageData = {
    title: "Premium Wedding-Grade Pagri in Goa",
    ...
    areas: GOA_AREAS,
    keyFeatures: ["Emergency last-minute service available in Goa", "Competitive pricing for individual and bulk orders", "Expert pagri specialists with 40+ years experience in Goa", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "On-site professional service at your Goa venue"],
    seoKeywords: ["wedding pagri in goa", "pagri Goa", "wedding pagri Goa", "pagri service Goa"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Goa - Your Premier Premium Wedding-Grade Pagri in Goa Destination</h2>

<p>Safawala Goa presents the most exquisite Pagri collection in the region. Our master craftsmen specialize in creating the perfect turban experience for beach destination weddings.</p>
