...
export const metadata: Metadata = {
  ...
  keywords: "safa design in goa, safa Goa, wedding safa Goa, safa service Goa",
  openGraph: {
    title: "Safa in Goa | Safawala Goa",
    description: "Premium safa service in Goa by Safawala Goa.",
    url: "https://safawalagoa.com/safa-design-in-goa",
    type: "website",
  },
}

export default function SafaDesignInGoaPage() {
  const pageData = {
    title: "Safa in Goa",
    ...
    areas: GOA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in Goa", "Emergency last-minute service available in Goa", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["safa design in goa", "safa Goa", "wedding safa Goa", "safa service Goa"],
    faqs: [
  {
