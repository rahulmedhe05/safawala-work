...
export const metadata: Metadata = {
  ...
  keywords: "turban tying in pune, turban Pune, wedding turban Pune, turban service Pune",
  openGraph: {
    title: "Turban in Pune | Safawala India",
    description: "Premium turban service in Pune by Safawala India.",
    url: "https://turbantying.com/turban-tying-in-pune",
    type: "website",
  },
}

export default function TurbanTyingInPunePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in Pune", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Pune venue", "Complete barati packages with matching coordination"],
    seoKeywords: ["turban tying in pune", "turban Pune", "wedding turban Pune", "turban service Pune"],
    faqs: [
  {
