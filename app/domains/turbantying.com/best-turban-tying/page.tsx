...
export const metadata: Metadata = {
  ...
  keywords: "best turban tying, turban India, wedding turban India, turban service India",
  openGraph: {
    title: "Turban in India | Safawala India",
    description: "Premium turban service in India by Safawala India.",
    url: "https://turbantying.com/best-turban-tying",
    type: "website",
  },
}

export default function BestTurbanTyingPage() {
  const pageData = {
    ...
    seoKeywords: ["best turban tying", "turban India", "wedding turban India", "turban service India"],
    faqs: [
  {
