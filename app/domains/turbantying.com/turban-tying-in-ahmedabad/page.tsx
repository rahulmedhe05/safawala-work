...
export const metadata: Metadata = {
  ...
  keywords: "turban tying in ahmedabad, turban Ahmedabad, wedding turban Ahmedabad, turban service Ahmedabad",
  openGraph: {
    title: "Turban in Ahmedabad | Safawala India",
    description: "Premium turban service in Ahmedabad by Safawala India.",
    url: "https://turbantying.com/turban-tying-in-ahmedabad",
    type: "website",
  },
}

export default function TurbanTyingInAhmedabadPage() {
  const pageData = {
