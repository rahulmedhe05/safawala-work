...
export const metadata: Metadata = {
  ...
  keywords: "turban tying in goa, turban Goa, wedding turban Goa, turban service Goa",
  openGraph: {
    title: "Turban in Goa | Safawala India",
    description: "Premium turban service in Goa by Safawala India.",
    url: "https://turbantying.com/turban-tying-in-goa",
    type: "website",
  },
}

export default function TurbanTyingInGoaPage() {
  const pageData = {
    title: "Turban in Goa",
