...
export const metadata: Metadata = {
  ...
  keywords: "bulk safa in goa, safa Goa, wedding safa Goa, safa service Goa",
  openGraph: {
    title: "Safa in Goa | Safawala India",
    description: "Premium safa service in Goa by Safawala India.",
    url: "https://bulksafa.com/bulk-safa-in-goa",
    type: "website",
  },
}

export default function BulkSafaInGoaPage() {
  const pageData = {
    title: "Safa in Goa",
