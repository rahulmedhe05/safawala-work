...
export const metadata: Metadata = {
  ...
  keywords: "best bulk safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://bulksafa.com/best-bulk-safa",
    type: "website",
  },
}

export default function BestBulkSafaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["best bulk safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
