...
export const metadata: Metadata = {
  ...
  keywords: "affordable bulk safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://bulksafa.com/affordable-bulk-safa",
    type: "website",
  },
}

export default function AffordableBulkSafaPage() {
  const pageData = {
    title: "Safa in India",
    ...
    seoKeywords: ["affordable bulk safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
