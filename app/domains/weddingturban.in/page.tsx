...
export const metadata: Metadata = {
  title: "Wedding Turban | Wedding turban service | Book Online India",
  description: "Wedding Turban - Wedding turban service. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "wedding turban, wedding-turban, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Wedding Turban | Premium Turban Service",
    description: "Wedding turban service. Expert turban service across India.",
    url: "https://weddingturban.in",
    type: "website",
  },
}

const SPECIALTIES = ['All Turban Styles', 'Complete Wedding Solution', 'Expert Service', 'Premium Quality']
...
export default function WeddingTurbanHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Wedding turban service. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Wedding Turban" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Wedding Turban Specialties</h2>
      ...
      <DynamicAboutSection location="Wedding Turban" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Wedding Turban" state="India" domain="weddingturban.in" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
