...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://weddingturban.in/jodhpuri-safa-in-india",
    type: "website",
  },
}
...
export default function JodhpuriSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders"],
