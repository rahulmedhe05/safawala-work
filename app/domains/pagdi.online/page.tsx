...
export const metadata: Metadata = {
  title: "Pagdi Online | Online pagdi booking | Book Online India",
  description: "Pagdi Online - Online pagdi booking. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "pagdi online, pagdi-online, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Pagdi Online | Premium Turban Service",
    description: "Online pagdi booking. Expert turban service across India.",
    url: "https://pagdi.online",
    type: "website",
  },
}

const SPECIALTIES = ['Easy Online Booking', 'Virtual Consultation', 'Home Delivery', '24/7 Support']
...
export default function PagdiOnlineHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Online pagdi booking. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Pagdi Online" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Pagdi Online Specialties</h2>
      ...
      <DynamicAboutSection location="Pagdi Online" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Pagdi Online" state="India" domain="pagdi.online" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
