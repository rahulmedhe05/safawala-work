...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://sharmajisafawale.in/safa-on-rent-in-india",
    type: "website",
  },
}
...
export default function SafaOnRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders"],
