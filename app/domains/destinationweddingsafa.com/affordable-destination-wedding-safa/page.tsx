...
export const metadata: Metadata = {
  ...
  keywords: "affordable destination wedding safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://destinationweddingsafa.com/affordable-destination-wedding-safa",
    type: "website",
  },
}

export default function AffordableDestinationWeddingSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["affordable destination wedding safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
