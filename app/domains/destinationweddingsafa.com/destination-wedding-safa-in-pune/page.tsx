...
export const metadata: Metadata = {
  ...
  keywords: "destination wedding safa in pune, safa Pune, wedding safa Pune, safa service Pune",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Pune | Safawala India",
    description: "Premium safa service in Pune by Safawala India.",
    url: "https://destinationweddingsafa.com/destination-wedding-safa-in-pune",
    type: "website",
  },
}

export default function DestinationWeddingSafaInPunePage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Pune", "Emergency last-minute service available in Pune"],
    seoKeywords: ["destination wedding safa in pune", "safa Pune", "wedding safa Pune", "safa service Pune"],
    faqs: [
  {
