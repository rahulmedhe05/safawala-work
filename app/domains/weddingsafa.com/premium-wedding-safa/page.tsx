...
export const metadata: Metadata = {
  ...
  keywords: "premium wedding safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://weddingsafa.com/premium-wedding-safa",
    type: "website",
  },
}

export default function PremiumWeddingSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["premium wedding safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
