...
export const metadata: Metadata = {
  ...
  keywords: "affordable wedding safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://weddingsafa.com/affordable-wedding-safa",
    type: "website",
  },
}

export default function AffordableWeddingSafaPage() {
  const pageData = {
    ...
    seoKeywords: ["affordable wedding safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
