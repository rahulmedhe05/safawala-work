...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Safa in Goa | Safawala India",
  description: "Looking for premium safa in Goa? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to...",
  keywords: "wedding safa in goa, safa Goa, wedding safa Goa, safa service Goa",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Goa | Safawala India",
    description: "Premium safa service in Goa by Safawala India.",
    url: "https://weddingsafa.com/wedding-safa-in-goa",
    type: "website",
  },
}
...
export default function WeddingSafaInGoaPage() {
  const pageData = {
    ...
    shortDescription: "Looking for premium safa in Goa? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium safa service in Goa by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "On-site professional service at your Goa venue", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in Goa"],
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Safa in Goa Destination</h2>

<p>Safawala Goa presents the most exquisite Safa collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
