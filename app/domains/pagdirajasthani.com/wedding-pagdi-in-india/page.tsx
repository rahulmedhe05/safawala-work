...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagdirajasthani.com/wedding-pagdi-in-india",
    type: "website",
  },
}
...
export default function WeddingPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
