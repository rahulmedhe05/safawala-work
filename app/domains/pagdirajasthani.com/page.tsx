...
export const metadata: Metadata = {
  ...
  description: "Rajasthani Pagdi - Classic Rajasthani turban. Premium rajasthani pagdi collection for grooms & weddings. Authentic Rajasthan style turbans. 40+ years expertise. Order online or book service!",
  ...
  openGraph: {
    ...
    description: "Classic Rajasthani turban. Authentic Rajasthan style turbans for weddings.",
    url: "https://pagdirajasthani.com",
    type: "website",
  },
}

const COLORS = ['Traditional Red', 'Saffron', 'Pink', 'Yellow', 'Multi-color']
const OCCASIONS = ['Weddings', 'Festivals', 'Religious Events', 'Cultural Celebrations']
...
const FAQ = [
  { q: "What makes Rajasthani Pagdi unique?", a: "Rajasthani Pagdi represents Classic Rajasthani turban. It features distinctive patterns and colors that are iconic to Rajasthan culture and tradition." },
  { q: "What colors are available in Rajasthani Pagdi?", a: "Our Rajasthani Pagdi collection is available in traditional colors including Traditional Red, Saffron, Pink and many more options to match your outfit." },
...
export default function RajasthaniPagdiHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Classic Rajasthani turban. Discover our exclusive collection of authentic Rajasthani Pagdi 
      ...
      <ContactForm />
      <DynamicFooter location="Rajasthani Pagdi" state="Rajasthan" domain="pagdirajasthani.com" type="style" />
      <WhatsAppFloat />
    </main>
  )
}
