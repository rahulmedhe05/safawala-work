...
export const metadata: Metadata = {
  title: "Pagdi in Delhi | Safawala India",
  description: "Looking for premium pagdi in Delhi? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage...",
  keywords: "pagdi binding in delhi, pagdi Delhi, wedding pagdi Delhi, pagdi service Delhi",
  openGraph: {
    title: "Pagdi in Delhi | Safawala India",
    description: "Premium pagdi service in Delhi by Safawala India.",
    url: "https://pagdibinding.com/pagdi-binding-in-delhi",
    type: "website",
  },
}

export default function PagdiBindingInDelhiPage() {
  const pageData = {
    title: "Pagdi in Delhi",
    shortDescription: "Looking for premium pagdi in Delhi? Safawala India is your trusted partner for authentic turban service. Our expert specialists bring 40+ years of heritage to make your special day truly memorable.",
    description: "Premium pagdi service in Delhi by Safawala India.",
    mainImage: "/hero-groom.webp",
    videos: ["/main-video.mp4"],
    galleryImages: ["/1.png", "/2.png", "/3.png", "/gallery-3.png", "/gallery-4.png"],
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Delhi", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in Delhi"],
    seoKeywords: ["pagdi binding in delhi", "pagdi Delhi", "wedding pagdi Delhi", "pagdi service Delhi"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Pagdi in Delhi Destination</h2>

<p>Safawala Delhi presents the most exquisite Pagdi collection in the region. Our master craftsmen specialize in creating the perfect turban experience for traditional ceremonies.</p>
