...
export const metadata: Metadata = {
  ...
  keywords: "feta binding designs, feta India, wedding feta India, feta service India",
  openGraph: {
    title: "Feta in India | Safawala India",
    description: "Premium feta service in India by Safawala India.",
    url: "https://fetabinding.com/feta-binding-designs",
    type: "website",
  },
}

export default function FetaBindingDesignsPage() {
  const pageData = {
    title: "Feta in India",
