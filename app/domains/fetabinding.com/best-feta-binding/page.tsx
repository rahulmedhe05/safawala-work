...
export const metadata: Metadata = {
  ...
  keywords: "best feta binding, feta India, wedding feta India, feta service India",
  openGraph: {
    title: "Feta in India | Safawala India",
    description: "Premium feta service in India by Safawala India.",
    url: "https://fetabinding.com/best-feta-binding",
    type: "website",
  },
}

export default function BestFetaBindingPage() {
  const pageData = {
    title: "Feta in India",
