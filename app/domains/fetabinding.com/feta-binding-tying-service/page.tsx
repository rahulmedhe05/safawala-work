...
export const metadata: Metadata = {
  ...
  keywords: "feta binding tying service, feta India, wedding feta India, feta service India",
  openGraph: {
    title: "Feta in India | Safawala India",
    description: "Premium feta service in India by Safawala India.",
    url: "https://fetabinding.com/feta-binding-tying-service",
    type: "website",
  },
}

export default function FetaBindingTyingServicePage() {
  const pageData = {
    title: "Feta in India",
