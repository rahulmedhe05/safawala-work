...
export const metadata: Metadata = {
  title: "Rajputana Pagdi in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "rajput pagdi in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Rajputana Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/rajput-pagdi-in-gurgaon",
    type: "website",
  },
}

export default function RajputPagdiInGurgaonPage() {
  const pageData = {
    title: "Rajputana Pagdi in Gurgaon",
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Competitive pricing for individual and bulk orders", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in Gurgaon", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["rajput pagdi in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Rajputana Pagdi in Gurgaon Destination</h2>
