...
export const metadata: Metadata = {
  title: "Sehra in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "sehra in gurgaon, sehra Gurgaon, wedding sehra Gurgaon, sehra service Gurgaon",
  openGraph: {
    title: "Sehra in Gurgaon | Safawala Gurgaon",
    description: "Premium sehra service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/sehra-in-gurgaon",
    type: "website",
  },
}

export default function SehraInGurgaonPage() {
  const pageData = {
    title: "Sehra in Gurgaon",
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["On-site professional service at your Gurgaon venue", "Complete barati packages with matching coordination", "Expert sehra specialists with 40+ years experience in Gurgaon", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Gurgaon", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["sehra in gurgaon", "sehra Gurgaon", "wedding sehra Gurgaon", "sehra service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Sehra in Gurgaon Destination</h2>
