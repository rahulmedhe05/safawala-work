...
export const metadata: Metadata = {
  title: "Marwar Safa in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "marwadi safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Marwar Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/marwadi-safa-in-gurgaon",
    type: "website",
  },
}

export default function MarwadiSafaInGurgaonPage() {
  const pageData = {
    title: "Marwar Safa in Gurgaon",
    ...
    seoKeywords: ["marwadi safa in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Marwar Safa in Gurgaon Destination</h2>
