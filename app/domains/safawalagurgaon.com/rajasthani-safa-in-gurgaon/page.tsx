...
export const metadata: Metadata = {
  title: "Rajasthan Safa in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "rajasthani safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Rajasthan Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/rajasthani-safa-in-gurgaon",
    type: "website",
  },
}

export default function RajasthaniSafaInGurgaonPage() {
  const pageData = {
    title: "Rajasthan Safa in Gurgaon",
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert safa specialists with 40+ years experience in Gurgaon", "On-site professional service at your Gurgaon venue", "Emergency last-minute service available in Gurgaon"],
    seoKeywords: ["rajasthani safa in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Rajasthan Safa in Gurgaon Destination</h2>
