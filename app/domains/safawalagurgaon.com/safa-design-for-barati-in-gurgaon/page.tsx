...
export const metadata: Metadata = {
  ...
  keywords: "safa design for barati in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Barati Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/safa-design-for-barati-in-gurgaon",
    type: "website",
  },
}

export default function SafaDesignForBaratiInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Expert safa specialists with 40+ years experience in Gurgaon", "Complete barati packages with matching coordination", "Emergency last-minute service available in Gurgaon", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["safa design for barati in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
