...
export const metadata: Metadata = {
  ...
  keywords: "custom wedding safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/custom-wedding-safa-in-gurgaon",
    type: "website",
  },
}

export default function CustomWeddingSafaInGurgaonPage() {
  const pageData = {
