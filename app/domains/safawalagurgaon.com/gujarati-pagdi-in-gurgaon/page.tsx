...
export const metadata: Metadata = {
  title: "Gujarat Pagdi in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "gujarati pagdi in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Gujarat Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/gujarati-pagdi-in-gurgaon",
    type: "website",
  },
}

export default function GujaratiPagdiInGurgaonPage() {
  const pageData = {
    title: "Gujarat Pagdi in Gurgaon",
    ...
    seoKeywords: ["gujarati pagdi in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Gujarat Pagdi in Gurgaon Destination</h2>
