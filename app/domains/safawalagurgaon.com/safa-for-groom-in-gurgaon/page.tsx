...
export const metadata: Metadata = {
  ...
  keywords: "safa for groom in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Groom Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/safa-for-groom-in-gurgaon",
    type: "website",
  },
}

export default function SafaForGroomInGurgaonPage() {
  const pageData = {
    ...
    seoKeywords: ["safa for groom in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
