...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for marriage in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/pagdi-for-marriage-in-gurgaon",
    type: "website",
  },
}

export default function PagdiForMarriageInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Emergency last-minute service available in Gurgaon", "Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in Gurgaon", "On-site professional service at your Gurgaon venue", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["pagdi for marriage in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
