...
export const metadata: Metadata = {
  ...
  keywords: "dulhe ki pagdi in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/dulhe-ki-pagdi-in-gurgaon",
    type: "website",
  },
}

export default function DulheKiPagdiInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "On-site professional service at your Gurgaon venue", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in Gurgaon", "Complete barati packages with matching coordination"],
    seoKeywords: ["dulhe ki pagdi in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
