...
export const metadata: Metadata = {
  ...
  keywords: "rajputi safa design in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Rajputana Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/rajputi-safa-design-in-gurgaon",
    type: "website",
  },
}

export default function RajputiSafaDesignInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in Gurgaon", "Expert safa specialists with 40+ years experience in Gurgaon", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "On-site professional service at your Gurgaon venue"],
    seoKeywords: ["rajputi safa design in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
