...
export const metadata: Metadata = {
  title: "Groom Pagdi in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "groom pagdi in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Groom Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/groom-pagdi-in-gurgaon",
    type: "website",
  },
}

export default function GroomPagdiInGurgaonPage() {
  const pageData = {
    title: "Groom Pagdi in Gurgaon",
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in Gurgaon", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "On-site professional service at your Gurgaon venue", "Customized designs matching your wedding theme and outfit"],
    seoKeywords: ["groom pagdi in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Groom Pagdi in Gurgaon Destination</h2>
