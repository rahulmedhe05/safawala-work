...
export const metadata: Metadata = {
  ...
  keywords: "pagdi bandhne wala in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/pagdi-bandhne-wala-in-gurgaon",
    type: "website",
  },
}

export default function PagdiBandhneWalaInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in Gurgaon", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["pagdi bandhne wala in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
