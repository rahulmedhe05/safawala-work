...
export const metadata: Metadata = {
  ...
  keywords: "safa for barati in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Barati Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/safa-for-barati-in-gurgaon",
    type: "website",
  },
}

export default function SafaForBaratiInGurgaonPage() {
  const pageData = {
