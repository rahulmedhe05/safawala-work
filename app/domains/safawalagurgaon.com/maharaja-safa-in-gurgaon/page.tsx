...
export const metadata: Metadata = {
  title: "Royal palaces Safa in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "maharaja safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Royal palaces Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/maharaja-safa-in-gurgaon",
    type: "website",
  },
}

export default function MaharajaSafaInGurgaonPage() {
  const pageData = {
    title: "Royal palaces Safa in Gurgaon",
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Emergency last-minute service available in Gurgaon", "Premium materials - silk, brocade, velvet, and designer fabrics", "Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in Gurgaon", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["maharaja safa in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Royal palaces Safa in Gurgaon Destination</h2>
