...
export const metadata: Metadata = {
  title: "Royal courts Safa in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "rajwadi safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Royal courts Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/rajwadi-safa-in-gurgaon",
    type: "website",
  },
}

export default function RajwadiSafaInGurgaonPage() {
  const pageData = {
    title: "Royal courts Safa in Gurgaon",
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Royal courts Safa in Gurgaon Destination</h2>
