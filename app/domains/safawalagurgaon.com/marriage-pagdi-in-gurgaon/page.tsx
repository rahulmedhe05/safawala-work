...
export const metadata: Metadata = {
  ...
  keywords: "marriage pagdi in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/marriage-pagdi-in-gurgaon",
    type: "website",
  },
}

export default function MarriagePagdiInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Free consultation and design preview via WhatsApp", "Emergency last-minute service available in Gurgaon", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in Gurgaon"],
    seoKeywords: ["marriage pagdi in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
