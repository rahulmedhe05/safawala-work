...
export const metadata: Metadata = {
  ...
  keywords: "pagdi in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/pagdi-in-gurgaon",
    type: "website",
  },
}

export default function PagdiInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Emergency last-minute service available in Gurgaon", "Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your Gurgaon venue", "Expert pagdi specialists with 40+ years experience in Gurgaon", "Free consultation and design preview via WhatsApp"],
    seoKeywords: ["pagdi in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
