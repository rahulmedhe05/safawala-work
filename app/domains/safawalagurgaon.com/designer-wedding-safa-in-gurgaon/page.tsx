...
export const metadata: Metadata = {
  ...
  keywords: "designer wedding safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/designer-wedding-safa-in-gurgaon",
    type: "website",
  },
}

export default function DesignerWeddingSafaInGurgaonPage() {
  const pageData = {
    ...
    seoKeywords: ["designer wedding safa in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
