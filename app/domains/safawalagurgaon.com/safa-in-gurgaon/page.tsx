...
export const metadata: Metadata = {
  ...
  keywords: "safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/safa-in-gurgaon",
    type: "website",
  },
}

export default function SafaInGurgaonPage() {
  const pageData = {
