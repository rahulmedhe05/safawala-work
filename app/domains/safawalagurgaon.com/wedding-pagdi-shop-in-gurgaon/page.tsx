...
export const metadata: Metadata = {
  ...
  keywords: "wedding pagdi shop in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Premium Wedding-Grade Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/wedding-pagdi-shop-in-gurgaon",
    type: "website",
  },
}

export default function WeddingPagdiShopInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in Gurgaon", "Expert pagdi specialists with 40+ years experience in Gurgaon", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["wedding pagdi shop in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
