...
export const metadata: Metadata = {
  ...
  keywords: "barati safa online in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Barati Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/barati-safa-online-in-gurgaon",
    type: "website",
  },
}

export default function BaratiSafaOnlineInGurgaonPage() {
  const pageData = {
...
<p>Welcome to Safawala Gurgaon - your premier destination for Safa services. With over 40 years of expertise in traditional turban craftsmanship, we bring royal elegance to your special day.</p>
