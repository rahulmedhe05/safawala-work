...
export const metadata: Metadata = {
  ...
  keywords: "sehrabandi in gurgaon, sehra Gurgaon, wedding sehra Gurgaon, sehra service Gurgaon",
  openGraph: {
    title: "Sehra in Gurgaon | Safawala Gurgaon",
    description: "Premium sehra service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/sehrabandi-in-gurgaon",
    type: "website",
  },
}

export default function SehrabandiInGurgaonPage() {
  const pageData = {
