...
export const metadata: Metadata = {
  ...
  keywords: "wedding safa for rent in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/wedding-safa-for-rent-in-gurgaon",
    type: "website",
  },
}

export default function WeddingSafaForRentInGurgaonPage() {
  const pageData = {
    ...
    seoKeywords: ["wedding safa for rent in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
