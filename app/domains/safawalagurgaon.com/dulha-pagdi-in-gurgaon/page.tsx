...
export const metadata: Metadata = {
  title: "Dulha (Groom) Pagdi in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "dulha pagdi in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Dulha (Groom) Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/dulha-pagdi-in-gurgaon",
    type: "website",
  },
}

export default function DulhaPagdiInGurgaonPage() {
  const pageData = {
    title: "Dulha (Groom) Pagdi in Gurgaon",
    ...
    seoKeywords: ["dulha pagdi in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Dulha (Groom) Pagdi in Gurgaon Destination</h2>
