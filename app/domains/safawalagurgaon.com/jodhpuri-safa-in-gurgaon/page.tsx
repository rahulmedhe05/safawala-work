...
export const metadata: Metadata = {
  title: "Jodhpur Safa in Gurgaon | Safawala Gurgaon",
  ...
  keywords: "jodhpuri safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Jodhpur Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/jodhpuri-safa-in-gurgaon",
    type: "website",
  },
}

export default function JodhpuriSafaInGurgaonPage() {
  const pageData = {
    title: "Jodhpur Safa in Gurgaon",
    ...
    seoKeywords: ["jodhpuri safa in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala Gurgaon - Your Premier Jodhpur Safa in Gurgaon Destination</h2>
