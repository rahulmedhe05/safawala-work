...
export const metadata: Metadata = {
  ...
  keywords: "safa garments in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/safa-garments-in-gurgaon",
    type: "website",
  },
}

export default function SafaGarmentsInGurgaonPage() {
  const pageData = {
    ...
    seoKeywords: ["safa garments in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
