...
export const metadata: Metadata = {
  ...
  keywords: "royal wedding safa in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Premium Wedding-Grade Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/royal-wedding-safa-in-gurgaon",
    type: "website",
  },
}

export default function RoyalWeddingSafaInGurgaonPage() {
  const pageData = {
    ...
    seoKeywords: ["royal wedding safa in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
