...
export const metadata: Metadata = {
  ...
  keywords: "safa design in gurgaon, safa Gurgaon, wedding safa Gurgaon, safa service Gurgaon",
  openGraph: {
    title: "Safa in Gurgaon | Safawala Gurgaon",
    description: "Premium safa service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/safa-design-in-gurgaon",
    type: "website",
  },
}

export default function SafaDesignInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in Gurgaon", "Competitive pricing for individual and bulk orders", "On-site professional service at your Gurgaon venue", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination"],
    seoKeywords: ["safa design in gurgaon", "safa Gurgaon", "wedding safa Gurgaon", "safa service Gurgaon"],
    faqs: [
  {
