...
export const metadata: Metadata = {
  ...
  keywords: "pagdi for groom in gurgaon, pagdi Gurgaon, wedding pagdi Gurgaon, pagdi service Gurgaon",
  openGraph: {
    title: "Groom Pagdi in Gurgaon | Safawala Gurgaon",
    description: "Premium pagdi service in Gurgaon by Safawala Gurgaon.",
    url: "https://safawalagurgaon.com/pagdi-for-groom-in-gurgaon",
    type: "website",
  },
}

export default function PagdiForGroomInGurgaonPage() {
  const pageData = {
    ...
    areas: GURGAON_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in Gurgaon", "Complete barati packages with matching coordination", "On-site professional service at your Gurgaon venue", "Emergency last-minute service available in Gurgaon", "Premium materials - silk, brocade, velvet, and designer fabrics"],
    seoKeywords: ["pagdi for groom in gurgaon", "pagdi Gurgaon", "wedding pagdi Gurgaon", "pagdi service Gurgaon"],
    faqs: [
  {
