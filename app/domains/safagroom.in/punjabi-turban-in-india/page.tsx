...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safagroom.in/punjabi-turban-in-india",
    type: "website",
  },
}
...
export default function PunjabiTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Expert turban specialists with 40+ years experience in India", "On-site professional service at your India venue"],
