...
export const metadata: Metadata = {
  ...
  keywords: "maharaja safa tying service, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Royal palaces Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://maharajasafa.com/maharaja-safa-tying-service",
    type: "website",
  },
}

export default function MaharajaSafaTyingServicePage() {
  const pageData = {
    ...
    seoKeywords: ["maharaja safa tying service", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
