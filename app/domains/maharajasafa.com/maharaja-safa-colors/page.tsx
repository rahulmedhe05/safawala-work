...
export const metadata: Metadata = {
  ...
  keywords: "maharaja safa colors, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Royal palaces Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://maharajasafa.com/maharaja-safa-colors",
    type: "website",
  },
}

export default function MaharajaSafaColorsPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations"],
    seoKeywords: ["maharaja safa colors", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
