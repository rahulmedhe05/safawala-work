...
export const metadata: Metadata = {
  ...
  keywords: "maharaja safa designs, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Royal palaces Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://maharajasafa.com/maharaja-safa-designs",
    type: "website",
  },
}

export default function MaharajaSafaDesignsPage() {
  const pageData = {
    ...
    seoKeywords: ["maharaja safa designs", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
