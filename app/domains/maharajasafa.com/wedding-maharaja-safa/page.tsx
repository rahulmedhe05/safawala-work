...
export const metadata: Metadata = {
  title: "Premium Wedding-Grade Royal palaces Safa in India | Safawala India",
  ...
  keywords: "wedding maharaja safa, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Premium Wedding-Grade Royal palaces Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://maharajasafa.com/wedding-maharaja-safa",
    type: "website",
  },
}

export default function WeddingMaharajaSafaPage() {
  const pageData = {
    title: "Premium Wedding-Grade Royal palaces Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day"],
    seoKeywords: ["wedding maharaja safa", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Premium Wedding-Grade Royal palaces Safa in India Destination</h2>
