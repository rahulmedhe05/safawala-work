...
export const metadata: Metadata = {
  title: "Royal palaces Barati Safa in India | Safawala India",
  ...
  keywords: "maharaja safa for barati, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Royal palaces Barati Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://maharajasafa.com/maharaja-safa-for-barati",
    type: "website",
  },
}

export default function MaharajaSafaForBaratiPage() {
  const pageData = {
    title: "Royal palaces Barati Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Complete barati packages with matching coordination"],
    seoKeywords: ["maharaja safa for barati", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Royal palaces Barati Safa in India Destination</h2>
