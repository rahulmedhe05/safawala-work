...
export const metadata: Metadata = {
  title: "Well-Maintained Rental Collection Royal palaces Safa in India | Safawala India",
  ...
  keywords: "maharaja safa rental, safa India, wedding safa India, safa service India",
  openGraph: {
    title: "Well-Maintained Rental Collection Royal palaces Safa in India | Safawala India",
    description: "Premium safa service in India by Safawala India.",
    url: "https://maharajasafa.com/maharaja-safa-rental",
    type: "website",
  },
}

export default function MaharajaSafaRentalPage() {
  const pageData = {
    title: "Well-Maintained Rental Collection Royal palaces Safa in India",
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India"],
    seoKeywords: ["maharaja safa rental", "safa India", "wedding safa India", "safa service India"],
    faqs: [
  {
  ...
  },
  {
    ...
    content: `
<h2>Welcome to Safawala India - Your Premier Well-Maintained Rental Collection Royal palaces Safa in India Destination</h2>
