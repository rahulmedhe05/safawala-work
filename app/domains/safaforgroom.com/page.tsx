...
export const metadata: Metadata = {
  title: "Safa for Groom | Premium groom turban service | Book Online India",
  description: "Safa for Groom - Premium groom turban service. Premium wedding turban tying service with 40+ years legacy. Expert artisans. Pan-India coverage. Book now!",
  keywords: "safa for groom, safa-for-groom, wedding safa service, groom turban service, pagdi tying service, turban on rent, safa booking online",
  openGraph: {
    title: "Safa for Groom | Premium Turban Service",
    description: "Premium groom turban service. Expert turban service across India.",
    url: "https://safaforgroom.com",
    type: "website",
  },
}

const SPECIALTIES = ['Royal Entrance Safa', 'Designer Groom Collection', 'Sehra Included', 'Kalgi & Brooch Set']
...
export default function SafaforGroomHomePage() {
  return (
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Premium groom turban service. India's trusted turban specialist with 40+ years legacy. 
            ...
            <div className="hidden lg:block">
              <img src="/hero-groom.webp" alt="Safa for Groom" className="rounded-2xl shadow-2xl" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Our Safa for Groom Specialties</h2>
      ...
      <DynamicAboutSection location="Safa for Groom" state="Pan India" />
      <GallerySection />
      <ContactForm />
      <DynamicFooter location="Safa for Groom" state="India" domain="safaforgroom.com" type="service" />
      <WhatsAppFloat />
    </main>
  )
}
