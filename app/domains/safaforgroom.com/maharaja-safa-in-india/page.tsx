...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://safaforgroom.com/maharaja-safa-in-india",
    type: "website",
  },
}
...
export default function MaharajaSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders"],
