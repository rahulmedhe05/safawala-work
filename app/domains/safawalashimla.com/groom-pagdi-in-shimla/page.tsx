...
export const metadata: Metadata = {
  ...
  keywords: "groom pagdi in shimla, pagdi Shimla, wedding pagdi Shimla, pagdi service Shimla",
  openGraph: {
    title: "Groom Pagdi in Shimla | Safawala Shimla",
    description: "Premium pagdi service in Shimla by Safawala Shimla.",
    url: "https://safawalashimla.com/groom-pagdi-in-shimla",
    type: "website",
  },
}

export default function GroomPagdiInShimlaPage() {
  const pageData = {
    ...
    seoKeywords: ["groom pagdi in shimla", "pagdi Shimla", "wedding pagdi Shimla", "pagdi service Shimla"],
    faqs: [
  {
